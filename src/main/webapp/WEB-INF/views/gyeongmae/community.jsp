inquiry<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
...
<body>
		 ...
		 //tab -->
				...
				<div id="container">
					<iframe name="iframeOther" id="iframeOther"
						src="https://goodauction.r114.com/community/real_qna.php"
						frameborder="0" scrolling="no" width="100%" height="2340px">
					</iframe>
				</div>
	...
	<iframe name="easyXDM_Kakao_default6604_provider"
		id="easyXDM_Kakao_default6604_provider"
		src="https://kapi.kakao.com/cors/?xdm_e=https%3A%2F%2Fwww.r114.com&amp;xdm_c=default6604&amp;xdm_p=1"
		...
		<div
			...
			<div>
				<iframe name="fb_xdm_frame_https" frameborder="0"
					...
					src="https://staticxx.facebook.com/connect/xd_arbiter/r/d_vbiawPdxB.js?version=44#channel=f3f3830605fa608&amp;origin=https%3A%2F%2Fwww.r114.com"
