...
<!--    <input type="text" placeholder="검색없이 건물 토지정보를 바로 확인하세요!" id="dqSearchTerm" name="dqSearchTerm" autocomplete="off" onmousedown="dq_setTextbox('1',event);" onkeydown="dq_setTextbox('1',event);" onkeypress="if(event.keyCode==13) {dq_search(); return false;}" class="g_search" value="" /> -->
	...
	<input type="hidden" name="adSearchKeywordUrl" id="adSearchKeywordUrl" value="http://www.r114.com/?_c=service&amp;_m=event&amp;_a=eventviewalimi">
				...
				<span>
					...
					<div class="layer_menu lm_9">
						<ul>
							...
							<li class="on"><a href="/?_c=service&amp;_m=Auction&amp;tab=2">경매STUDY</a></li>
...
<div id="body_layout">
	...
	<div class="contents_wrap2">
		...
		<div id="container">
			<iframe name="iframeOther" id="iframeOther" src="https://goodauction.r114.com/study/pubsale_process.php" frameborder="0" scrolling="no" width="100%" height="7640px">
			</iframe>
		</div>
...
<script type="text/javascript">
	...
	var tab = isEmpty(getParameterByName("tab")) ? "1" : decodeURI(getParameterByName("tab")) ;
...
</script><iframe name="easyXDM_Kakao_default8345_provider" id="easyXDM_Kakao_default8345_provider" src="https://kapi.kakao.com/cors/?xdm_e=https%3A%2F%2Fwww.r114.com&amp;xdm_c=default8345&amp;xdm_p=1" frameborder="0" style="position: absolute; top: -2000px; left: 0px;"></iframe><div id="fb-root" class=" fb_reset"><div style="position: absolute; top: -10000px; width: 0px; height: 0px;"><div><iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" src="https://staticxx.facebook.com/connect/xd_arbiter/r/d_vbiawPdxB.js?version=44#channel=f249515d8a83d74&amp;origin=https%3A%2F%2Fwww.r114.com" style="border: none;"></iframe></div><div></div></div></div></body>
</html>