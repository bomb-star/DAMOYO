...
<script
	src="https://cr.acecounter.com/Web/AceCounter_AW.js?gc=AH6A41105368933&amp;py=0&amp;gd=gtb14&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1555227405587"
...
<body style="">
	...
	<div class="floating_topmenu view">
		<div class="w_fix">
			<ul class="menu">

				<li class="divMemulInfoTab on"><a href="#divMemulInfoTab">매물정보</a></li>
				...
				<li class=""><a href="/?_c=service&amp;_m=Interior&amp;_s=life"
					target="_blank">인테리어문의</a></li>
		...
		<div class="body_wrap printArea1">
			<div class="contents_wrap">
				<div class="util_wrap">
					...
					<a href="${pageContext.request.contextPath}/eroe/mamulList" class="btn_type1 listview" id="aMemul">매물리스트
						보기</a> <a href="javascript:;" class="btn_type1 srch_please red"
						id="aAskbuy">찾아주세요</a> <span class="social_set">
						<button type="button">
				...
				<div class="title_set1">
					...
					<div class="name_wrap">
						<span class="tag_comm3 type2">중개의뢰<em>19.04.08</em></span><strong
							class="name">북안면</strong>
					</div>
					<div class="price_wrap">
						<div class="price2">&nbsp;</div>
						<span class="tag_comm2 m">매매</span><em class="price1">37,000
							만원</em>
					</div>
				</div>
			...
			-->
				...
				<div class="divInfo" id="divMemulInfoTab">
					<h4 class="h4_type4">
						매물정보 <span class="rb" id="divBannerView" style="display: none;">
						</span>
					</h4>
									...
									<div class="tbl_type_2row">
										<ul>
											...
											<li><span class="spninfo" style="height: 20px;">대지면적</span><span
												class="spndetail">27,438.14㎡&nbsp;(8,300평)</span></li>

											<li><span class="spninfo" style="height: 20px;">지목</span><span
												class="spndetail">임야</span></li>

											<li><span class="spninfo" style="height: 20px;">용도지역</span><span
												class="spndetail">보전녹지</span></li>

											<li><span class="spninfo" style="height: 20px;">현이용상태</span><span
												class="spndetail">휴경지</span></li>

											<li><span class="spninfo" style="height: 20px;">건물규제사항</span><span
												class="spndetail">남향의 평평한 토지</span></li>

											<li><span class="spninfo" style="height: 20px;">건축제한사항</span><span
												class="spndetail">남향의 평평한 토지</span></li>

											<li><span class="spninfo" style="height: 20px;">실구입자금</span><span
												class="spndetail">37,000만원</span></li>

											<li><span class="spninfo" style="height: 20px;">거래희망일</span><span
												class="spndetail">빠르면 빠를수록 좋음</span></li>
				...
				<div class="divInfo" id="divMemulPhotoTab">
					<h4 class="h4_type4 line">사진정보</h4>
					<div class="slide_type2_memul gallery">
						<div class="gallery_cont">
							<ul class="slider_cont">
								<li><a data-slide-index="0" href="" class="slide"><img
										src="http://image.r114.co.kr/support/2019/04/DB46E99EB9324A41919EE0EAAD04AE0D.png"
										width="100%" height="349" class="memulPhotoImage"></a></li>
								<li><a data-slide-index="1" href="" class="slide"><img
										src="http://image.r114.co.kr/support/2019/04/BE9608CC078D415EBF6134D1E92B5D82.png"
										width="100%" height="349" class="memulPhotoImage"></a></li>
								<li><a data-slide-index="2" href="" class="slide"><img
										src="http://image.r114.co.kr/support/2019/04/C6675EB3A00B4BF0B005CF49C17477A4.png"
										width="100%" height="349" class="memulPhotoImage"></a></li>
							</ul>
							<div class="ui">
						...
						<div class="bottom_wrap">
							<div class="menu">
								<a href="javascript:" class="memulPhotoImage on">매물사진</a>
							</div>

							<div class="pager_wrap">
								<div class="pager">
									<a data-slide-index="0" href="" class="slide"><img
										src="http://image.r114.co.kr/support/2019/04/DB46E99EB9324A41919EE0EAAD04AE0D.png"
										width="61px" height="61px" class="memulPhotoImage"></a><a
										data-slide-index="1" href="" class="slide"><img
										src="http://image.r114.co.kr/support/2019/04/BE9608CC078D415EBF6134D1E92B5D82.png"
										width="61px" height="61px" class="memulPhotoImage"></a><a
										data-slide-index="2" href="" class="slide"><img
										src="http://image.r114.co.kr/support/2019/04/C6675EB3A00B4BF0B005CF49C17477A4.png"
										width="61px" height="61px" class="memulPhotoImage"></a>
								</div>
								<div class="pager_ui"></div>
							</div>
						</div>
					</div>
				</div>

				<div class="divInfo" id="divMemulInfoTab" style="display: none">
					...
					<table class="tbl_type2 lf ">
						...
						<tbody>
							<tr>
								<th>매물상세설명</th>
								<td colspan="3"><div
										style="word-wrap: break-word; overflow-wrap: break-word; word-break: break-word;"></div></td>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<div id="divGrapPlotTab" style="display: none;">
					<h4 class="h4_type4 line">
						시세정보 0㎡(0평) <em class="rb"><a href="javascript:;"
...
//									vAxis: {title: "", gridlines:{count:5}, viewWindowMode:'explicit', viewWindow:{min:yMin, max:yMax}},
				...
				<div id="divGrapBoxlineTab" style="display: none;">
					<h4 class="h4_type4 line">
						0㎡(0평) 시세변동 추이(10년)<em class="small rb">단위 : 만원</em>
					</h4>
					<div class="graph_area typeB">
						<div class="exp_wrap">
							<ul class="exp_list type1">
								...
								<!--
							<li><i class="ico_comm_l grp_icon_circlered"> </i>매매시세</li>
							<li><i class="ico_comm_l grp_icon_circleblue"> </i>전세시세</li>
							-->
							</ul>
						</div>
				...
				<div class="report_wrap" id="divBannerView" style="display: none;"></div>

				<div class="divInfo">
					<h4 class="h4_type4 line">
						비용 정보<em class="small">총 <span class="fc_blue">39,035</span>만원
						</em>
					</h4>
								...
								<td>
									<div class="tbl_type_2row">
										<ul>
											...
											<li style="height: 50px;"><span class="spninfo"
												style="height: 26px;">인테리어</span><span class="spndetail"
												style="height: 26px;"><button type="button"
														href="#none" class="btn_type1 small" id="btnInterior">견적
														문의하기</button></span></li>

											<li style="height: 50px;"><span class="spndetail"
												style="height: 26px;">&nbsp;</span></li>
				...
				<div id="divPageMapHeignt">
					...
					<div class="sub_map_wrap"
						style="overflow: hidden; width: 728px; max-width: 728px; height: 320px; max-height: 320px; display: none;">
						<iframe style="width: 728px; height: 320px;" frameborder="0"
							scrolling="no" id="iframeMap"></iframe>
					</div>
				</div>
				...
				<div id="divMemulListAllTab">
					...
					<div class="divInfo" id="divAreaMemulListTab"
						style="display: none;">
			...
			<div class="right_wrap">
				<div class="util_wrap2">
					...
					<!--<a href="javascript:;"><span class="ico_comm_s report"></span>허위매물신고</a>-->
					<a href="javascript:;" id="aPrint"><span
						class="ico_comm_s print"></span>인쇄</a>
				</div>
				<div class="member_office_info bx_gray">
					<div class="cont">
						...
						<a href="javascript:;"
							onclick="fnWinUrl('http://www.r114.net/T/010-7228-0863', '_blank','', '','','');"><div
								class="thumb">
								<img
									src="http://image.r114.co.kr/brokersimages/2018/12/F20170216123625_photo03_non.jpg"
									border="0">
							</div></a> <strong class="name"><i class="ico_class c">C</i><a
							href="javascript:;"
							onclick="fnWinUrl('http://www.r114.net/T/010-7228-0863', '_blank','', '','','');">대겸공인중개사사무소</a></strong>
						<ul class="info">
							<li><strong>대표</strong><span>우대겸</span></li>
							<li><strong>주소</strong><span>경상북도 영천시 야사동 189-20</span></li>
							<li class="tel"><strong>전화</strong><span class="fc_blue">054)333-8249<br>010-7228-0863
							</span></li>
						</ul>
						<strong class="special">토지, 아파트, 주택 전문</strong>
						<div class="btn_area">
							<a href="javascript:;" class="btn_type2"
								onclick="fnMapOpen('F20170216123625','128.9481730412','35.9739512682')">위치</a>
							<a href="javascript:;"
								onclick="fnWinUrl('http://www.r114.net/T/010-7228-0863', '_blank','', '','','');"
								class="btn_type2">홈페이지</a><a href="javascript:;"
								onclick="fnWinUrl('http://net.r114.co.kr/redirectjun.asp?jno=F20170216123625&amp;kind=11&amp;jkind=&amp;mflag=1&amp;Hjong=18', '_blank','', '','','');"
						...
						<li style="display: block;">
							...
							<div class="btn_wrap">
								<div class="right_paging_wrap" id="paging3">
									<!-- 2017-11-09 페이징 영역 추가 -->

								</div>

								<a href="javascript:;" class="btn_type2" id="btnQustion">문의하기</a>
								<a href="javascript:;" class="btn_type2" id="btnConntactTel">연락처
									남기기</a>
...
.noprint {
		...
		<div
			...
			<div>
				<iframe name="fb_xdm_frame_https" frameborder="0"
					...
					src="https://staticxx.facebook.com/connect/xd_arbiter/r/d_vbiawPdxB.js?version=44#channel=f2e3048f0e9cd&amp;origin=https%3A%2F%2Fwww.r114.com"
	...
	<script type="text/javascript" src="/W1/js/memul/houseDetail.js"></script>
	...
	var strmmCode = "A11011";
	var strMulCode = "102912";
	var strAgencyCode = "F20170216123625";
	var strAgencyName = "대겸공인중개사사무소";
	var strMemulType = "토지";
	var strAddr1 = "경상북도";
	var strAddr2 = "영천시";
	var strAddr3 = "북안면";
	var strAddr4 = "옥천리 산 33 외 인접땅 합 3필지";
	var strAddrCode = "4723039000";
	var strBunji = "";
	var strSize = "27438.14";
	var strRealSize = "0";
	var strPySize = "0";
	var strPyType = "";
	var strBuildName = "";
	var strPrice = "37000";
	var strPrice2 = "0";
	var strMemulNum = "102912";
	var strComplexGbn = "";
	var strComplexCode = "";
	var strDealType  = "매매";
	var strlandCategory = "임야";
	var strQuestionTitle  = "매매|r114|토지|r114||r114|경상북도|r114|영천시|r114|북안면";
	var strQuestionURL = "/Default.asp?_c=memul&_m=asksellDetail&mulcode=102912";
	var strGoogleMapX  = "";
	var strGoogleMapY = "";
	var strFCode = "OA";
	...
	var strHouseholdCount = "";	// add_loan
	...
	$(document).ready(function() {
		...
		if ( $("#divMemulListTab").css("display") == "none" && $("#divAreaMemulListTab").css("display") == "none" )
			{
				//$("#divSubwayLiving").css("display", "none");
	...
	function fn_snsShare(){
		...
		if($.browser.msie && parseInt($.browser.version) <= parseInt(8)){
			...
			var longURL = "https://www.r114.com?_c=memul&_m=asksellDetail&mulcode=102912";
	...
	//	fn_snsGoShare(sns,  sUrl , '[부동산114] [토지] 북안면 ');
	...
	<iframe name="easyXDM_Kakao_default8747_provider"
		id="easyXDM_Kakao_default8747_provider"
		src="https://kapi.kakao.com/cors/?xdm_e=https%3A%2F%2Fwww.r114.com&amp;xdm_c=default8747&amp;xdm_p=1"
