...
<meta id="metaURL" property="og:url"
	content="https://www.r114.com/Default.asp?_c=ask&amp;_m=customerreview">
...
<script
	src="https://cr.acecounter.com/Web/AceCounter_AW.js?gc=AH6A41105368933&amp;py=0&amp;gd=gtb14&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1554785675169"
			...
			<div class="title_wrap">
				...
				<div class="location">
					<ul>
						...
						<li><a
							href="${pageContext.request.contextPath}/eroe/eroeMain">매물의뢰</a></li>
						<li><a
...
-->
				...
				<div class="info_smr bm"
					style="background-image: url(https://image.r114.co.kr/W1/images/sub/bg_info_ask.jpg);">
					<div class="inner">
						<strong>지역내 베테랑 중개사무소를 통해 고객님의<br> 부동산거래를 지원합니다.
						</strong>
						<p>
							지역내 프리미엄 중개사무소를 중심으로 1:1 책임중개를 지원합니다. <br> 의뢰하신 매물은 부동산114
							매물메뉴에도 홍보되어 빠른 거래를 지원합니다.
						</p>
						<div class="mgt2">
							<a href="javascript:" class="btn_type1" id="cmdGoAskSell">내놓기
								의뢰하기</a> <a href="javascript:" class="btn_type1" id="cmdGoAskBuy">구하기
								의뢰하기</a>
						</div>
					</div>
				</div>
				...
				<div class="tab_btn">
					<ul class="tab_list">
						...
						<li id="askCategory1"><a
							href="${pageContext.request.contextPath}/eroe/customerReview_tab2">구하기</a></li>
					</ul>
				</div>
				...
				<ul class="list_review">
					<li>
						<div class="in">
							<span class="area"><span class="ico_comm_s location5">위치</span>서울특별시
								중구 회현동3가</span> <span class="info_wrap2"> <span>사무실</span><span>월세</span>
							</span> <span class="txt">보증금 518 만원 / 월세 52 ~ 52 만원</span> <strong
								class="ellip">빠른 시간 내에 집을 구할 수 있었습니다.</strong>
							<p>uggggghjjjjkkkkkkjjhhh hjjjeefffgggggggttfffgfffffffffgg</p>
							<a href="javascript:" class="btn_type2"
								onclick="openLp('#lp_layout_339')" style="display:">더보기<span
								class="ico_comm_s arrow1"></span></a> <span class="info_wrap2">
								<span><span class="ico_comm_s writer">작성자</span>shamscoltd***</span>
								<span>2019.04.09</span>
							</span>
						</div>
						<div class="profile1">
							<strong>거래전담 공인중개사</strong> <span class="thumb"><img
								src="https://image.r114.co.kr/brokersimages/2016/05/F20111110155351_photo03_non.jpg"
								border="0"></span> <em class="info"> <span class="shop"><i
									class="ico_class c">C</i>한길공인</span> <span class="juso"><i
									class="ico_comm_s home">주소</i><a href="javascript:;"
									onclick="fnMapLayerPop(this, 'popup','','','F20111110155351')"
									class="link_blue">서울특별시 마포구 도화동 2-342 외1필지 </a></span> <span
								class="tel"><i class="ico_comm_s tel">tel</i>02)713 -
									5554</span> <a href="javascript:fnGoJunHome('F20111110155351')"
								class="btn_type1" title="새창">홈페이지</a>
							</em> <span class="like"><span class="ico_comm_s like2">공감</span>4</span>
						</div>
					</li>
					...
					<div id="lp_layout_339">
						<div class="lp_wrap" style="width: 700px;">
							<div class="inner">
								<div class="lp_con">
									<div class="list_review">
										<div class="in">
											<span class="info_wrap2"> <em><span
													class="ico_comm_s location5"></span>서울특별시 중구 회현동3가</em><span>사무실</span><span>월세</span><span>46/32㎡</span>
											</span>
											<div class="info_wrap2">보증금 518 만원 / 월세 52 ~ 52 만원</div>
											<!-- //2017.08.23 수정 -->
											<strong>빠른 시간 내에 집을 구할 수 있었습니다.</strong>
											<p>uggggghjjjjkkkkkkjjhhh
												hjjjeefffgggggggttfffgfffffffffgg</p>
											<!-- 2017.08.23 수정 -->
											<!-- <span class="info_wrap2"> -->
											<span class="info_wrap1"> <!-- //2017.08.23 수정 --> <span><span
													class="ico_comm_s writer">작성자</span>shamscoltd***</span> <span>2019.04.09</span>
											</span>
										</div>
										<div class="profile1">
											<!-- 2017.08.23 수정 -->
							...
							<span class="like"><span class="ico_comm_s like2">공감</span>24</span> -->
											<em class="title_s">거래전담 공인중개사</em> <span class="thumb"><img
												src="https://image.r114.co.kr/brokersimages/2016/05/F20111110155351_photo03_non.jpg"
												border="0"></span> <span class="info"> <span
												class="shop"><i class="ico_class c">C</i>한길공인</span> <span
												class="address"><i class="ico_comm_s home">주소</i><a
													href="javascript:;"
													onclick="fnMapLayerPop(this, 'popup','','','F20111110155351')"
													class="link_blue">서울특별시 마포구 도화동 2-342 외1필지 </a></span> <span
												class="tel"><i class="ico_comm_s tel">tel</i>02)713 -
												...
												href="javascript:fnGoJunHomeMemul('F20111110155351')"
												class="btn_type1" target="_blank">매물보기</a>
											</span> <span class="like"><span class="ico_comm_s like2">공감</span>4</span>
											<!-- //2017.08.23 수정 -->
										</div>
										<!-- 2017.08.23 추가 -->
										<!--
					...
					<li>
						<div class="in">
							<span class="area"><span class="ico_comm_s location5">위치</span>부산광역시
								연제구 연산동</span> <span class="info_wrap2"> <span>오피스텔</span><span>매매</span>
							</span> <span class="txt">매매가 205 ~ 210,000 만원</span> <strong
								class="ellip">빠른 시간 내에 집을 팔 수 있었습니다.</strong>
							<p>물건수정할 내용이 있어서 매물 내립니다. 관심 가져주셔서 감사합니다 다시 매물 접수하도록 하겠습니다</p>
							<a href="javascript:" class="btn_type2"
								onclick="openLp('#lp_layout_338')" style="display:">더보기<span
								class="ico_comm_s arrow1"></span></a> <span class="info_wrap2">
						...
						<div class="profile1">
							<strong>거래전담 공인중개사</strong> <span class="thumb"></span> <em
								class="info"> <span class="shop"><i
									class="ico_class c">C</i>조은공인중개사</span> <span class="juso"><i
									class="ico_comm_s home">주소</i><a href="javascript:;"
									onclick="fnMapLayerPop(this, 'popup','','','F20190226164900')"
									class="link_blue">부산광역시 연제구 연산동 1143-4 11층 (연산동)</a></span> <span
								class="tel"><i class="ico_comm_s tel">tel</i>010 - 2209 -
									8830</span> <a href="javascript:fnGoJunHome('F20190226164900')"
								class="btn_type1" title="새창">홈페이지</a>
					...
					<div id="lp_layout_338">
						<div class="lp_wrap" style="width: 700px;">
							<div class="inner">
								<div class="lp_con">
									<div class="list_review">
										<div class="in">
											<span class="info_wrap2"> <em><span
													class="ico_comm_s location5"></span>부산광역시 연제구 연산동</em><span>오피스텔</span><span>매매</span><span>62/46㎡</span>
											</span>
											<div class="info_wrap2">매매가 205 ~ 210,000 만원</div>
											<!-- //2017.08.23 수정 -->
											<strong>빠른 시간 내에 집을 팔 수 있었습니다.</strong>
											<p>물건수정할 내용이 있어서 매물 내립니다. 관심 가져주셔서 감사합니다 다시 매물 접수하도록
												하겠습니다</p>
											<!-- 2017.08.23 수정 -->
											<!-- <span class="info_wrap2"> -->
											<span class="info_wrap1"> <!-- //2017.08.23 수정 --> <span><span
													class="ico_comm_s writer">작성자</span>donmungchi1***</span> <span>2019.04.09</span>
											</span>
										</div>
										<div class="profile1">
											<!-- 2017.08.23 수정 -->
							...
							<span class="like"><span class="ico_comm_s like2">공감</span>24</span> -->
											<em class="title_s">거래전담 공인중개사</em> <span class="thumb"></span>
											<span class="info"> <span class="shop"><i
													class="ico_class c">C</i>조은공인중개사</span> <span class="address"><i
													class="ico_comm_s home">주소</i><a href="javascript:;"
													onclick="fnMapLayerPop(this, 'popup','','','F20190226164900')"
													class="link_blue">부산광역시 연제구 연산동 1143-4 11층 (연산동)</a></span> <span
												class="tel"><i class="ico_comm_s tel">tel</i>010 -
													2209 - 8830</span> <a
												href="javascript:fnGoJunHome('F20190226164900')"
												class="btn_type1" title="새창">홈페이지</a> <a
												href="javascript:fnGoJunHomeMemul('F20190226164900')"
												class="btn_type1" target="_blank">매물보기</a>
											</span> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
											<!-- //2017.08.23 수정 -->
										</div>
										<!-- 2017.08.23 추가 -->
										<!--
					...
					<li>
						<div class="in">
							<span class="area"><span class="ico_comm_s location5">위치</span>경기도
								김포시 양촌읍</span> <span class="info_wrap2"> <span>분양권</span><span>매매</span>
							</span> <span class="txt">매매가 2,916,000 ~ 2,950,000 만원</span> <strong
								class="ellip">빠른 시간 내에 집을 구할 수 있었습니다.</strong>
							<p>매물 올리고나서 연락이 금방왔습니다 좋은 가격에 거래가 잘 진행됐으면 좋겠네요</p>
							<a href="javascript:" class="btn_type2"
								onclick="openLp('#lp_layout_337')" style="display:">더보기<span
								class="ico_comm_s arrow1"></span></a> <span class="info_wrap2">
						...
						<div class="profile1">
							<strong>거래전담 공인중개사</strong> <span class="thumb"></span> <em
								class="info"> <span class="shop"><i
									class="ico_class c">C</i>현대아이파크공인</span> <span class="juso"><i
									class="ico_comm_s home">주소</i><a href="javascript:;"
									onclick="fnMapLayerPop(this, 'popup','','','F20160526155158')"
									class="link_blue">경기도 김포시 사우동 878 제이팰리스 103호</a></span> <span
								class="tel"><i class="ico_comm_s tel">tel</i>031)9911 -
									114</span> <a href="javascript:fnGoJunHome('F20160526155158')"
								class="btn_type1" title="새창">홈페이지</a>
							</em> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
						</div>
					</li>
					...
					<div id="lp_layout_337">
						<div class="lp_wrap" style="width: 700px;">
							<div class="inner">
								<div class="lp_con">
									<div class="list_review">
										<div class="in">
											<span class="info_wrap2"> <em><span
													class="ico_comm_s location5"></span>경기도 김포시 양촌읍</em><span>분양권</span><span>매매</span><span>99/77㎡</span>
											</span>
											<div class="info_wrap2">매매가 2,916,000 ~ 2,950,000 만원</div>
											<!-- //2017.08.23 수정 -->
											<strong>빠른 시간 내에 집을 구할 수 있었습니다.</strong>
											<p>매물 올리고나서 연락이 금방왔습니다 좋은 가격에 거래가 잘 진행됐으면 좋겠네요</p>
											<!-- 2017.08.23 수정 -->
											<!-- <span class="info_wrap2"> -->
											<span class="info_wrap1"> <!-- //2017.08.23 수정 --> <span><span
													class="ico_comm_s writer">작성자</span>seokjae0203</span> <span>2019.04.08</span>
											</span>
										</div>
										<div class="profile1">
											<!-- 2017.08.23 수정 -->
							...
							<span class="like"><span class="ico_comm_s like2">공감</span>24</span> -->
											<em class="title_s">거래전담 공인중개사</em> <span class="thumb"></span>
											<span class="info"> <span class="shop"><i
													class="ico_class c">C</i>현대아이파크공인</span> <span class="address"><i
													class="ico_comm_s home">주소</i><a href="javascript:;"
													onclick="fnMapLayerPop(this, 'popup','','','F20160526155158')"
													class="link_blue">경기도 김포시 사우동 878 제이팰리스 103호</a></span> <span
												class="tel"><i class="ico_comm_s tel">tel</i>031)9911
													- 114</span> <a href="javascript:fnGoJunHome('F20160526155158')"
												class="btn_type1" title="새창">홈페이지</a> <a
												href="javascript:fnGoJunHomeMemul('F20160526155158')"
												class="btn_type1" target="_blank">매물보기</a>
											</span> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
											<!-- //2017.08.23 수정 -->
										</div>
					...
					<li>
						<div class="in">
							<span class="area"><span class="ico_comm_s location5">위치</span>강원도
								횡성군 안흥면</span> <span class="info_wrap2"> <span>토지</span><span>매매</span>
							</span> <span class="txt">매매가 4,900 ~ 4,900 만원</span> <strong
								class="ellip">OK</strong>
							<p>OKerrr ghhj bbbn hhgff ffgh ooptew6 hhjjbbnnn jjggg hbhff
								hhfg qweqd hjjbh hffvbj</p>
							<a href="javascript:" class="btn_type2"
								onclick="openLp('#lp_layout_336')" style="display:">더보기<span
								class="ico_comm_s arrow1"></span></a> <span class="info_wrap2">
						...
						<div class="profile1">
							<strong>거래전담 공인중개사</strong> <span class="thumb"><img
								src="https://image.r114.co.kr/brokersimages/2017/08/F09182258000010_photo03_non.jpg"
								border="0"></span> <em class="info"> <span class="shop"><i
									class="ico_class c">C</i>엉클과금여사공인</span> <span class="juso"><i
									class="ico_comm_s home">주소</i><a href="javascript:;"
									onclick="fnMapLayerPop(this, 'popup','','','F09182258000010')"
									class="link_blue">강원도 횡성군 횡성읍 311 </a></span> <span class="tel"><i
									class="ico_comm_s tel">tel</i>033)344 - 0004</span> <a
								href="javascript:fnGoJunHome('F09182258000010')"
								class="btn_type1" title="새창">홈페이지</a>
							</em> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
						</div>
					</li>
						...
						<div class="lp_wrap" style="width: 700px;">
							<div class="inner">
								<div class="lp_con">
									<div class="list_review">
										<div class="in">
											<span class="info_wrap2"> <em><span
													class="ico_comm_s location5"></span>강원도 횡성군 안흥면</em><span>토지</span><span>매매</span><span>805㎡</span>
											</span>
											<div class="info_wrap2">매매가 4,900 ~ 4,900 만원</div>
											<!-- //2017.08.23 수정 -->
											<strong>OK</strong>
											<p>OKerrr ghhj bbbn hhgff ffgh ooptew6 hhjjbbnnn jjggg
												hbhff hhfg qweqd hjjbh hffvbj</p>
											<!-- 2017.08.23 수정 -->
											<!-- <span class="info_wrap2"> -->
											<span class="info_wrap1"> <!-- //2017.08.23 수정 --> <span><span
													class="ico_comm_s writer">작성자</span>m821371***</span> <span>2019.04.07</span>
											</span>
										</div>
										<div class="profile1">
											<!-- 2017.08.23 수정 -->
							...
							<span class="like"><span class="ico_comm_s like2">공감</span>24</span> -->
											<em class="title_s">거래전담 공인중개사</em> <span class="thumb"><img
												src="https://image.r114.co.kr/brokersimages/2017/08/F09182258000010_photo03_non.jpg"
												border="0"></span> <span class="info"> <span
												class="shop"><i class="ico_class c">C</i>엉클과금여사공인</span> <span
												class="address"><i class="ico_comm_s home">주소</i><a
													href="javascript:;"
													onclick="fnMapLayerPop(this, 'popup','','','F09182258000010')"
													class="link_blue">강원도 횡성군 횡성읍 311 </a></span> <span class="tel"><i
												...
												href="javascript:fnGoJunHome('F09182258000010')"
												class="btn_type1" title="새창">홈페이지</a> <a
												href="javascript:fnGoJunHomeMemul('F09182258000010')"
												class="btn_type1" target="_blank">매물보기</a>
											</span> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
											<!-- //2017.08.23 수정 -->
										</div>
					...
					<li>
						<div class="in">
							<span class="area"><span class="ico_comm_s location5">위치</span>서울특별시
								금천구 가산동</span> <span class="info_wrap2"> <span>사무실</span><span>월세</span>
							</span> <span class="txt">보증금 500 만원 / 월세 40 ~ 40 만원</span> <strong
								class="ellip">빠른 시간 내에 집을 팔 수 있었습니다.</strong>
							<p>코오롱 공인 중개사의 좋은 사장님을 통해 거래가 잘 이루어졌습니다. 다음에도 계속 잘 부탁드리겠습니다.</p>
							<a href="javascript:" class="btn_type2"
								onclick="openLp('#lp_layout_335')" style="display:">더보기<span
								class="ico_comm_s arrow1"></span></a> <span class="info_wrap2">
						...
						<div class="profile1">
							<strong>거래전담 공인중개사</strong> <span class="thumb"></span> <em
								class="info"> <span class="shop"><i
									class="ico_class c">C</i>코오롱공인</span> <span class="juso"><i
									class="ico_comm_s home">주소</i><a href="javascript:;"
									onclick="fnMapLayerPop(this, 'popup','','','F20150416113510')"
									class="link_blue">서울특별시 금천구 가산동 60-4 코오롱테크노 벨리 110호</a></span> <span
								class="tel"><i class="ico_comm_s tel">tel</i>02)865 -
									4100</span> <a href="javascript:fnGoJunHome('F20150416113510')"
								class="btn_type1" title="새창">홈페이지</a>
							</em> <span class="like"><span class="ico_comm_s like2">공감</span>1</span>
						</div>
					</li>
					...
					<div id="lp_layout_335">
						<div class="lp_wrap" style="width: 700px;">
							<div class="inner">
								<div class="lp_con">
									<div class="list_review">
										<div class="in">
											<span class="info_wrap2"> <em><span
													class="ico_comm_s location5"></span>서울특별시 금천구 가산동</em><span>사무실</span><span>월세</span><span>23㎡</span>
											</span>
											<div class="info_wrap2">보증금 500 만원 / 월세 40 ~ 40 만원</div>
											<!-- //2017.08.23 수정 -->
											<strong>빠른 시간 내에 집을 팔 수 있었습니다.</strong>
											<p>코오롱 공인 중개사의 좋은 사장님을 통해 거래가 잘 이루어졌습니다. 다음에도 계속 잘
												부탁드리겠습니다.</p>
											<!-- 2017.08.23 수정 -->
											<!-- <span class="info_wrap2"> -->
											<span class="info_wrap1"> <!-- //2017.08.23 수정 --> <span><span
													class="ico_comm_s writer">작성자</span>choyoseop***</span> <span>2019.04.05</span>
											</span>
										</div>
										<div class="profile1">
											<!-- 2017.08.23 수정 -->
							...
							<span class="like"><span class="ico_comm_s like2">공감</span>24</span> -->
											<em class="title_s">거래전담 공인중개사</em> <span class="thumb"></span>
											<span class="info"> <span class="shop"><i
													class="ico_class c">C</i>코오롱공인</span> <span class="address"><i
													class="ico_comm_s home">주소</i><a href="javascript:;"
													onclick="fnMapLayerPop(this, 'popup','','','F20150416113510')"
													class="link_blue">서울특별시 금천구 가산동 60-4 코오롱테크노 벨리 110호</a></span> <span
												class="tel"><i class="ico_comm_s tel">tel</i>02)865 -
													4100</span> <a href="javascript:fnGoJunHome('F20150416113510')"
												class="btn_type1" title="새창">홈페이지</a> <a
												href="javascript:fnGoJunHomeMemul('F20150416113510')"
												class="btn_type1" target="_blank">매물보기</a>
											</span> <span class="like"><span class="ico_comm_s like2">공감</span>1</span>
											<!-- //2017.08.23 수정 -->
										</div>
										<!-- 2017.08.23 추가 -->
										<!--
					...
					<li>
						<div class="in">
							<span class="area"><span class="ico_comm_s location5">위치</span>부산광역시
								북구 금곡동</span> <span class="info_wrap2"> <span>상가</span><span>매매</span>
							</span> <span class="txt">매매가 170,000 ~ 170,000 만원</span> <strong
								class="ellip">빠른 시간 내에 집을 구할 수 있었습니다.</strong>
							<p></p>
							<a href="javascript:" class="btn_type2"
								onclick="openLp('#lp_layout_334')" style="display:">더보기<span
								class="ico_comm_s arrow1"></span></a> <span class="info_wrap2">
						...
						<div class="profile1">
							<strong>거래전담 공인중개사</strong> <span class="thumb"><img
								src="https://image.r114.co.kr/brokersimages/2019/03/F20180124170638_photo03_non.jpg"
								border="0"></span> <em class="info"> <span class="shop"><i
									class="ico_class p">P</i>명인부동산중개사무소</span> <span class="juso"><i
									class="ico_comm_s home">주소</i><a href="javascript:;"
									onclick="fnMapLayerPop(this, 'popup','','','F20180124170638')"
									class="link_blue">부산광역시 부산진구 부전동 260-59 2동 203호</a></span> <span
								class="tel"><i class="ico_comm_s tel">tel</i>010 - 4336 -
									3971</span> <a href="javascript:fnGoJunHome('F20180124170638')"
								class="btn_type1" title="새창">홈페이지</a>
							</em> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
						</div>
					</li>
						...
						<div class="lp_wrap" style="width: 700px;">
							<div class="inner">
								<div class="lp_con">
									<div class="list_review">
										<div class="in">
											<span class="info_wrap2"> <em><span
													class="ico_comm_s location5"></span>부산광역시 북구 금곡동</em><span>상가</span><span>매매</span><span>449/1,355㎡</span>
											</span>
											<div class="info_wrap2">매매가 170,000 ~ 170,000 만원</div>
											<!-- //2017.08.23 수정 -->
											<strong>빠른 시간 내에 집을 구할 수 있었습니다.</strong>
											<p></p>
											<!-- 2017.08.23 수정 -->
											<!-- <span class="info_wrap2"> -->
											<span class="info_wrap1"> <!-- //2017.08.23 수정 --> <span><span
													class="ico_comm_s writer">작성자</span>inokpark1980***</span> <span>2019.04.04</span>
											</span>
										</div>
										<div class="profile1">
											<!-- 2017.08.23 수정 -->
							...
							<span class="like"><span class="ico_comm_s like2">공감</span>24</span> -->
											<em class="title_s">거래전담 공인중개사</em> <span class="thumb"><img
												src="https://image.r114.co.kr/brokersimages/2019/03/F20180124170638_photo03_non.jpg"
												border="0"></span> <span class="info"> <span
												class="shop"><i class="ico_class p">P</i>명인부동산중개사무소</span> <span
												class="address"><i class="ico_comm_s home">주소</i><a
													href="javascript:;"
													onclick="fnMapLayerPop(this, 'popup','','','F20180124170638')"
													class="link_blue">부산광역시 부산진구 부전동 260-59 2동 203호</a></span> <span
												class="tel"><i class="ico_comm_s tel">tel</i>010 -
													4336 - 3971</span> <a
												href="javascript:fnGoJunHome('F20180124170638')"
												class="btn_type1" title="새창">홈페이지</a> <a
												href="javascript:fnGoJunHomeMemul('F20180124170638')"
												class="btn_type1" target="_blank">매물보기</a>
											</span> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
											<!-- //2017.08.23 수정 -->
										</div>
					...
					<li>
						<div class="in">
							<span class="area"><span class="ico_comm_s location5">위치</span>강원도
								정선군 신동읍</span> <span class="info_wrap2"> <span>토지</span><span>매매</span>
							</span> <span class="txt">매매가 21,000 ~ 21,000 만원</span> <strong
								class="ellip">조건에 맞는 좋은 집을 찾았습니다.</strong>
							<p>사장님이 친절하게 답해주시네요 조목조목 따져서 말해주신고요 또 질문도 꼼꼼 하게 해주시고요</p>
							<a href="javascript:" class="btn_type2"
								onclick="openLp('#lp_layout_333')" style="display:">더보기<span
								class="ico_comm_s arrow1"></span></a> <span class="info_wrap2">
						...
						<div class="profile1">
							<strong>거래전담 공인중개사</strong> <span class="thumb"><img
								src="https://image.r114.co.kr/brokersimages/2016/05/F20160426105241_photo03_non.jpg"
								border="0"></span> <em class="info"> <span class="shop"><i
									class="ico_class c">C</i>강남공인중개사사무소</span> <span class="juso"><i
									class="ico_comm_s home">주소</i><a href="javascript:;"
									onclick="fnMapLayerPop(this, 'popup','','','F20160426105241')"
									class="link_blue">서울특별시 서초구 서초동 1315 1층33호</a></span> <span
								class="tel"><i class="ico_comm_s tel">tel</i>02)533 -
									3365</span> <a href="javascript:fnGoJunHome('F20160426105241')"
								class="btn_type1" title="새창">홈페이지</a>
							</em> <span class="like"><span class="ico_comm_s like2">공감</span>3</span>
						</div>
					</li>
						...
						<div class="lp_wrap" style="width: 700px;">
							<div class="inner">
								<div class="lp_con">
									<div class="list_review">
										<div class="in">
											<span class="info_wrap2"> <em><span
													class="ico_comm_s location5"></span>강원도 정선군 신동읍</em><span>토지</span><span>매매</span><span>4,628㎡</span>
											</span>
											<div class="info_wrap2">매매가 21,000 ~ 21,000 만원</div>
											<!-- //2017.08.23 수정 -->
											...
											<!-- <span class="info_wrap2"> -->
											<span class="info_wrap1"> <!-- //2017.08.23 수정 --> <span><span
													class="ico_comm_s writer">작성자</span>kiss0208***</span> <span>2019.04.04</span>
											</span>
										</div>
										<div class="profile1">
											<!-- 2017.08.23 수정 -->
							...
							<span class="like"><span class="ico_comm_s like2">공감</span>24</span> -->
											<em class="title_s">거래전담 공인중개사</em> <span class="thumb"><img
												src="https://image.r114.co.kr/brokersimages/2016/05/F20160426105241_photo03_non.jpg"
												border="0"></span> <span class="info"> <span
												class="shop"><i class="ico_class c">C</i>강남공인중개사사무소</span> <span
												class="address"><i class="ico_comm_s home">주소</i><a
													href="javascript:;"
													onclick="fnMapLayerPop(this, 'popup','','','F20160426105241')"
													class="link_blue">서울특별시 서초구 서초동 1315 1층33호</a></span> <span
												class="tel"><i class="ico_comm_s tel">tel</i>02)533 -
													3365</span> <a href="javascript:fnGoJunHome('F20160426105241')"
												class="btn_type1" title="새창">홈페이지</a> <a
												href="javascript:fnGoJunHomeMemul('F20160426105241')"
												class="btn_type1" target="_blank">매물보기</a>
											</span> <span class="like"><span class="ico_comm_s like2">공감</span>3</span>
											<!-- //2017.08.23 수정 -->
										</div>
										<!-- 2017.08.23 추가 -->
										<!--
					...
					<li>
						<div class="in">
							<span class="area"><span class="ico_comm_s location5">위치</span>대구광역시
								달서구 이곡동</span> <span class="info_wrap2"> <span>원룸</span><span>월세</span>
							</span> <span class="txt">보증금 500 만원 / 월세 43 ~ 45 만원</span> <strong
								class="ellip">거래완료 되었습니다</strong>
							<p>부동산을 통하여 중개 거래완료 되었습니다 감사합니다 부동산114 많은사람들에 알려져 사업이번창하기를
								기원합니다 다시한번 감사 드립니다ㆍ</p>
							<a href="javascript:" class="btn_type2"
								onclick="openLp('#lp_layout_332')" style="display:">더보기<span
								class="ico_comm_s arrow1"></span></a> <span class="info_wrap2">
						...
						<div class="profile1">
							<strong>거래전담 공인중개사</strong> <span class="thumb"></span> <em
								class="info"> <span class="shop"><i
									class="ico_class r">R</i>동우부동산중개사무소</span> <span class="juso"><i
									class="ico_comm_s home">주소</i><a href="javascript:;"
									onclick="fnMapLayerPop(this, 'popup','','','F04027041600012')"
									class="link_blue">대구광역시 달서구 장기동 131-1 3층</a></span> <span class="tel"><i
									class="ico_comm_s tel">tel</i>053)583 - 7722</span> <a
								href="javascript:fnGoJunHome('F04027041600012')"
								class="btn_type1" title="새창">홈페이지</a>
							</em> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
						</div>
					</li>
					...
					<div id="lp_layout_332">
						<div class="lp_wrap" style="width: 700px;">
							<div class="inner">
								<div class="lp_con">
									<div class="list_review">
										<div class="in">
											<span class="info_wrap2"> <em><span
													class="ico_comm_s location5"></span>대구광역시 달서구 이곡동</em><span>원룸</span><span>월세</span><span>52㎡</span>
											</span>
											<div class="info_wrap2">보증금 500 만원 / 월세 43 ~ 45 만원</div>
											<!-- //2017.08.23 수정 -->
											<strong>거래완료 되었습니다</strong>
											<p>부동산을 통하여 중개 거래완료 되었습니다 감사합니다 부동산114 많은사람들에 알려져
												사업이번창하기를 기원합니다 다시한번 감사 드립니다ㆍ</p>
											<!-- 2017.08.23 수정 -->
											<!-- <span class="info_wrap2"> -->
											<span class="info_wrap1"> <!-- //2017.08.23 수정 --> <span><span
													class="ico_comm_s writer">작성자</span>du637***</span> <span>2019.04.02</span>
											</span>
										</div>
										<div class="profile1">
											<!-- 2017.08.23 수정 -->
							...
							<span class="like"><span class="ico_comm_s like2">공감</span>24</span> -->
											<em class="title_s">거래전담 공인중개사</em> <span class="thumb"></span>
											<span class="info"> <span class="shop"><i
													class="ico_class r">R</i>동우부동산중개사무소</span> <span class="address"><i
													class="ico_comm_s home">주소</i><a href="javascript:;"
													onclick="fnMapLayerPop(this, 'popup','','','F04027041600012')"
													class="link_blue">대구광역시 달서구 장기동 131-1 3층</a></span> <span
												class="tel"><i class="ico_comm_s tel">tel</i>053)583
													- 7722</span> <a href="javascript:fnGoJunHome('F04027041600012')"
												class="btn_type1" title="새창">홈페이지</a> <a
												href="javascript:fnGoJunHomeMemul('F04027041600012')"
												class="btn_type1" target="_blank">매물보기</a>
											</span> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
											<!-- //2017.08.23 수정 -->
										</div>
					...
					<li>
						<div class="in">
							<span class="area"><span class="ico_comm_s location5">위치</span>서울특별시
								동대문구 장안동</span> <span class="info_wrap2"> <span>아파트</span><span>전세</span>
							</span> <span class="txt">전세가 30,000 ~ 30,000 만원</span> <strong
								class="ellip">빠른 시간 내에 집을 구할 수 있었습니다.</strong>
							<p>요즘 거래가 어렵네요 대출규제로 더욱 그런거 같아요 최소한 돈 융통은 되게 해 줘야지 이게 사는건지</p>
							<a href="javascript:" class="btn_type2"
								onclick="openLp('#lp_layout_331')" style="display:">더보기<span
								class="ico_comm_s arrow1"></span></a> <span class="info_wrap2">
						...
						<div class="profile1">
							<strong>거래전담 공인중개사</strong> <span class="thumb"><img
								src="https://image.r114.co.kr/brokersimages/2014/01/F20080729090104_photo02_np.jpg"
								border="0"></span> <em class="info"> <span class="shop"><i
									class="ico_class c">C</i>뉴서울공인중개사사무소</span> <span class="juso"><i
									class="ico_comm_s home">주소</i><a href="javascript:;"
									onclick="fnMapLayerPop(this, 'popup','','','F20080729090104')"
									class="link_blue">서울특별시 동대문구 전농동 687 신성미소지움 101동 상가 101호</a></span> <span
								class="tel"><i class="ico_comm_s tel">tel</i>02)2246 -
									9444</span> <a href="javascript:fnGoJunHome('F20080729090104')"
								class="btn_type1" title="새창">홈페이지</a>
							</em> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
						</div>
					</li>
						...
						<div class="lp_wrap" style="width: 700px;">
							<div class="inner">
								<div class="lp_con">
									<div class="list_review">
										<div class="in">
											<span class="info_wrap2"> <em><span
													class="ico_comm_s location5"></span>서울특별시 동대문구 장안동</em><span>아파트</span><span>전세</span><span>107/84㎡</span>
											</span>
											<div class="info_wrap2">전세가 30,000 ~ 30,000 만원</div>
											<!-- //2017.08.23 수정 -->
											<strong>빠른 시간 내에 집을 구할 수 있었습니다.</strong>
											<p>요즘 거래가 어렵네요 대출규제로 더욱 그런거 같아요 최소한 돈 융통은 되게 해 줘야지 이게
												사는건지</p>
											<!-- 2017.08.23 수정 -->
											<!-- <span class="info_wrap2"> -->
											<span class="info_wrap1"> <!-- //2017.08.23 수정 --> <span><span
													class="ico_comm_s writer">작성자</span>ujbhwd***</span> <span>2019.03.30</span>
											</span>
										</div>
										<div class="profile1">
											<!-- 2017.08.23 수정 -->
							...
							<span class="like"><span class="ico_comm_s like2">공감</span>24</span> -->
											<em class="title_s">거래전담 공인중개사</em> <span class="thumb"><img
												src="https://image.r114.co.kr/brokersimages/2014/01/F20080729090104_photo02_np.jpg"
												border="0"></span> <span class="info"> <span
												class="shop"><i class="ico_class c">C</i>뉴서울공인중개사사무소</span>
												<span class="address"><i class="ico_comm_s home">주소</i><a
													href="javascript:;"
													onclick="fnMapLayerPop(this, 'popup','','','F20080729090104')"
													class="link_blue">서울특별시 동대문구 전농동 687 신성미소지움 101동 상가
														101호</a></span> <span class="tel"><i class="ico_comm_s tel">tel</i>02)2246
													- 9444</span> <a href="javascript:fnGoJunHome('F20080729090104')"
												class="btn_type1" title="새창">홈페이지</a> <a
												href="javascript:fnGoJunHomeMemul('F20080729090104')"
												class="btn_type1" target="_blank">매물보기</a>
											</span> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
											<!-- //2017.08.23 수정 -->
										</div>
					...
					<li>
						<div class="in">
							<span class="area"><span class="ico_comm_s location5">위치</span>대전광역시
								서구 둔산동</span> <span class="info_wrap2"> <span>오피스텔</span><span>매매</span>
							</span> <span class="txt">매매가 5,300 ~ 5,300 만원</span> <strong
								class="ellip">잘 부탁합니다</strong>
							<p>한마루 공인중개사님 안녕하세요 원활한 중개가 될 수 있도록 잘 부탁 드립니다 좋은날 되세요</p>
							<a href="javascript:" class="btn_type2"
								onclick="openLp('#lp_layout_330')" style="display:">더보기<span
								class="ico_comm_s arrow1"></span></a> <span class="info_wrap2">
						...
						<div class="profile1">
							<strong>거래전담 공인중개사</strong> <span class="thumb"><img
								src="https://image.r114.co.kr/brokersimages/2018/01/F20151130121250_photo02_np.jpg"
								border="0"></span> <em class="info"> <span class="shop"><i
									class="ico_class c">C</i>한마루공인</span> <span class="juso"><i
									class="ico_comm_s home">주소</i><a href="javascript:;"
									onclick="fnMapLayerPop(this, 'popup','','','F20151130121250')"
									class="link_blue">대전광역시 서구 둔산동 1383 상가106호(둔산동,햇님아파트)</a></span> <span
								class="tel"><i class="ico_comm_s tel">tel</i>042)487 -
									5454</span> <a href="javascript:fnGoJunHome('F20151130121250')"
								class="btn_type1" title="새창">홈페이지</a>
							</em> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
						</div>
					</li>
						...
						<div class="lp_wrap" style="width: 700px;">
							<div class="inner">
								<div class="lp_con">
									<div class="list_review">
										<div class="in">
											<span class="info_wrap2"> <em><span
													class="ico_comm_s location5"></span>대전광역시 서구 둔산동</em><span>오피스텔</span><span>매매</span><span>54/27㎡</span>
											</span>
											<div class="info_wrap2">매매가 5,300 ~ 5,300 만원</div>
											<!-- //2017.08.23 수정 -->
											...
											<!-- <span class="info_wrap2"> -->
											<span class="info_wrap1"> <!-- //2017.08.23 수정 --> <span><span
													class="ico_comm_s writer">작성자</span>ad79ya***</span> <span>2019.03.28</span>
											</span>
										</div>
										<div class="profile1">
											<!-- 2017.08.23 수정 -->
							...
							<span class="like"><span class="ico_comm_s like2">공감</span>24</span> -->
											<em class="title_s">거래전담 공인중개사</em> <span class="thumb"><img
												src="https://image.r114.co.kr/brokersimages/2018/01/F20151130121250_photo02_np.jpg"
												border="0"></span> <span class="info"> <span
												class="shop"><i class="ico_class c">C</i>한마루공인</span> <span
												class="address"><i class="ico_comm_s home">주소</i><a
													href="javascript:;"
													onclick="fnMapLayerPop(this, 'popup','','','F20151130121250')"
													class="link_blue">대전광역시 서구 둔산동 1383 상가106호(둔산동,햇님아파트)</a></span> <span
												class="tel"><i class="ico_comm_s tel">tel</i>042)487
													- 5454</span> <a href="javascript:fnGoJunHome('F20151130121250')"
												class="btn_type1" title="새창">홈페이지</a> <a
												href="javascript:fnGoJunHomeMemul('F20151130121250')"
												class="btn_type1" target="_blank">매물보기</a>
											</span> <span class="like"><span class="ico_comm_s like2">공감</span>0</span>
											<!-- //2017.08.23 수정 -->
										</div>
				...
				<div class="paging">
					<strong><span class="skip">현재페이지</span>1</strong><a
						...
						href="javascript:goPage(8, 1);">8</a><a
						href="javascript:goPage(9, 1);">9</a><a
						href="javascript:goPage(10, 1);">10</a><a
						href="javascript:next_page(1);"><span
			...
			<!-- 라이트 시작 -->
			<div class="right_wrap" id="divAskRight">
		...
		<span class="ico_comm_l zoomin"></span>
				...
				<div class="bx_gray banner">
					<a href="/?_c=lots&amp;_m=ipjuinfo&amp;_a=ipjunews" class="bn_a">
						...
						<p>
							매물 찾기부터 입주까지<br> 필요한 정보를 드려요!
						</p> <span class="ico_comm_l  move_ico"></span>
					</a>
				</div>
						...
						<div class="slide_type6">
							<div class="bx-wrapper" style="max-width: 100%;">
								<div class="bx-viewport" aria-live="polite"
									style="width: 100%; overflow: hidden; position: relative; height: 164px;">
									<ul
										style="width: 4215%; position: relative; transition-duration: 0s; transform: translate3d(-760px, 0px, 0px);">
										<li
											style="float: left; list-style: none; position: relative; width: 190px;"
											class="bx-clone" aria-hidden="true"><a
											href="/?_c=lots&amp;_m=lotsnews&amp;_a=newsdetail&amp;bno=70&amp;kind=&amp;search_keyword=&amp;search_writer=&amp;search_addr1=&amp;search_addr2=&amp;search_addr3=&amp;sort=1&amp;page=1&amp;num=14286"
											class="thumb_wrap"> <span class="thumb gra"><img
													src="https://image.r114.co.kr/images/r114/2014/jo_h20190325.png"
													width="190" height="120" alt=""></span> <strong class="tit"><b>현대건설
														힐스테이트 리뉴얼로No.1 브랜드 위상 강화</b> </strong> <!--<span class="desc">  힐스테이트의 새로운 브랜드 철학 "라이프스타일 리더"
 현대건설, 힐스테이트 리뉴얼로 No.1 브랜드 위상 강화 
  ...
  - 소비자 인지도 제고 위한 브랜드명 한글 적용 및 로..</span>-->
										...
										<li
											style="float: left; list-style: none; position: relative; width: 190px;"
											aria-hidden="true"><a
											href="/?_c=lots&amp;_m=lotsnews&amp;_a=newsdetail&amp;bno=70&amp;kind=&amp;search_keyword=&amp;search_writer=&amp;search_addr1=&amp;search_addr2=&amp;search_addr3=&amp;sort=1&amp;page=1&amp;num=14290"
											class="thumb_wrap"> <span class="thumb gra"><img
													src="https://image.r114.co.kr/images/r114/2014/jo_g20190405.png"
													width="190" height="120" alt=""></span> <strong class="tit">트리플역세권으로
													강남까지 더 빠르게! "금정역동양라파크"</strong> <!--<span class="desc">   
  모집문의: 1666-0881 
  - 1-4호선, GTX금정역 트리플역세권
 - 강남까지 10분대!
   ...
   금정역동양라파크 에서 아파트 조합원 모집을 모집 중이다. 경..</span>-->
										...
										<li
											style="float: left; list-style: none; position: relative; width: 190px;"
											aria-hidden="true"><a
											href="/?_c=lots&amp;_m=lotsnews&amp;_a=newsdetail&amp;bno=70&amp;kind=&amp;search_keyword=&amp;search_writer=&amp;search_addr1=&amp;search_addr2=&amp;search_addr3=&amp;sort=1&amp;page=1&amp;num=14288"
											class="thumb_wrap"> <span class="thumb gra"><img
													src="https://image.r114.co.kr/images/r114/2014/jo_g20190402.jpg"
													width="190" height="120" alt=""></span> <strong class="tit">송파대우이안(이스트원),다세권
  ...
  - 거여역 0.3km 초 역세권
   ...
   송파대우이안(이스트원) 에서 아파트 조합원 모집을 모집 중이다. 서울시 송파구 거여동 17-9..</span>-->
										...
										<li
											style="float: left; list-style: none; position: relative; width: 190px;"
											aria-hidden="true"><a
											href="/?_c=lots&amp;_m=lotsnews&amp;_a=newsdetail&amp;bno=70&amp;kind=&amp;search_keyword=&amp;search_writer=&amp;search_addr1=&amp;search_addr2=&amp;search_addr3=&amp;sort=1&amp;page=1&amp;num=14287"
											class="thumb_wrap"> <span class="thumb gra"><img
													src="https://image.r114.co.kr/images/r114/2014/jo_g20190326.jpg"
													width="190" height="120" alt=""></span> <strong class="tit">GS건설
													방배그랑자이 4월 분양예정</strong> <!--<span class="desc">  ◆ 방배경남아파트 재건축 전용면적 59~84㎡ 256가구 일반분양 예정
 ...
 - 강남까지 10분대!
   ...
   금정역동양라파크 에서 아파트 조합원 모집을 모집 중이다. 경..</span>-->
				...
				<div class="bx_gray">
					...
					<div class="bn_iframe researchRightAds">
						<iframe src="" scrolling="no" marginheight="0" marginwidth="0"
							frameborder="0" width="100%" height="194"></iframe>
					</div>
					<!-- //프로모션 -->
				</div>
				<div class="bx_gray">
					...
					<div class="inner issue">
						...
						<a href="/?_c=Research&amp;_m=ReportNews&amp;_a=HotIssue"
							class="txt_wrap"> <strong class="fc_blue">벚꽃분양과 집들이</strong>
							<span style="height: 40px;">부동산114는 벚꽃이 활짝 피는 4~5월에 분양,
								입주예정인 아파트 중 실수요가 ..</span>
						</a>
						<div class="info_wrap2">
							<span>2019.04</span><span>관련기사:<em class="fc_blue">3</em>건
							</span>
						</div>
						<a href="/?_c=Research&amp;_m=ReportNews&amp;_a=HotIssue"
							class="more_type1" title="요즘 뜨는 이슈">더보기 <span
				...
				<div class="bx_gray">
					...
					<div class="inner weekly">
						...
						<ol class="list_num_type1">
							...
							<li><a
								href="javascript:fnResearchDetail(62, '', 247, 'weeklytips')">리모델링과는
									다른 리노베이션</a></li>

							<li><a
								href="javascript:fnResearchDetail(62, '', 246, 'weeklytips')">홈
									인스펙션이란?</a></li>

							<li><a
								href="javascript:fnResearchDetail(62, '', 245, 'weeklytips')">공인중개사와
									부동산중개인은 다르다</a></li>

							<li><a
								href="javascript:fnResearchDetail(62, '', 244, 'weeklytips')">입주자
									사전방문제도</a></li>

						</ol>
						<a href="/?_c=Research&amp;_m=KnowHow&amp;_a=WeeklyTips"
				...
				<div class="bx_gray banner">
					<a href="/?_c=Research&amp;_m=Guide" class="bn_a"> <strong>영상제작
							의뢰</strong>
						<p>
							맞춤 보도자료<br>영상 신청
						</p> <span class="ico_comm_l mp"></span>
					</a>
				</div>
...
$(document).ready(function() {
	...
	*/
	...
	<iframe name="easyXDM_Kakao_default1365_provider"
		...
		src="https://kapi.kakao.com/cors/?xdm_e=https%3A%2F%2Fwww.r114.com&amp;xdm_c=default1365&amp;xdm_p=1"
		...
		<div
			...
			<div>
				<iframe name="fb_xdm_frame_https" frameborder="0"
					...
					src="https://staticxx.facebook.com/connect/xd_arbiter/r/d_vbiawPdxB.js?version=44#channel=f17cf19cf475b7c&amp;origin=https%3A%2F%2Fwww.r114.com"
