...
<meta id="metaURL" property="og:url" content="https://www.r114.com/Default.asp?_c=ask&amp;_m=asklist">
...
</script><script src="https://cr.acecounter.com/Web/AceCounter_AW.js?gc=AH6A41105368933&amp;py=0&amp;gd=gtb14&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1554693874368" type="text/javascript"></script>
	...
	<div class="body_wrap">
        ...
        <div class="contents_wrap">
			...
			<div class="info_smr bm" style="background-image:url(https://image.r114.co.kr/W1/images/sub/bg_info_ask.jpg);">
				<div class="inner">
					<strong>지역내 베테랑 중개사무소를 통해 고객님의<br> 부동산거래를 지원합니다.</strong>
					<p>지역내 프리미엄 중개사무소를 중심으로 1:1 책임중개를 지원합니다. <br>
					의뢰하신 매물은 부동산114 매물메뉴에도 홍보되어 빠른 거래를 지원합니다.</p>
					<div class="mgt2">
						<a href="javascript:" class="btn_type1" id="cmdGoAskSell">내놓기 의뢰하기</a>
						<a href="javascript:" class="btn_type1" id="cmdGoAskBuy">구하기 의뢰하기</a>
					</div>
				</div>
			</div>
			...
			<div class="tab_btn">
				<ul class="tab_list">
					<li id="sellbuyType2" class="on">내놓기</li>
					<li id="sellbuyType1"><a href="${pageContext.request.contextPath}/eroe/eroeStatus_tab2">구하기</a></li>
				</ul>
			...
			<ul class="list_sell">	
				<li class="on">
					<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=102912"> -->
					<!--<a href='/?_c=memul&_m=HouseDetail&mulcode=102912'> -->
					<div class="s1">
						<strong class="in">
							<span class="tag_comm type14">접수</span>
							<span class="area"><span class="ico_comm_s location5">위치</span>경상북도 영천시 북안면</span>
							<span class="info_wrap2">
								<span>토지</span>
								<span>매매</span>
								<span>27,438㎡</span>
								<span><span class="ico_comm_s writer">작성자</span>grsanga1</span><!--2017-10-30 작성자 날짜 조회수 추가-->
                                <span>2019.04.08</span>								
							</span>
						</strong>
						<span class="in2"><span class="tag_comm type15">매매</span> <span class="txt">매매가 37,000 ~ 39,000만원</span></span>
						<a href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=102912" class="more_type1" style="" target="_blank">해당매물보기 <span class="ico_comm_s more1"> </span></a>					
					</div>
					<!--</a> -->	
					<div class="s2"><p>거래희망 중개사무소가 선택되었습니다.</p><div class="slide_type4">	<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" aria-live="polite" style="width: 100%; overflow: hidden; position: relative; height: 180px;"><ul style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2018/12/F20170216123625_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>대겸공인중개사사무소<em>대표 : 우대겸 054 ) 333 - 8249</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20170216123625')" class="link_blue">경상북도 영천시 야사동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 0건</span><span>토지,아파트,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20170216123625')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20170216123625', '대겸공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20170216123625')"> 매물보기</button>	</div></div><p>안녕하십니까? 대겸공인중개사사무소입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" aria-hidden="false"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2018/12/F20170216123625_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>대겸공인중개사사무소<em>대표 : 우대겸 054 ) 333 - 8249</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20170216123625')" class="link_blue">경상북도 영천시 야사동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 0건</span><span>토지,아파트,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20170216123625')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20170216123625', '대겸공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20170216123625')"> 매물보기</button>	</div></div><p>안녕하십니까? 대겸공인중개사사무소입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li>	<li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2018/12/F20170216123625_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>대겸공인중개사사무소<em>대표 : 우대겸 054 ) 333 - 8249</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20170216123625')" class="link_blue">경상북도 영천시 야사동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 0건</span><span>토지,아파트,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20170216123625')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20170216123625', '대겸공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20170216123625')"> 매물보기</button>	</div></div><p>안녕하십니까? 대겸공인중개사사무소입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div></div>	</div>					
				</li>
	
				<li class="on">
					<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=102911"> -->
					<!--<a href='/?_c=memul&_m=HouseDetail&mulcode=102911'> -->
					<div class="s1">
						<strong class="in">
							<span class="tag_comm type14">접수</span>
							<span class="area"><span class="ico_comm_s location5">위치</span>경기도 고양시 중산동 중산코오롱2단지</span>
							<span class="info_wrap2">
								<span>아파트</span>
								<span>매매</span>
								<span>67/49㎡</span>
								<span><span class="ico_comm_s writer">작성자</span>jys120459***</span><!--2017-10-30 작성자 날짜 조회수 추가-->
                                <span>2019.04.08</span>								
							</span>
						</strong>
						<span class="in2"><span class="tag_comm type15">매매</span> <span class="txt">매매가 16,000 ~ 16,000만원</span></span>
						<a href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=102911" class="more_type1" style="" target="_blank">해당매물보기 <span class="ico_comm_s more1"> </span></a>					
					</div>
					<!--</a> -->	
					<div class="s2"><p>거래희망 중개사무소가 선택되었습니다.</p><div class="slide_type4">	<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" aria-live="polite" style="width: 100%; overflow: hidden; position: relative; height: 199px;"><ul style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2015/10/F20141103184159_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>산들마을공인<em>대표 : 안희순 031 ) 925 - 0022</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20141103184159')" class="link_blue">경기도 고양시 중산동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 116건</span><span>아파트,상가,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20141103184159')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20141103184159', '산들마을공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20141103184159')"> 매물보기</button>	</div></div><p>안녕하십니까? 산들마을공인입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" aria-hidden="false"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2015/10/F20141103184159_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>산들마을공인<em>대표 : 안희순 031 ) 925 - 0022</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20141103184159')" class="link_blue">경기도 고양시 중산동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 116건</span><span>아파트,상가,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20141103184159')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20141103184159', '산들마을공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20141103184159')"> 매물보기</button>	</div></div><p>안녕하십니까? 산들마을공인입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li>	<li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2015/10/F20141103184159_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>산들마을공인<em>대표 : 안희순 031 ) 925 - 0022</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20141103184159')" class="link_blue">경기도 고양시 중산동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 116건</span><span>아파트,상가,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20141103184159')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20141103184159', '산들마을공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20141103184159')"> 매물보기</button>	</div></div><p>안녕하십니까? 산들마을공인입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div></div>	</div>					
				</li>
	
				<li class="on">
					<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=102910"> -->
					<!--<a href='/?_c=memul&_m=HouseDetail&mulcode=102910'> -->
					<div class="s1">
						<strong class="in">
							<span class="tag_comm type14">접수</span>
							<span class="area"><span class="ico_comm_s location5">위치</span>경기도 고양시 대화동 힐스테이트일산</span>
							<span class="info_wrap2">
								<span>오피스텔</span>
								<span>월세</span>
								<span>168/84㎡</span>
								<span><span class="ico_comm_s writer">작성자</span>gpapple***</span><!--2017-10-30 작성자 날짜 조회수 추가-->
                                <span>2019.04.08</span>								
							</span>
						</strong>
						<span class="in2"><span class="tag_comm type15">월세</span> <span class="txt">보증금 10,000 / 월세 70 ~ 80만원</span></span>
						<a href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=102910" class="more_type1" style="" target="_blank">해당매물보기 <span class="ico_comm_s more1"> </span></a>					
					</div>
					<!--</a> -->	
					<div class="s2"><p>거래희망 중개사무소가 선택되었습니다.</p><div class="slide_type4">	<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" aria-live="polite" style="width: 100%; overflow: hidden; position: relative; height: 180px;"><ul style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2012/03/F20091123104818_photo02_np.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>킨텍스한화공인<em>대표 : 양혜숙 031 ) 923 - 0088</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20091123104818')" class="link_blue">경기도 고양시 대화동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 79건</span><span>아파트,오피스텔,아파트분양권</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20091123104818')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20091123104818', '킨텍스한화공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20091123104818')"> 매물보기</button>	</div></div><p>안녕하십니까? 킨텍스한화공인입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" aria-hidden="false"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2012/03/F20091123104818_photo02_np.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>킨텍스한화공인<em>대표 : 양혜숙 031 ) 923 - 0088</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20091123104818')" class="link_blue">경기도 고양시 대화동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 79건</span><span>아파트,오피스텔,아파트분양권</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20091123104818')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20091123104818', '킨텍스한화공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20091123104818')"> 매물보기</button>	</div></div><p>안녕하십니까? 킨텍스한화공인입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li>	<li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2012/03/F20091123104818_photo02_np.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>킨텍스한화공인<em>대표 : 양혜숙 031 ) 923 - 0088</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20091123104818')" class="link_blue">경기도 고양시 대화동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 79건</span><span>아파트,오피스텔,아파트분양권</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20091123104818')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20091123104818', '킨텍스한화공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20091123104818')"> 매물보기</button>	</div></div><p>안녕하십니까? 킨텍스한화공인입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div></div>	</div>					
				</li>
	
				<li class="on">
					<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=102909"> -->
					<!--<a href='/?_c=memul&_m=HouseDetail&mulcode=102909'> -->
					<div class="s1">
						<strong class="in">
							<span class="tag_comm type14">접수</span>
							<span class="area"><span class="ico_comm_s location5">위치</span>경기도 시흥시 정왕동</span>
							<span class="info_wrap2">
								<span>상가</span>
								<span>매매</span>
								<span>436㎡</span>
								<span><span class="ico_comm_s writer">작성자</span>sjk112602</span><!--2017-10-30 작성자 날짜 조회수 추가-->
                                <span>2019.04.08</span>								
							</span>
						</strong>
						<span class="in2"><span class="tag_comm type15">매매</span> <span class="txt">매매가 26,000 ~ 26,000만원</span></span>
						<a href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=102909" class="more_type1" style="" target="_blank">해당매물보기 <span class="ico_comm_s more1"> </span></a>					
					</div>
					<!--</a> -->	
					<div class="s2"><p>거래희망 중개사무소가 선택되었습니다.</p><div class="slide_type4">	<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" aria-live="polite" style="width: 100%; overflow: hidden; position: relative; height: 180px;"><ul style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2014/03/F20140325174955_photo02_np.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>부동산하우스공인<em>대표 : 박인자 031 ) 498 - 8900</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20140325174955')" class="link_blue">경기도 시흥시 정왕동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 50건</span><span>아파트,상가,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20140325174955')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20140325174955', '부동산하우스공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20140325174955')"> 매물보기</button>	</div></div><p>안녕하십니까? 부동산하우스공인입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" aria-hidden="false"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2014/03/F20140325174955_photo02_np.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>부동산하우스공인<em>대표 : 박인자 031 ) 498 - 8900</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20140325174955')" class="link_blue">경기도 시흥시 정왕동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 50건</span><span>아파트,상가,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20140325174955')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20140325174955', '부동산하우스공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20140325174955')"> 매물보기</button>	</div></div><p>안녕하십니까? 부동산하우스공인입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li>	<li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2014/03/F20140325174955_photo02_np.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>부동산하우스공인<em>대표 : 박인자 031 ) 498 - 8900</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20140325174955')" class="link_blue">경기도 시흥시 정왕동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 50건</span><span>아파트,상가,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20140325174955')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20140325174955', '부동산하우스공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20140325174955')"> 매물보기</button>	</div></div><p>안녕하십니까? 부동산하우스공인입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div></div>	</div>					
				</li>
	
				<li class="on">
					<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=102907"> -->
					<!--<a href='/?_c=memul&_m=HouseDetail&mulcode=102907'> -->
					<div class="s1">
						<strong class="in">
							<span class="tag_comm type14">접수</span>
							<span class="area"><span class="ico_comm_s location5">위치</span>서울특별시 서초구 잠원동</span>
							<span class="info_wrap2">
								<span>상가</span>
								<span>월세</span>
								<span>99/99㎡</span>
								<span><span class="ico_comm_s writer">작성자</span>aanke***</span><!--2017-10-30 작성자 날짜 조회수 추가-->
                                <span>2019.04.08</span>								
							</span>
						</strong>
						<span class="in2"><span class="tag_comm type15">월세</span> <span class="txt">보증금 3,000 / 월세 240 ~ 240만원</span></span>
						<a href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=102907" class="more_type1" style="" target="_blank">해당매물보기 <span class="ico_comm_s more1"> </span></a>					
					</div>
					<!--</a> -->	
					<div class="s2"><p>거래희망 중개사무소가 선택되었습니다.</p><div class="slide_type4">	<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" aria-live="polite" style="width: 100%; overflow: hidden; position: relative; height: 256px;"><ul style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2016/05/F20160426105241_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>강남공인중개사사무소<em>대표 : 고광영 02 ) 533 - 3365</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20160426105241')" class="link_blue">서울특별시 서초구 서초동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 17건</span><span>상가,상가건물,아파트</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20160426105241')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20160426105241', '강남공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20160426105241')"> 매물보기</button>	</div></div><p>안녕하십니까? 강남공인중개사사무소입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br><br>전국상가 매매전문 강남 부동산 입니다.<br>저희에게 맏겨주세요.<br><br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" aria-hidden="false"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2016/05/F20160426105241_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>강남공인중개사사무소<em>대표 : 고광영 02 ) 533 - 3365</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20160426105241')" class="link_blue">서울특별시 서초구 서초동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 17건</span><span>상가,상가건물,아파트</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20160426105241')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20160426105241', '강남공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20160426105241')"> 매물보기</button>	</div></div><p>안녕하십니까? 강남공인중개사사무소입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br><br>전국상가 매매전문 강남 부동산 입니다.<br>저희에게 맏겨주세요.<br><br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li>	<li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2016/05/F20160426105241_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>강남공인중개사사무소<em>대표 : 고광영 02 ) 533 - 3365</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20160426105241')" class="link_blue">서울특별시 서초구 서초동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 17건</span><span>상가,상가건물,아파트</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20160426105241')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20160426105241', '강남공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20160426105241')"> 매물보기</button>	</div></div><p>안녕하십니까? 강남공인중개사사무소입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br><br>전국상가 매매전문 강남 부동산 입니다.<br>저희에게 맏겨주세요.<br><br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div></div>	</div>					
				</li>
	
				<li class="on">
					<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=102906"> -->
					<!--<a href='/?_c=memul&_m=HouseDetail&mulcode=102906'> -->
					<div class="s1">
						<strong class="in">
							<span class="tag_comm type14">접수</span>
							<span class="area"><span class="ico_comm_s location5">위치</span>부산광역시 남구 용호동 삼성</span>
							<span class="info_wrap2">
								<span>아파트</span>
								<span>매매</span>
								<span>59/48㎡</span>
								<span><span class="ico_comm_s writer">작성자</span>부산시민</span><!--2017-10-30 작성자 날짜 조회수 추가-->
                                <span>2019.04.08</span>								
							</span>
						</strong>
						<span class="in2"><span class="tag_comm type15">매매</span> <span class="txt">매매가 7,500 ~ 7,500만원</span></span>
						<a href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=102906" class="more_type1" style="" target="_blank">해당매물보기 <span class="ico_comm_s more1"> </span></a>					
					</div>
					<!--</a> -->	
					<div class="s2"><p>거래희망 중개사무소가 선택되었습니다.</p><div class="slide_type4">	<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" aria-live="polite" style="width: 100%; overflow: hidden; position: relative; height: 199px;"><ul style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2019/03/F20140220151724_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>코리아예가부동산<em>대표 : 양진희 051 ) 621 - 1515</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20140220151724')" class="link_blue">부산광역시 남구 용호동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 52건</span><span>아파트,주택,상가</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20140220151724')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20140220151724', '코리아예가부동산 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20140220151724')"> 매물보기</button>	</div></div><p>안녕하십니까? 코리아예가부동산입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>적극적인 광고와 더불어<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" aria-hidden="false"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2019/03/F20140220151724_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>코리아예가부동산<em>대표 : 양진희 051 ) 621 - 1515</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20140220151724')" class="link_blue">부산광역시 남구 용호동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 52건</span><span>아파트,주택,상가</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20140220151724')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20140220151724', '코리아예가부동산 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20140220151724')"> 매물보기</button>	</div></div><p>안녕하십니까? 코리아예가부동산입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>적극적인 광고와 더불어<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li>	<li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2019/03/F20140220151724_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>코리아예가부동산<em>대표 : 양진희 051 ) 621 - 1515</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20140220151724')" class="link_blue">부산광역시 남구 용호동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 52건</span><span>아파트,주택,상가</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20140220151724')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20140220151724', '코리아예가부동산 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20140220151724')"> 매물보기</button>	</div></div><p>안녕하십니까? 코리아예가부동산입니다.<br>고객님께서 2019.04.08에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>적극적인 광고와 더불어<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div></div>	</div>					
				</li>
	
				<li class="on">
					<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=102896"> -->
					<!--<a href='/?_c=memul&_m=HouseDetail&mulcode=102896'> -->
					<div class="s1">
						<strong class="in">
							<span class="tag_comm type14">접수</span>
							<span class="area"><span class="ico_comm_s location5">위치</span>경기도 용인시 보정동</span>
							<span class="info_wrap2">
								<span>단독다가구</span>
								<span>매매</span>
								<span>265/155㎡</span>
								<span><span class="ico_comm_s writer">작성자</span>haromk2</span><!--2017-10-30 작성자 날짜 조회수 추가-->
                                <span>2019.04.07</span>								
							</span>
						</strong>
						<span class="in2"><span class="tag_comm type15">매매</span> <span class="txt">매매가 165,000 ~ 170,000만원</span></span>
						<a href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=102896" class="more_type1" style="" target="_blank">해당매물보기 <span class="ico_comm_s more1"> </span></a>					
					</div>
					<!--</a> -->	
					<div class="s2"><p>거래희망 중개사무소가 선택되었습니다.</p><div class="slide_type4">	<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" aria-live="polite" style="width: 100%; overflow: hidden; position: relative; height: 180px;"><ul style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2018/12/F20181206142521_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>죽전아이파크공인중개사사무소<em>대표 : 박영미 031 ) 897 - 5000</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20181206142521')" class="link_blue">경기도 용인시 보정동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 63건</span><span>아파트,오피스텔,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20181206142521')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20181206142521', '죽전아이파크공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20181206142521')"> 매물보기</button>	</div></div><p>안녕하십니까? 죽전아이파크공인중개사사무소입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" aria-hidden="false"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2018/12/F20181206142521_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>죽전아이파크공인중개사사무소<em>대표 : 박영미 031 ) 897 - 5000</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20181206142521')" class="link_blue">경기도 용인시 보정동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 63건</span><span>아파트,오피스텔,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20181206142521')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20181206142521', '죽전아이파크공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20181206142521')"> 매물보기</button>	</div></div><p>안녕하십니까? 죽전아이파크공인중개사사무소입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li>	<li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2018/12/F20181206142521_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>죽전아이파크공인중개사사무소<em>대표 : 박영미 031 ) 897 - 5000</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20181206142521')" class="link_blue">경기도 용인시 보정동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 63건</span><span>아파트,오피스텔,주택</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20181206142521')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20181206142521', '죽전아이파크공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20181206142521')"> 매물보기</button>	</div></div><p>안녕하십니까? 죽전아이파크공인중개사사무소입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div></div>	</div>					
				</li>
	
				<li class="on">
					<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=102888"> -->
					<!--<a href='/?_c=memul&_m=HouseDetail&mulcode=102888'> -->
					<div class="s1">
						<strong class="in">
							<span class="tag_comm type14">접수</span>
							<span class="area"><span class="ico_comm_s location5">위치</span>서울특별시 광진구 광장동 광장현대홈타운12차</span>
							<span class="info_wrap2">
								<span>아파트</span>
								<span>매매</span>
								<span>177/143㎡</span>
								<span><span class="ico_comm_s writer">작성자</span>hglee219</span><!--2017-10-30 작성자 날짜 조회수 추가-->
                                <span>2019.04.07</span>								
							</span>
						</strong>
						<span class="in2"><span class="tag_comm type15">매매</span> <span class="txt">매매가 160,000 ~ 160,000만원</span></span>
						<a href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=102888" class="more_type1" style="" target="_blank">해당매물보기 <span class="ico_comm_s more1"> </span></a>					
					</div>
					<!--</a> -->	
					<div class="s2"><p>거래희망 중개사무소가 선택되었습니다.</p><div class="slide_type4">	<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" aria-live="polite" style="width: 100%; overflow: hidden; position: relative; height: 180px;"><ul style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2014/10/F01061432000047_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>부동산1번지현대프라임공인<em>대표 : 김중학 02 ) 458 - 5959</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F01061432000047')" class="link_blue">서울특별시 광진구 구의동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 33건</span><span>아파트,상가</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F01061432000047')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F01061432000047', '부동산1번지현대프라임공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F01061432000047')"> 매물보기</button>	</div></div><p>안녕하십니까? 부동산1번지현대프라임공인입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" aria-hidden="false"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2014/10/F01061432000047_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>부동산1번지현대프라임공인<em>대표 : 김중학 02 ) 458 - 5959</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F01061432000047')" class="link_blue">서울특별시 광진구 구의동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 33건</span><span>아파트,상가</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F01061432000047')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F01061432000047', '부동산1번지현대프라임공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F01061432000047')"> 매물보기</button>	</div></div><p>안녕하십니까? 부동산1번지현대프라임공인입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li>	<li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2014/10/F01061432000047_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>부동산1번지현대프라임공인<em>대표 : 김중학 02 ) 458 - 5959</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F01061432000047')" class="link_blue">서울특별시 광진구 구의동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 33건</span><span>아파트,상가</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F01061432000047')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F01061432000047', '부동산1번지현대프라임공인 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F01061432000047')"> 매물보기</button>	</div></div><p>안녕하십니까? 부동산1번지현대프라임공인입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div></div>	</div>					
				</li>
	
				<li class="on">
					<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=102879"> -->
					<!--<a href='/?_c=memul&_m=HouseDetail&mulcode=102879'> -->
					<div class="s1">
						<strong class="in">
							<span class="tag_comm type14">접수</span>
							<span class="area"><span class="ico_comm_s location5">위치</span>강원도 평창군 대관령면</span>
							<span class="info_wrap2">
								<span>토지</span>
								<span>매매</span>
								<span>19,500㎡</span>
								<span><span class="ico_comm_s writer">작성자</span>skysys2000***</span><!--2017-10-30 작성자 날짜 조회수 추가-->
                                <span>2019.04.07</span>								
							</span>
						</strong>
						<span class="in2"><span class="tag_comm type15">매매</span> <span class="txt">매매가 800,000 ~ 800,000만원</span></span>
						<a href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=102879" class="more_type1" style="" target="_blank">해당매물보기 <span class="ico_comm_s more1"> </span></a>					
					</div>
					<!--</a> -->	
					<div class="s2"><p>거래희망 중개사무소가 선택되었습니다.</p><div class="slide_type4">	<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" aria-live="polite" style="width: 100%; overflow: hidden; position: relative; height: 256px;"><ul style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2016/05/F20160426105241_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>강남공인중개사사무소<em>대표 : 고광영 02 ) 533 - 3365</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20160426105241')" class="link_blue">서울특별시 서초구 서초동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 17건</span><span>상가,상가건물,아파트</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20160426105241')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20160426105241', '강남공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20160426105241')"> 매물보기</button>	</div></div><p>안녕하십니까? 강남공인중개사사무소입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>전국토지매매 강남부동산 입니다.<br>저희에게 맏겨주세요<br><br><br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" aria-hidden="false"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2016/05/F20160426105241_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>강남공인중개사사무소<em>대표 : 고광영 02 ) 533 - 3365</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20160426105241')" class="link_blue">서울특별시 서초구 서초동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 17건</span><span>상가,상가건물,아파트</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20160426105241')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20160426105241', '강남공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20160426105241')"> 매물보기</button>	</div></div><p>안녕하십니까? 강남공인중개사사무소입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>전국토지매매 강남부동산 입니다.<br>저희에게 맏겨주세요<br><br><br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li>	<li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2016/05/F20160426105241_photo03_non.jpg" border="0"></span>		<div class="txt">			<i class="ico_class c">C</i>강남공인중개사사무소<em>대표 : 고광영 02 ) 533 - 3365</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20160426105241')" class="link_blue">서울특별시 서초구 서초동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 17건</span><span>상가,상가건물,아파트</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20160426105241')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20160426105241', '강남공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20160426105241')"> 매물보기</button>	</div></div><p>안녕하십니까? 강남공인중개사사무소입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>전국토지매매 강남부동산 입니다.<br>저희에게 맏겨주세요<br><br><br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div></div>	</div>					
				</li>
	
				<li class="on">
					<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=102878"> -->
					<!--<a href='/?_c=memul&_m=HouseDetail&mulcode=102878'> -->
					<div class="s1">
						<strong class="in">
							<span class="tag_comm type14">접수</span>
							<span class="area"><span class="ico_comm_s location5">위치</span>경기도 김포시 북변동</span>
							<span class="info_wrap2">
								<span>연립빌라다세대</span>
								<span>매매</span>
								<span>55/71㎡</span>
								<span><span class="ico_comm_s writer">작성자</span>choieunmi2476***</span><!--2017-10-30 작성자 날짜 조회수 추가-->
                                <span>2019.04.07</span>								
							</span>
						</strong>
						<span class="in2"><span class="tag_comm type15">매매</span> <span class="txt">매매가 19,500 ~ 19,500만원</span></span>
						<a href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=102878" class="more_type1" style="" target="_blank">해당매물보기 <span class="ico_comm_s more1"> </span></a>					
					</div>
					<!--</a> -->	
					<div class="s2"><p>거래희망 중개사무소가 선택되었습니다.</p><div class="slide_type4">	<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" aria-live="polite" style="width: 100%; overflow: hidden; position: relative; height: 180px;"><ul style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2018/12/F20090813181135_photo02_np.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>쌍용1번지공인중개사사무소<em>대표 : 이흥진 031 - 983 - 4343</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20090813181135')" class="link_blue">경기도 김포시 장기동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 7건</span><span>아파트,상가,아파트분양권</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20090813181135')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20090813181135', '쌍용1번지공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20090813181135')"> 매물보기</button>	</div></div><p>안녕하십니까? 쌍용1번지공인중개사사무소입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li><li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" aria-hidden="false"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2018/12/F20090813181135_photo02_np.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>쌍용1번지공인중개사사무소<em>대표 : 이흥진 031 - 983 - 4343</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20090813181135')" class="link_blue">경기도 김포시 장기동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 7건</span><span>아파트,상가,아파트분양권</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20090813181135')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20090813181135', '쌍용1번지공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20090813181135')"> 매물보기</button>	</div></div><p>안녕하십니까? 쌍용1번지공인중개사사무소입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li>	<li style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;" class="bx-clone" aria-hidden="true"><div class="list_office">	<div class="cont">		<span class="thumb"><img src="https://image.r114.co.kr/brokersimages/2018/12/F20090813181135_photo02_np.jpg" border="0"></span>		<div class="txt">			<i class="ico_class r">R</i>쌍용1번지공인중개사사무소<em>대표 : 이흥진 031 - 983 - 4343</em><br>			<p class="juso"><i class="ico_comm_s home">지도보기</i><a href="javascript:;" onclick="fnMapLayerPop(this, 'popup','','','F20090813181135')" class="link_blue">경기도 김포시 장기동</a></p>			<em class="info_wrap2"><span class="m_num">전체 보유매물 : 7건</span><span>아파트,상가,아파트분양권</span></em>		</div>	</div>	<div class="btn_wrap">		<button class="btn_type1" onclick="fnGoJunHome('F20090813181135')" )"=""> 홈페이지</button>		<button class="btn_type1" onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20090813181135', '쌍용1번지공인중개사사무소 ', '', '', '1')">1:1문의</button>		<button class="btn_type1" onclick="fnGoJunHomeMemul('F20090813181135')"> 매물보기</button>	</div></div><p>안녕하십니까? 쌍용1번지공인중개사사무소입니다.<br>고객님께서 2019.04.07에 부동산114의 중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div></div>	</div>					
				</li>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		// 찾아주세요 등록 페이지로 이동
		$("#cmdGoAskBuy").on("click", function(e) {
...
</script><iframe name="easyXDM_Kakao_default1223_provider" id="easyXDM_Kakao_default1223_provider" src="https://kapi.kakao.com/cors/?xdm_e=https%3A%2F%2Fwww.r114.com&amp;xdm_c=default1223&amp;xdm_p=1" frameborder="0" style="position: absolute; top: -2000px; left: 0px;"></iframe><div id="fb-root" class=" fb_reset"><div style="position: absolute; top: -10000px; width: 0px; height: 0px;"><div><iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" src="https://staticxx.facebook.com/connect/xd_arbiter/r/d_vbiawPdxB.js?version=44#channel=f1fc4fcd62a4754&amp;origin=https%3A%2F%2Fwww.r114.com" style="border: none;"></iframe></div><div></div></div></div></body></html>