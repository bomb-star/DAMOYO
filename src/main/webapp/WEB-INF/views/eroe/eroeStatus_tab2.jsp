...
<meta id="metaURL" property="og:url"
	content="https://www.r114.com/Default.asp?_c=ask&amp;_m=asklist&amp;sellbuyType=1">
...
<script
	src="https://cr.acecounter.com/Web/AceCounter_AW.js?gc=AH6A41105368933&amp;py=0&amp;gd=gtb14&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1554694274205"
	...
	<div id="body_layout">
		<div class="body_wrap">
			...
			<div class="contents_wrap">
				...
				<div class="tab_btn">
					<ul class="tab_list">
						<li id="sellbuyType2"><a
							href="${pageContext.request.contextPath}/eroe/eroeStatus">내놓기</a></li>
						<li id="sellbuyType1" class="on">구하기</li>
					</ul>
					<a href="javascript:" class="btn_type1" id="cmdMyAsking">나의
						의뢰현황</a>
				</div>
				<div class="sort_wrap">
					<!--<a href="#none">전체</a>-->
					<a href="#none" class="selected">접수</a> <a href="#none">의뢰중</a>
				</div>

				<ul class="list_sell">
					<li class="">
						<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=14455"> --> <!--<a {매물상세링크}> -->
						<div class="s1">
							<strong class="in"> <span class="tag_comm type14">접수</span>
								<span class="area"><span class="ico_comm_s location5">위치</span>서울특별시
									노원구 공릉동 공릉우성</span> <span class="info_wrap2"> <span>아파트</span>
									<span>매매</span> <span>66 ~ 98㎡</span> <span><span
										class="ico_comm_s writer">작성자</span>mintaroma86***</span>
								<!--2017-10-30 작성자 날짜 조회수 추가--> <span>2019.04.08</span>
							</span>
							</strong> <span class="in2"><span class="tag_comm type15">매매</span>
								<span class="txt">매수가 30,000 ~ 39,999만원</span></span> <a
								href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=14455"
								class="more_type1" style="display: none" target="_blank">해당매물보기
								<span class="ico_comm_s more1"> </span>
							</a>
						</div> <!--</a> -->
						<div class="s2">
							<p>거래희망 중개사무소가 선택되었습니다.</p>
							<div class="slide_type4">
								<div class="bx-wrapper" style="max-width: 100%;">
									<div class="bx-viewport" aria-live="polite"
										style="width: 100%; overflow: hidden; position: relative; height: 199px;">
										<ul
											style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);">
											<li
												style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;"
												class="bx-clone" aria-hidden="true"><div
													class="list_office">
													<div class="cont">
														<span class="thumb"></span>
														<div class="txt">
															<i class="ico_class p">P</i>JK부동산공인중개사무소<em>대표 : 이형숙
																070 ) 4042 - 8950</em><br>
															<p class="juso">
																<i class="ico_comm_s home">홈페이지</i><a
																	href="javascript:;"
																	onclick="fnMapLayerPop(this, 'popup','','','F20180511163044')"
																	class="link_blue">인천광역시 부평구 부평동</a>
															</p>
															<em class="info_wrap2"><span class="m_num">전체
																	보유매물 : 0건</span><span>주택,상가,오피스텔</span></em>
														</div>
													</div>
													<div class="btn_wrap">
														<button class="btn_type1"
															onclick="fnGoJunHome('F20180511163044')">홈페이지</button>
														<button class="btn_type1"
															onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20180511163044', 'JK부동산공인중개사무소 ', '', '', '1')">1:1문의</button>
														<button class="btn_type1"
															onclick="fnGoJunHomeMemul('F20180511163044')">
															매물보기</button>
													</div>
												</div>
												<p>
													안녕하십니까? JK부동산공인중개사무소입니다.<br>고객님께서 2019.04.08에 부동산114의
													중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>수도권 최대 중개네트워크
													JK공인중개사무소 최팀장입니다. 중개업소 선택해주시면 매물의뢰 진행해드리겠습니다. 감사합니다.<br>거래가
													성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.
												</p></li>
											<li
												style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;"
												aria-hidden="false"><div class="list_office">
													<div class="cont">
														<span class="thumb"></span>
														<div class="txt">
															<i class="ico_class p">P</i>JK부동산공인중개사무소<em>대표 : 이형숙
					...
					<li class="">
						<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=14445"> --> <!--<a {매물상세링크}> -->
						<div class="s1">
							<strong class="in"> <span class="tag_comm type14">접수</span>
								<span class="area"><span class="ico_comm_s location5">위치</span>경기도
									용인시 죽전동 꽃메마을IPARK</span> <span class="info_wrap2"> <span>아파트</span>
									<span>매매</span> <span>132 ~ 152㎡</span> <span><span
										class="ico_comm_s writer">작성자</span>buraboman***</span>
								<!--2017-10-30 작성자 날짜 조회수 추가--> <span>2019.04.04</span>
							</span>
							</strong> <span class="in2"><span class="tag_comm type15">매매</span>
								<span class="txt">매수가 46,000 ~ 48,000만원</span></span> <a
								href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=14445"
								class="more_type1" style="display: none" target="_blank">해당매물보기
								<span class="ico_comm_s more1"> </span>
							</a>
						</div> <!--</a> -->
												...
												class="bx-clone" aria-hidden="true"><div
													...
													<div class="cont">
														<span class="thumb"><img
															src="https://image.r114.co.kr/BrokersImagesSub/F20140508172646_photo_junmain_reg1.png"
															border="0"></span>
														<div class="txt">
															<i class="ico_class r">R</i>신촌부동산공인<em>대표 : 정희선 031
																) 898 - 2300</em><br>
															<p class="juso">
																<i class="ico_comm_s home">홈페이지</i><a
																	href="javascript:;"
																	onclick="fnMapLayerPop(this, 'popup','','','F20140508172646')"
																	class="link_blue">경기도 용인시 보정동</a>
															</p>
															<em class="info_wrap2"><span class="m_num">전체
																	보유매물 : 65건</span><span>아파트,상가,주택</span></em>
														</div>
													</div>
													<div class="btn_wrap">
														<button class="btn_type1"
															onclick="fnGoJunHome('F20140508172646')">홈페이지</button>
														<button class="btn_type1"
															onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20140508172646', '신촌부동산공인 ', '', '', '1')">1:1문의</button>
														<button class="btn_type1"
															onclick="fnGoJunHomeMemul('F20140508172646')">
															매물보기</button>
													</div>
												</div>
												<p>
													안녕하십니까? 신촌부동산공인입니다.<br>고객님께서 2019.04.04에 부동산114의
													중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>저희 부동산으로 연락주시면 더욱
													성심성의껏 최선을 다하겠습니다~<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.
												</p></li>
											<li
												style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;"
												aria-hidden="false"><div class="list_office">
					...
					<li class="">
						<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=14443"> --> <!--<a {매물상세링크}> -->
						<div class="s1">
							<strong class="in"> <span class="tag_comm type14">접수</span>
								<span class="area"><span class="ico_comm_s location5">위치</span>대전광역시
									유성구 원신흥동</span> <span class="info_wrap2"> <span>원룸</span> <span>전세</span>
									<span>0 ~ 0㎡</span> <span><span
										class="ico_comm_s writer">작성자</span>namyh358***</span>
								<!--2017-10-30 작성자 날짜 조회수 추가--> <span>2019.04.03</span>
							</span>
							</strong> <span class="in2"><span class="tag_comm type15">전세</span>
								<span class="txt">전세가 0 ~ 10,000만원</span></span> <a
								href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=14443"
								class="more_type1" style="display: none" target="_blank">해당매물보기
								<span class="ico_comm_s more1"> </span>
							</a>
						</div> <!--</a> -->
						<div class="s2">
							...
							<div class="slide_type4">
								<div class="bx-wrapper" style="max-width: 100%;">
									<div class="bx-viewport" aria-live="polite"
										style="width: 100%; overflow: hidden; position: relative; height: 180px;">
										<ul
											style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);">
											<li
												style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;"
												class="bx-clone" aria-hidden="true"><div
													...
													<div class="cont">
														<span class="thumb"><img
															src="https://image.r114.co.kr/brokersimages/2019/03/F20190108172345_photo02_np.jpg"
															border="0"></span>
														<div class="txt">
															<i class="ico_class c">C</i>반석원공인중개사사무소<em>대표 : 이현중
																042 ) 823 - 3900</em><br>
															<p class="juso">
																<i class="ico_comm_s home">홈페이지</i><a
																	href="javascript:;"
																	onclick="fnMapLayerPop(this, 'popup','','','F20190108172345')"
																	class="link_blue">대전광역시 유성구 반석동</a>
															</p>
															<em class="info_wrap2"><span class="m_num">전체
																	보유매물 : 8건</span><span>상가,사무실</span></em>
														</div>
													</div>
													<div class="btn_wrap">
														<button class="btn_type1"
															onclick="fnGoJunHome('F20190108172345')">홈페이지</button>
														<button class="btn_type1"
															onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20190108172345', '반석원공인중개사사무소 ', '', '', '1')">1:1문의</button>
														<button class="btn_type1"
															onclick="fnGoJunHomeMemul('F20190108172345')">
															매물보기</button>
													</div>
												</div>
												<p>
													안녕하십니까? 반석원공인중개사사무소입니다.<br>고객님께서 2019.04.03에 부동산114의
													중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가
													최선을 다하겠습니다.<br>감사합니다.
												</p></li>
											<li
												style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;"
					...
					<li class="">
						<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=14442"> --> <!--<a {매물상세링크}> -->
						<div class="s1">
							<strong class="in"> <span class="tag_comm type14">접수</span>
								<span class="area"><span class="ico_comm_s location5">위치</span>경기도
									수원시 권선동 한양</span> <span class="info_wrap2"> <span>아파트</span> <span>전세</span>
									<span>49 ~ 82㎡</span> <span><span
										class="ico_comm_s writer">작성자</span>dkwl237</span>
								<!--2017-10-30 작성자 날짜 조회수 추가--> <span>2019.04.03</span>
							</span>
							</strong> <span class="in2"><span class="tag_comm type15">전세</span>
								<span class="txt">전세가 0 ~ 12,000만원</span></span> <a
								href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=14442"
								class="more_type1" style="display: none" target="_blank">해당매물보기
								<span class="ico_comm_s more1"> </span>
							</a>
						</div> <!--</a> -->
										...
										<ul
											...
											<li
												...
												class="bx-clone" aria-hidden="true"><div
													...
													<div class="cont">
														<span class="thumb"><img
															src="https://image.r114.co.kr/brokersimages/2018/06/F02104413900047_photo03_non.jpg"
															border="0"></span>
														<div class="txt">
															<i class="ico_class r">R</i>대신공인<em>대표 : 왕예숙 031 )
																232 - 3337</em><br>
															<p class="juso">
																<i class="ico_comm_s home">홈페이지</i><a
																	href="javascript:;"
																	onclick="fnMapLayerPop(this, 'popup','','','F02104413900047')"
																	class="link_blue">경기도 수원시 권선동</a>
															</p>
															<em class="info_wrap2"><span class="m_num">전체
																	보유매물 : 60건</span><span>아파트,상가,주택</span></em>
														</div>
													</div>
													<div class="btn_wrap">
														<button class="btn_type1"
															onclick="fnGoJunHome('F02104413900047')">홈페이지</button>
														<button class="btn_type1"
															onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F02104413900047', '대신공인 ', '', '', '1')">1:1문의</button>
														<button class="btn_type1"
															onclick="fnGoJunHomeMemul('F02104413900047')">
															매물보기</button>
													</div>
												</div>
												<p>
													안녕하십니까? 대신공인입니다.<br>고객님께서 2019.04.03에 부동산114의 중개의뢰서비스를
													통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가 최선을
													다하겠습니다.<br>감사합니다.
												</p></li>
											<li
												style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;"
					...
					<li class="">
						<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=14440"> --> <!--<a {매물상세링크}> -->
						<div class="s1">
							<strong class="in"> <span class="tag_comm type14">접수</span>
								<span class="area"><span class="ico_comm_s location5">위치</span>경기도
									평택시 합정동</span> <span class="info_wrap2"> <span>연립빌라다세대</span> <span>전세</span>
									<span>82 ~ 82㎡</span> <span><span
										class="ico_comm_s writer">작성자</span>zzalsdn90***</span>
								<!--2017-10-30 작성자 날짜 조회수 추가--> <span>2019.04.03</span>
							</span>
							</strong> <span class="in2"><span class="tag_comm type15">전세</span>
								<span class="txt">전세가 12,000 ~ 12,000만원</span></span> <a
								href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=14440"
								class="more_type1" style="display: none" target="_blank">해당매물보기
								<span class="ico_comm_s more1"> </span>
							</a>
						</div> <!--</a> -->
						<div class="s2">
							...
							<div class="slide_type4">
								<div class="bx-wrapper" style="max-width: 100%;">
									<div class="bx-viewport" aria-live="polite"
										style="width: 100%; overflow: hidden; position: relative; height: 218px;">
										<ul
											style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);">
											<li
												style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;"
												class="bx-clone" aria-hidden="true"><div
													...
													<div class="cont">
														<span class="thumb"><img
															src="https://image.r114.co.kr/brokersimages/2019/03/F20141126130230_photo03_non.jpg"
															border="0"></span>
														<div class="txt">
															<i class="ico_class r">R</i>박사공인중개사<em>대표 : 박화숙 010
																- 2090 - 3290</em><br>
															<p class="juso">
																<i class="ico_comm_s home">홈페이지</i><a
																	href="javascript:;"
																	onclick="fnMapLayerPop(this, 'popup','','','F20141126130230')"
																	class="link_blue">경기도 평택시 용이동</a>
															</p>
															<em class="info_wrap2"><span class="m_num">전체
																	보유매물 : 156건</span><span>주택,토지,상가건물</span></em>
														</div>
													</div>
													<div class="btn_wrap">
														<button class="btn_type1"
															onclick="fnGoJunHome('F20141126130230')">홈페이지</button>
														<button class="btn_type1"
															onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20141126130230', '박사공인중개사 ', '', '', '1')">1:1문의</button>
														<button class="btn_type1"
															onclick="fnGoJunHomeMemul('F20141126130230')">
															매물보기</button>
													</div>
												</div>
												<p>
													안녕하십니까? 박사공인중개사입니다.<br>고객님께서 2019.04.03에 부동산114의
													중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>전화번호를 문자로 주셔봐요<br>
													010-2090-3290<br>거래가 성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.
												</p></li>
											<li
												style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;"
												aria-hidden="false"><div class="list_office">
					...
					<li class="">
						<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=14438"> --> <!--<a {매물상세링크}> -->
						<div class="s1">
							<strong class="in"> <span class="tag_comm type14">접수</span>
								<span class="area"><span class="ico_comm_s location5">위치</span>인천광역시
									연수구 송도동 송도더샵퍼스트월드2차</span> <span class="info_wrap2"> <span>오피스텔</span>
									<span>전세</span> <span>15 ~ 85㎡</span> <span><span
										class="ico_comm_s writer">작성자</span>날씨좋다</span>
								<!--2017-10-30 작성자 날짜 조회수 추가--> <span>2019.04.02</span>
							</span>
							</strong> <span class="in2"><span class="tag_comm type15">전세</span>
								<span class="txt">전세가 1,000 ~ 10,000만원</span></span> <a
								href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=14438"
								class="more_type1" style="display: none" target="_blank">해당매물보기
								<span class="ico_comm_s more1"> </span>
							</a>
						</div> <!--</a> -->
										...
										<ul
											...
											<li
												...
												class="bx-clone" aria-hidden="true"><div
													...
													<div class="cont">
														<span class="thumb"><img
															src="https://image.r114.co.kr/brokersimages/2017/02/F20161102151931_photo03_non.jpg"
															border="0"></span>
														<div class="txt">
															<i class="ico_class r">R</i>송도나라공인중개사사무소<em>대표 : 양현주
																032 ) 811 - 8001</em><br>
															<p class="juso">
																<i class="ico_comm_s home">홈페이지</i><a
																	href="javascript:;"
																	onclick="fnMapLayerPop(this, 'popup','','','F20161102151931')"
																	class="link_blue">인천광역시 연수구 송도동</a>
															</p>
															<em class="info_wrap2"><span class="m_num">전체
																	보유매물 : 183건</span><span>상가,아파트,오피스텔</span></em>
														</div>
													</div>
													<div class="btn_wrap">
														<button class="btn_type1"
															onclick="fnGoJunHome('F20161102151931')">홈페이지</button>
														<button class="btn_type1"
															onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20161102151931', '송도나라공인중개사사무소 ', '', '', '1')">1:1문의</button>
														<button class="btn_type1"
															onclick="fnGoJunHomeMemul('F20161102151931')">
															매물보기</button>
													</div>
												</div>
												<p>
													안녕하십니까? 송도나라공인중개사사무소입니다.<br>고객님께서 2019.04.02에 부동산114의
													중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가
													최선을 다하겠습니다.<br>감사합니다.
												</p></li>
											<li
					...
					<li class="">
						<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=14437"> --> <!--<a {매물상세링크}> -->
						<div class="s1">
							<strong class="in"> <span class="tag_comm type14">접수</span>
								<span class="area"><span class="ico_comm_s location5">위치</span>경기도
									성남시 수진동</span> <span class="info_wrap2"> <span>단독다가구</span> <span>매매</span>
									<span>132 ~ 164㎡</span> <span><span
										class="ico_comm_s writer">작성자</span>eunyoung4001***</span>
								<!--2017-10-30 작성자 날짜 조회수 추가--> <span>2019.04.01</span>
							</span>
							</strong> <span class="in2"><span class="tag_comm type15">매매</span>
								<span class="txt">매수가 30,000 ~ 39,999만원</span></span> <a
								href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=14437"
								class="more_type1" style="display: none" target="_blank">해당매물보기
								<span class="ico_comm_s more1"> </span>
							</a>
						</div> <!--</a> -->
						<div class="s2">
							...
							<div class="slide_type4">
								<div class="bx-wrapper" style="max-width: 100%;">
									<div class="bx-viewport" aria-live="polite"
										style="width: 100%; overflow: hidden; position: relative; height: 275px;">
										<ul
											style="width: 1215%; position: relative; transition-duration: 0s; transform: translate3d(-666px, 0px, 0px);">
											<li
												style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;"
												class="bx-clone" aria-hidden="true"><div
													...
													<div class="cont">
														<span class="thumb"><img
															src="https://image.r114.co.kr/brokersimages/2015/01/F20121217113346_photo03_non.jpg"
															border="0"></span>
														<div class="txt">
															<i class="ico_class r">R</i>수진역성일(단지내)부동산<em>대표 :
																정옥경 031 ) 756 - 5400</em><br>
															<p class="juso">
																<i class="ico_comm_s home">홈페이지</i><a
																	href="javascript:;"
																	onclick="fnMapLayerPop(this, 'popup','','','F20121217113346')"
																	class="link_blue">경기도 성남시 성남동</a>
															</p>
															<em class="info_wrap2"><span class="m_num">전체
																	보유매물 : 114건</span><span>상가,오피스텔,주택</span></em>
														</div>
													</div>
													<div class="btn_wrap">
														<button class="btn_type1"
															onclick="fnGoJunHome('F20121217113346')">홈페이지</button>
														<button class="btn_type1"
															onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20121217113346', '수진역성일(단지내)부동산 ', '', '', '1')">1:1문의</button>
														<button class="btn_type1"
															onclick="fnGoJunHomeMemul('F20121217113346')">
															매물보기</button>
													</div>
												</div>
												<p>
													안녕하십니까? 수진역성일(단지내)부동산입니다.<br>고객님께서 2019.04.01에 부동산114의
													중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>수진역성일단지내 부동산입니다. <br>수진1동
													주택 19.1평 41500 전세 13000-월세35안고매매<br>신흥1동 20.5평 39500
													보21200월세 30안고 <br>매매 있습니다.다 올수리 된집<br>연락주세요.010-9018-9720<br>거래가
													성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.
												</p></li>
											<li
												style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;"
					...
					<li class="">
						<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=14436"> --> <!--<a {매물상세링크}> -->
						<div class="s1">
							<strong class="in"> <span class="tag_comm type14">접수</span>
								<span class="area"><span class="ico_comm_s location5">위치</span>서울특별시
									송파구 석촌동</span> <span class="info_wrap2"> <span>단독다가구</span> <span>매매</span>
									<span>99 ~ 131㎡</span> <span><span
										class="ico_comm_s writer">작성자</span>eunyoung4001***</span>
								<!--2017-10-30 작성자 날짜 조회수 추가--> <span>2019.04.01</span>
							</span>
							</strong> <span class="in2"><span class="tag_comm type15">매매</span>
								<span class="txt">매수가 30,000 ~ 39,999만원</span></span> <a
								href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=14436"
								class="more_type1" style="display: none" target="_blank">해당매물보기
								<span class="ico_comm_s more1"> </span>
							</a>
						</div> <!--</a> -->
										...
										<ul
											...
											<li
												...
												class="bx-clone" aria-hidden="true"><div
													...
													<div class="cont">
														<span class="thumb"><img
															src="https://image.r114.co.kr/brokersimages/2013/11/F01181381300088_photo02_np.jpg"
															border="0"></span>
														<div class="txt">
															<i class="ico_class r">R</i>행운공인중개사<em>대표 : 송한철 02 )
																448 - 8489</em><br>
															<p class="juso">
																<i class="ico_comm_s home">홈페이지</i><a
																	href="javascript:;"
																	onclick="fnMapLayerPop(this, 'popup','','','F01181381300088')"
																	class="link_blue">서울특별시 송파구 오금동</a>
															</p>
															<em class="info_wrap2"><span class="m_num">전체
																	보유매물 : 146건</span><span>아파트,주택,사무실</span></em>
														</div>
													</div>
													<div class="btn_wrap">
														<button class="btn_type1"
															onclick="fnGoJunHome('F01181381300088')">홈페이지</button>
														<button class="btn_type1"
															onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F01181381300088', '행운공인중개사 ', '', '', '1')">1:1문의</button>
														<button class="btn_type1"
															onclick="fnGoJunHomeMemul('F01181381300088')">
															매물보기</button>
													</div>
												</div>
												<p>
													안녕하십니까? 행운공인중개사입니다.<br>고객님께서 2019.04.01에 부동산114의
													중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가
													최선을 다하겠습니다.<br>감사합니다.
												</p></li>
											<li
					...
					<li class="">
						<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=14435"> --> <!--<a {매물상세링크}> -->
						<div class="s1">
							<strong class="in"> <span class="tag_comm type14">접수</span>
								<span class="area"><span class="ico_comm_s location5">위치</span>경기도
									고양시 일산동</span> <span class="info_wrap2"> <span>연립빌라다세대</span> <span>전세</span>
									<span>56 ~ 82㎡</span> <span><span
										class="ico_comm_s writer">작성자</span>무적트윈스</span>
								<!--2017-10-30 작성자 날짜 조회수 추가--> <span>2019.04.01</span>
							</span>
							</strong> <span class="in2"><span class="tag_comm type15">전세</span>
								<span class="txt">전세가 7,000 ~ 10,000만원</span></span> <a
								href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=14435"
								class="more_type1" style="display: none" target="_blank">해당매물보기
								<span class="ico_comm_s more1"> </span>
							</a>
						</div> <!--</a> -->
										...
										<ul
											...
											<li
												...
												class="bx-clone" aria-hidden="true"><div
													...
													<div class="cont">
														<span class="thumb"><img
															src="https://image.r114.co.kr/brokersimages/2014/07/F02014113200026_photo02_np.jpg"
															border="0"></span>
														<div class="txt">
															<i class="ico_class r">R</i>현대공인<em>대표 : 최선숙 031 )
																915 - 0405</em><br>
															<p class="juso">
																<i class="ico_comm_s home">홈페이지</i><a
																	href="javascript:;"
																	onclick="fnMapLayerPop(this, 'popup','','','F02014113200026')"
																	class="link_blue">경기도 고양시 일산동</a>
															</p>
															<em class="info_wrap2"><span class="m_num">전체
																	보유매물 : 116건</span><span>아파트,주택,사무실</span></em>
														</div>
													</div>
													<div class="btn_wrap">
														<button class="btn_type1"
															onclick="fnGoJunHome('F02014113200026')">홈페이지</button>
														<button class="btn_type1"
															onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F02014113200026', '현대공인 ', '', '', '1')">1:1문의</button>
														<button class="btn_type1"
															onclick="fnGoJunHomeMemul('F02014113200026')">
															매물보기</button>
													</div>
												</div>
												<p>
													안녕하십니까? 현대공인입니다.<br>고객님께서 2019.04.01에 부동산114의 중개의뢰서비스를
													통해 등록하신 매물을 중개하고자 합니다.<br>현대부동산입니다,가능한 물건이 있습니다.<br>거래가
													성사될 수 있도록 저희가 최선을 다하겠습니다.<br>감사합니다.
												</p></li>
											<li
												style="float: left; list-style: none; position: relative; margin-right: 10px; width: 656px;"
					...
					<li class="">
						<!-- <a href="/?_c=memul&_m=HouseDetail&mulcode=14434"> --> <!--<a {매물상세링크}> -->
						<div class="s1">
							<strong class="in"> <span class="tag_comm type14">접수</span>
								<span class="area"><span class="ico_comm_s location5">위치</span>서울특별시
									강북구 수유동</span> <span class="info_wrap2"> <span>사무실</span> <span>월세</span>
									<span>9 ~ 33㎡</span> <span><span
										class="ico_comm_s writer">작성자</span>r114kimid</span>
								<!--2017-10-30 작성자 날짜 조회수 추가--> <span>2019.04.01</span>
							</span>
							</strong> <span class="in2"><span class="tag_comm type15">월세</span>
								<span class="txt">보증금 100만원 / 월세 10 ~ 10만원</span></span> <a
								href="/?_c=memul&amp;_m=HouseDetail&amp;mulcode=14434"
								class="more_type1" style="display: none" target="_blank">해당매물보기
								<span class="ico_comm_s more1"> </span>
							</a>
						</div> <!--</a> -->
										...
										<ul
											...
											<li
												...
												class="bx-clone" aria-hidden="true"><div
													...
													<div class="cont">
														<span class="thumb"><img
															src="https://image.r114.co.kr/brokersimages/2017/12/F20170912164347_photo02_np.jpg"
															border="0"></span>
														<div class="txt">
															<i class="ico_class c">C</i>이오부동산공인중개사사무소<em>대표 :
																이영애 02 ) 988 - 7080</em><br>
															<p class="juso">
																<i class="ico_comm_s home">홈페이지</i><a
																	href="javascript:;"
																	onclick="fnMapLayerPop(this, 'popup','','','F20170912164347')"
																	class="link_blue">서울특별시 강북구 미아동</a>
															</p>
															<em class="info_wrap2"><span class="m_num">전체
																	보유매물 : 161건</span><span>주택,아파트,상가</span></em>
														</div>
													</div>
													<div class="btn_wrap">
														<button class="btn_type1"
															onclick="fnGoJunHome('F20170912164347')">홈페이지</button>
														<button class="btn_type1"
															onclick="openQuestionToAgent('#lp_layout_questionToAgent', '일반문의', 'F20170912164347', '이오부동산공인중개사사무소 ', '', '', '1')">1:1문의</button>
														<button class="btn_type1"
															onclick="fnGoJunHomeMemul('F20170912164347')">
															매물보기</button>
													</div>
												</div>
												<p>
													안녕하십니까? 이오부동산공인중개사사무소입니다.<br>고객님께서 2019.04.01에 부동산114의
													중개의뢰서비스를 통해 등록하신 매물을 중개하고자 합니다.<br>거래가 성사될 수 있도록 저희가
													최선을 다하겠습니다.<br>감사합니다.
												</p></li>
											<li
						...
						<div class="slide_type6">
							<div class="bx-wrapper" style="max-width: 100%;">
								<div class="bx-viewport" aria-live="polite"
									...
									<ul
										style="width: 4215%; position: relative; transition-duration: 0s; transform: translate3d(-190px, 0px, 0px);">
										<li
...
//		$("div.contents_wrap ul.list_review").html("<li>" + util.curPage + " 페이지 자료조회 중 입니다." + "</li>");
	...
	<iframe name="easyXDM_Kakao_default2018_provider"
		id="easyXDM_Kakao_default2018_provider"
		src="https://kapi.kakao.com/cors/?xdm_e=https%3A%2F%2Fwww.r114.com&amp;xdm_c=default2018&amp;xdm_p=1"
		...
		<div
			...
			<div>
				<iframe name="fb_xdm_frame_https" frameborder="0"
					...
					src="https://staticxx.facebook.com/connect/xd_arbiter/r/d_vbiawPdxB.js?version=44#channel=f1a8af350e35a7&amp;origin=https%3A%2F%2Fwww.r114.com"
