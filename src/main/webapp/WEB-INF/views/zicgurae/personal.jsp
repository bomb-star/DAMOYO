			...
			<li class="on">
				<span>
					...
					<div class="layer_menu lm_3">
						<ul>
							<li class="on"><a href="/?_c=service&amp;_s=directdeal&amp;_m=directdeallistPersonal">개인매물</a></li>
...
<div id="body_layout">
		...
		<div class="srch_deal_wrap">
			<div class="inner">
				<span class="inp_slt" style="width:170px">
					<select title="매물종류 선택" id="estateTypeFilter" style="display: none;">
						
					<option value="">매물전체</option><option value="아파트">아파트</option><option value="오피스텔">오피스텔</option><option value="분양권">분양권</option><option value="주택">주택</option><option value="상가주택">상가주택</option><option value="원룸">원룸</option><option value="연립빌라다세대">빌라</option><option value="상가">상가</option><option value="사무실">사무실</option><option value="빌딩">빌딩/건물</option><option value="공장^창고">공장/창고</option><option value="토지">토지</option><option value="숙박콘도펜션">숙박콘도펜션</option><option value="기타">기타</option></select><span tabindex="0" id="estateTypeFilter-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="estateTypeFilter-menu" aria-haspopup="true" title="매물종류 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">매물전체</span></span>
				</span>
				...
				<div id="priceFilterType1">
					...
					<input type="text" class="inp_txt" title="가격 최소값 입력" style="width:168px;" numberonly="true" id="priceFilter1Min" data-min-max="Y" data-price="Y" maxlength="10" disabled=""><span class="txt">~</span>
					<input type="text" class="inp_txt" title="가격 최대값 입력" style="width:168px;margin-left:3px;" numberonly="true" id="priceFilter1Max" data-min-max="Y" data-price="Y" maxlength="10" disabled=""><span class="txt">만원</span>
				...
				<div id="priceFilterType2" style="display: none;">
					...
					<span class="inp_slt" style="width:170px;">
						...
						</select><span tabindex="0" id="priceFilterItem2-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="priceFilterItem2-menu" aria-haspopup="true" title="가격 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">가격 전체</span></span>
					</span>
					<input type="text" class="inp_txt" title="가격 최소값 입력" style="width:98px;" numberonly="true" id="priceFilter2Min" data-min-max="Y" data-price="Y" maxlength="10" disabled=""><span class="txt">~</span>
					<input type="text" class="inp_txt" title="가격 최대값 입력" style="width:98px;" numberonly="true" id="priceFilter2Max" data-min-max="Y" data-price="Y" maxlength="10" disabled=""><span class="txt">만원</span>
			...
			<div class="option_wrap">
				<div>
					<div class="option_item">
						<strong class="option_tit">면적</strong>
						<span class="inp_slt" style="width:120px;">
							<select title="면적 선택" name="searchSize" id="searchSize" style="display: none;">
								
							<option value="전체^">전체</option><option value="0^66">0~66㎡</option><option value="66^99">66㎡~99㎡</option><option value="99^132">99㎡~132㎡</option><option value="132^165">132㎡~165㎡</option><option value="165^198">165㎡~198㎡</option><option value="198^330">198㎡~330㎡</option><option value="330^991">330㎡~991㎡</option><option value="직접입력^">직접입력</option></select><span tabindex="0" id="searchSize-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="searchSize-menu" aria-haspopup="true" title="면적 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">전체</span></span>
						</span>
						<input type="text" class="inp_txt small" title="최소 면적 입력" name="sl" id="sl" maxlength="20" numberonly="true"><span class="txt">~</span>
						<input type="text" class="inp_txt small" title="최대 면적 입력" name="sh" id="sh" maxlength="20" numberonly="true">
						<span class="txt">㎡</span>
					</div>
					<div class="option_item multi_row clsOptionView">
						<div>
							<strong class="option_tit">방수/욕실수</strong>
							<span class="inp_slt">
								<select title="방수 선택" name="bang" id="bang" style="display: none;">
								<!--	<option value="">방수</option> -->
								<option value="">전체</option><option value="1">1개</option><option value="2">2개</option><option value="3">3개</option><option value="4">4개</option><option value="5">5개</option><option value="6">6개</option><option value="7">7개이상</option></select><span tabindex="0" id="bang-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="bang-menu" aria-haspopup="true" title="방수 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">전체</span></span>
							</span>
							<span class="inp_slt">
								<select title="욕실수 선택" name="bath" id="bath" style="display: none;">
									
								<option value="">전체</option><option value="1">1개</option><option value="2">2개</option><option value="3">3개</option><option value="4">4개</option><option value="5">5개이상</option></select><span tabindex="0" id="bath-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="bath-menu" aria-haspopup="true" title="욕실수 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">전체</span></span>
							</span>
						</div>
						<div class="transport">
							<strong class="option_tit">교통정보</strong>
							<span class="inp_slt">
								<select title="호선 선택" name="subl" id="subl" style="display: none;">
	...
	</select><span tabindex="0" id="subl-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="subl-menu" aria-haspopup="true" title="호선 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">호선</span></span>
							</span>
							<span class="inp_slt">
								<select title="역명 선택" name="subn" id="subn" style="display: none;">
									<option value="">역명</option>
								</select><span tabindex="0" id="subn-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="subn-menu" aria-haspopup="true" title="역명 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">역명</span></span>
							</span>
							<span class="inp_slt">
								<select title="이동수단 선택" name="subm" id="subm" style="display: none;">
									
								<option value="">이동수단</option>	
	<option value="1">도보</option>		
	
	<option value="2">버스</option>		
	</select><span tabindex="0" id="subm-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="subm-menu" aria-haspopup="true" title="이동수단 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">이동수단</span></span>
							</span>
							<span class="inp_slt">
								<select title="소요시간 선택" name="subt" id="subt" style="display: none;">
									
								<option value="">소요시간</option><option value="1">1분</option><option value="2">2분</option><option value="3">3분</option><option value="4">4분</option><option value="5">5분</option><option value="6">6분</option><option value="7">7분</option><option value="8">8분</option><option value="9">9분</option><option value="10">10분이상</option></select><span tabindex="0" id="subt-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="subt-menu" aria-haspopup="true" title="소요시간 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">소요시간</span></span>
							</span>
						</div>
					</div>
				</div>
				<button class="btn_detail_option">상세옵션 <span class="ico_comm_s"></span></button><!-- 활성화class="on" -->
			</div>
		</div>
		<!-- //검색 -->
		...
		<div id="list_firstLoad">
			<!-- 그랜드매물 -->
			<h4 class="h4_type4">그랜드매물<a href="javascript:" class="btn_type1 rb" onclick="goSellPage(56);">등록하기</a></h4>
			<ul class="list_thumb_type5">
				
				<li class=" left"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77288')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2019/02/AA52B2F1C90C41CC847244FF4DAC1E92.jpg" alt="">
...
/사기꾼은 경험상 단번에 알아내는 재주가 있으니 시간낭비하지않도록!!</p>
				...
				<li class="type3 "><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77749')">
						<div class="thumb">
...
많은 문의 바랍니다.</p>
				...
				<li class="type3 "><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77738')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2019/03/E190FAC965B34BC9AD4CBA1E6A9945D7.JPG" alt="">
							<span class="tag_comm type4" style="">급매물</span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
				...
				<li class="type1 left"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77735')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2019/03/CEF1C5FDDB324EAD9E4156E4FEC6446D.jpg" alt="">
							<span class="tag_comm " style="display: none"></span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
						...
						<strong class="tit">성남시 수내동 94㎡</strong>
						<p class="desc">-매매양도시 수익률 5%이상 보장 / 면적:실평수 30평대 


-분당 최고 입지 수내역 역세권, 오피스 및 주상복합 밀집지역 핵심 로데오 상권에서 가시성 뛰어난 위치입니다.


-특히 롯데백화점을 중심으로 행정시설, 금융시설, 오피스, 학원가, 쇼핑, 문화 등의 다양한 시설이 밀집되어 있어 직장인은 물론 학생, 가족 단위의 수요층이 평일이나 주말 구분 없이 끊이지 않는 상권으로 주변시세 수익률 5%이상 형성되어 안정적이며 


-롯데 백화점 도보 3분거리로 유동성이 풍부한 입지 / 이 지역 수내역세권에 접한 백현지구에 현대중공업 R&amp;D센터 유치 등 정자역의 네이버본사, SK 하이닉스, 두산분당센터와 함께 대기업 업무중심지로 부상하고 있어 풍부한 배후수요와 함께 고수익 보장 /투자가치가 매우 높은 매물입니다. 
				...
				<li class="wrt ">
					<a href="javascript:" onclick="goSellPage(56);">
						<span class="ico_comm_l r_wrt1"></span>
						<span class="fc_blue2">그랜드 </span>매물 등록하시고 <br>빠른 거래하세요~
			...
			<!-- //그랜드매물 -->
			<!-- 스페셜매물 -->
			<h4 class="h4_type4">스페셜매물<a href="javascript:" class="btn_type1 rb" onclick="goSellPage(58);">등록하기</a></h4>
			<ul class="list_thumb_type5 type2">
				
				<li class="type3"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77789')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2019/04/E3AE5F83866D45AF9E894D7FBD593FCE.jpg" alt="">
						...
						<strong class="tit">성북구 성북동 281㎡</strong>
				...
				<li class="type3"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77717')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/images/r114/2005/common/img_mmex154_land.gif" alt="">
							<span class="tag_comm type4" style="">급매물</span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
						...
						<strong class="tit">홍천군 서면 1,928㎡</strong>
				...
				<li class="type1"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77776')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2019/03/027F0465D58043028884B36F48FE8EB5.jpg" alt="">
							<span class="tag_comm type8" style="">올수리</span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
							연립빌라다세대<br>
						...
						<strong class="tit">안산시 와동 99㎡</strong>
...
-옥상 및 옥상창고  단독 사용 가능</p>
				...
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77765')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2019/03/306A449436724DAEA6650200D0087389.jpg" alt="">
							<span class="tag_comm type4" style="">급매물</span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
						...
						<strong class="tit">연천군 청산면 3,232㎡</strong>
						<p class="desc">1.대지입니다.
2.개발행위허가 및 건축허가 취득했습니다.
3.한탄강 보이며, 가장 위에 있어 전망 좋습니다.
4.모든 건축행위 할 수 있습니다.
5.전체 3,232㎡, 3필지로 나눠놨습니다.
6.현재 바로 붙은 옆 토지 펜션운영중이며 잘됩니다. 인근 군부대 이전으로 면회객 많이 찾고 있습니다.
7.전원주택으로 지을 시 위에 넓게 2동, 아래 기본5개 좋습니다. 펜션으로 지을 시 땅이 넓어 구색 맞춰 지을 수 있습니다.
8.문산-전곡간 고속도로 개통되어 자유로에서 30분 거리입니다.

이것저것 충분히 검토하시고 전화주세요.</p>
					</a>
				</li>
				
				<li class="type1"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77746')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2019/03/3594CA6E9D2C487799FECB93279A4710.jpg" alt="">
							<span class="tag_comm type4" style="">급매물</span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
						...
						<strong class="tit">서대문구 홍은동 71㎡</strong>
						<p class="desc">깨끗하고 조용함.
3호선 홍제역 마을버스 10분거리 위치 교통편리
보온이 잘된집, 한겨울 난방비 7만원 미만, 공동관리비 4만원으로 관리비 저렴</p>
					</a>
				</li>
				
				<li class="type3"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77745')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2019/03/1DDAF4DE344548BFB5DA75E06E332838.jpg" alt="">
							<span class="tag_comm type4" style="">급매물</span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
						...
						<strong class="tit">성남시 정자동 671㎡</strong>
						<p class="desc">- 분당 정자동 까페거리 위치
- 해당 상권에서 보기 힘든 대형 평수
- 같은 오픈형 지하 광장에는 10여개의 음식점 및 까페가 있음 
- 횟집, 일식집, 오락시설 (당구장, PC방, 스크린골프) 및 브런치 까페 입점 유리
- 주변 시세보다 저렴한 매물
- 공실 직전 보증금 1억 2천만, 월세 700만으로 운영되었음</p>
					</a>
				</li>
				
				<li class="type3"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77729')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2017/06/9C06B839C1DD8EE.png" alt="">
							<span class="tag_comm type9" style="">가격저렴</span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
						...
						<strong class="tit">평택시 현덕면 3,956㎡</strong>
						<p class="desc">(현덕면 도대리1건)
●자연녹지지역 (평당 95만원 급매)
-향후 도시개발의 대상이 되는 후보지로 유력한 지역

평택시 현덕면사무소에서5분거리인접(2.3km)소재

(안중읍 성해리 1건 
농림지역 경작중인 답 1.736평방미터 /526평
 1억5천만원에 별도 급매합니다

현덕면-삼성반도체평택캠퍼스에서 20분대에 위치해
주변투자수요가 급부상하며 향후개발전망 밝음
안중읍과 아산호수 인접구역으로 차이나타운
개발설도 겹쳐 호재기대 급매물로 투자가치 상승

(참고)
●수도권남부 신성장동력으로 개발열기고조
고덕국제신도시 조성중
-미군기지 평택이전과 인근에 
삼성전자반도체 단지 조성중
...
●작년12월 평택-수서간 고속철도(src)개통되고
이 철도가 동탄GTX까지 연결되어 평택에서
서울까지는 물론 수도권전역을 3~40분대에
진입할 수 있게됨
-최근 5년간평택지역 집값상승율이  24.91%로전국1</p>
					</a>
				</li>
				
				<li class="type1"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77595')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2019/01/3FE01EA10C774727B5B3EAFC9D3AF952.jpg" alt="">
							<span class="tag_comm " style="display: none"></span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
						...
						<strong class="tit">제주시 한경면 1,984㎡</strong>
						<p class="desc">제주도 해안도로 레스토랑(총 1984㎡(600평)) 매매, 가장 노을이 멋지게 지는 해안도로,
 JTBC "효리네 민박"으로 뜨겁게 떠올라 관광객이 정말 많이 찾는 "신창풍차해안도로" 한 가운데 있는 해안도로에 접한 토지와 레스토랑을 매매합니다. 
전체 3필지(600평)입니다.

-신창리 1353-1(대지) : 813㎡(250평)
-신창리 1353-1(건물) : 총 59평
 .1층:47평(카페(35평, 홀면적 30평) 와 살림집(12평))
 .2층:47평(옥상(35평), 손님용 게스트하우스 (12평)), 추가2층 증축가능
-신창리 1353-2(임야) : 473㎡(140평)
-신창리 1353-3(전) : 698㎡(210평)

*.현재 허가받은 레스토랑 운영중(*.임대중이며 임대료가 계속 상승중)
*.주위에 많은 펜션과 카페들이 생기고 있어 계속 땅값이 오를 전망임
*.거래시 가격 협의 가능합니다</p>
					</a>
				</li>
				
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77432')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2018/11/14DD7EAAD24D417FBDBD46D280612A00.jpg" alt="">
							<span class="tag_comm type9" style="">가격저렴</span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
						...
						<strong class="tit">완도군 청산면 1,098㎡</strong>
						<p class="desc">청산도에서 View 가 가장 좋은 한옥집입니다</p>
					</a>
				</li>
				
				<li class="type3"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('76869')">
						<div class="thumb">
...
* 융자금은 승계가 되지 않습니다</p>
				...
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77093')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2018/03/5BDFE2E916764C9998BD401F60EA541F.jpg" alt="">
							<span class="tag_comm " style="display: none"></span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
						...
						<strong class="tit">평창군 방림면 96㎡</strong>
				...
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77039')">
						<div class="thumb">
							<img src="https://image.r114.co.kr/directimages/2019/03/EBFA7D7934A748A78AE9A194BFF9EA28.JPG" alt="">
							<span class="tag_comm " style="display: none"></span>
						</div>
						<span class="s_type">
							<span class="tag_comm2 type2">월세</span>
							사무실<br>
							보 3,000 만원 / 180 만원
						</span>
						<strong class="tit">동대문구 회기동 96㎡</strong>
						<p class="desc">저희 코레일유통은 입주자분들의 편의성과 쾌적한 사무환경을 조성하기 위해서 최선의 노력을 다하겠습니다~ 보증금 및 월세 협의가 가능하니 많은 문의 부탁드립니다~ 회기역에서 5분거리에 위치하여 접근성이 용이하며, 대학가 상권 중심지에 위치하여 있습니다. 입주자 전용 주차장을 보유하고 있으며 뒷편에 아파트단지가 있습니다.</p>
					</a>
				</li>
			...
			<!-- //스페셜매물 -->
			<!-- 플러스매물 -->
			<h4 class="h4_type4">플러스매물<a href="javascript:" class="btn_type1 rb" onclick="goSellPage(60);">등록하기</a></h4>
			<ul class="list_box_type1">
				
				<li class="type2"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77778')">
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
							토지
						</span>
						<span class="s_type">280,000 만원</span>
						<strong class="tit">경산시 압량면 926㎡</strong>
						<p class="desc">전면 50M 삼면도로 8차선 대로접
영남대역 대구지하철2호선 15분거리
맞은편 대단지아파트 형성 
				...
				<li class="type3"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77767')">
						<span class="s_type">
							<span class="tag_comm2 type2">월세</span>
							연립빌라다세대
						</span>
						<span class="s_type">보 3,000 만원 / 55 만원</span>
						<strong class="tit">당진시 석문면 106㎡</strong>
						<p class="desc">- 당진 석문면 삼봉리 최신 시설 신축 빌라 3,4층 으로 매매,전세,월세 가능(협의)
- 주인 개인 소유로 3,4층 입주 가능
-  당진 삼봉리 초등학교,중학교 앞  최적의 중심가에 위치,주변 편의시설 이용가능(은행,하나로마트,식당,가게등)
- 바다 전망(최적의 바다view, 조용,편안함,쾌적한 환경)
- 황토벽,편백나무  친환경 소재 인테리어 사용(아토피,피부,공기,건강에최적) 
- 최상의 편리시설 빌트인 빌라 (식시세척기,가스렌지,장롱,화장대설치)
- 즉시 입주 가능
-  빌라 3,4층 집에서 보이는  바다 전망 view 
- 펜션같은 바다 뷰와 최상의 깨끗하고 친환경적 신축 빌라 
- 입주시 주인과 가격 협의 조정가능
- 넓은 주차장(25대가능)
-향후 2020년 전철 역 입주예정(석문산업단지 연결) (송악역-석문역-등)
(근처 전철역 설치 계획)</p>
					</a>
				</li>
				
				<li class="type3"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77742')">
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
							상가
						</span>
						<span class="s_type">17,000 만원</span>
						<strong class="tit">동래구 온천동 76㎡</strong>
						<p class="desc">210세대 아파트 내 상가 (현)
(1) 입주업종 (미장원) 약13평 / 일천만원(월27만원) 계약 15년12월05일
(2) 입주업종(보일러사무실) 약10평 / 오백만원 (월25만원) 계약 15년 12월01일
				...
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77726')">
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
							토지
						</span>
						<span class="s_type">89,000 만원</span>
						<strong class="tit">가평군 상면 6,158㎡</strong>
						<p class="desc">청평역 차량 15분,  현리 차량 5분, 가평수목원 접, 하천 접, 전원주택 접, 수영장 포함 최신 이태리식 리조트 200m 거리(금년 5월 open),
토목공사 완료, 전기 시설, 청정 지하수(수질검사 100%합격, 대공)
*전원주택지 최고 위치, 펜션, 캠핑장 최고 적지</p>
					</a>
				</li>
				
				<li class="type1"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77659')">
						<span class="s_type">
							<span class="tag_comm2 type3">임대</span>
							공장
						</span>
						<span class="s_type">보 3,000 만원 / 280 만원</span>
						<strong class="tit">밀양시 단장면 858㎡</strong>
						<p class="desc"> 밀양IC 에서 10분거리에 위치, 총 3개동(사무실동,가동,나동) 
1.사무실동(165㎡):사무실,사장실,주방,화장실
2.가동(363㎡):작업장,에어샤워기,저온저장고
3.나동(330㎡): 공실
※ 가동 소재 저온저장고는 전 세입자 편의상 철거한 상태임.필요시 재설치 가능</p>
					</a>
				</li>
				
				<li class="type1"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77617')">
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
							토지
						</span>
						<span class="s_type">90,000 만원</span>
						<strong class="tit">광산구 송산동 11,115㎡</strong>
						<p class="desc">광주 빛그린산단 근처, 광주시 송정역방면으로 3.5Km 떨어진 임야를 매매합니다.
총 3,368평이며, 6m도로에 접하고 있습니다.
현대자동차와 광주시가 합작한 완성차 공장과 금호타이어 공장이 빛그린산단에
들어서기에 앞으로 발전 가능성이 높은 땅입니다.
개인 사정으로 급매로 매각합니다.</p>
					</a>
				</li>
				
				<li class="type2"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77596')">
						<span class="s_type">
							<span class="tag_comm2 type1">매매</span>
							토지
						</span>
						<span class="s_type">9,500 만원</span>
						<strong class="tit">태안군 남면 246㎡</strong>
						<p class="desc">몽산포해수욕장 바로 입구 공영주차장옆 토지를 매매합니다. 차도 접한 땅이며 지목은 임야입니다. 카페나 휴게음식점,매점등을 하시기에 좋은 땅입니다.
태안 관광개발과 솔빛대교 개통으로 투자가치가 있습니다.</p>
					</a>
				</li>
				
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77533')">
						<span class="s_type">
							<span class="tag_comm2 type2">월세</span>
							사무실
						</span>
						<span class="s_type">보 10 만원 / 50 만원</span>
						<strong class="tit">동대문구 장안동 99㎡</strong>
						<p class="desc">308호 - 보증금 10, 월 50만원.(부가세별도) 
핸드폰: 010-4240-9441. 
집전화: 02-2214-3666
</p>
					</a>
			...
			<!-- //플러스매물 -->
			<!-- 베이직매물 -->
			<h4 class="h4_type4">베이직매물<a href="javascript:" class="btn_type1 rb" onclick="goSellPage(62);">등록하기</a></h4>
			<ul class="list_basic" id="list_basic">				
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77838', '1')">
						<span class="tit"><span class="tag_comm2 type1">매매</span><br>전원농가주택</span>
						<span class="s_type">120,000 만원</span>
						<div class="info">
							<span class="loc">홍천군 서석면 250㎡ </span>
							<p class="desc">토지면적 약 4300 제곱미터(1300py)
대지 약 1000제곱미터(300py)
건축면적 약 100제곱미터(30py)
총 3층 중,
지증 30py로 큰 방 1, 주차장 (2대 주차 가능)
1층 30py로 방3, 거실, 주방, 화장실2
2층 15py로 방2, 거실, 화장실
물은 지하100미터 이상에서 끌어올리는 암반수(강원 보건환경연구원 46가지 수질검사 최상급)
심야보일러 및 온수 보일러 설치
차분한 동북향 배산임수지형으로 홍천강 상류가 동네 앞을 굽이 흘러가고 뒤는 노송으로 가득찬 국유림이 있으며 지대가 높아 볕이 잘 드는 곳입니다.
20년간 공들여 가꾼 조경은 철쭉, 영산홍, 잣나무, 단풍, 구상나무 왕벚나무 등이 가득합니다.
대형 잔디밭, 소형잔디밭+테라스 및 산책로가 어우러집니다.
주변은 고급 펜션들과 유기농 블루베리 농장으로 둘러쌓여 있어 오염시설이 전혀 없고 여울길 등 산책로가 잘 조성되어 있습니다.
서울-양양 고속도로 내촌 IC에서 약 9km, 12분 거리</p>
				...
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77795', '1')">
						<span class="tit"><span class="tag_comm2 type2">월세</span><br>상가</span>
				...
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77796', '1')">
						<span class="tit"><span class="tag_comm2 type2">월세</span><br>상가</span>
						<span class="s_type">보 4,000 만원 / 200 만원</span>
						<div class="info">
							<span class="loc">부산진구 부전동 115㎡ </span>
							<p class="desc">부산 부산진구 서면 롯데호텔 인근 1층 상가건물입니다. 1개월전 오픈한 일식,스시집입니다. 현재 성업중이며 성수기로 접어드는 시기이므로 매출이 꾸준히 늘고 있습니다
이 건물에 10년이상 거주한 사유로 주변시세에 비해 월세등이 많이 저렴한 편입니다.
갑자기 개인 사정이 생겨 매매를 내놓게 되었습니다.
일식집이나 스시 ,이자카야,카페 등 기존시설로 사용가능합니다.
권리금이라기보단 시설비 정도 받을까 합니다. 금액은 협의가능합니다.
사거리 모서리 건물이며, 1층이며, 천고가 높아 건물이 실평수보다 크게 느껴집니다
직거래매물이며, 관심있으신분들의 전화 부탁드립니다,</p>
						</div>
					</a>
				</li>
				
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77794', '1')">
						<span class="tit"><span class="tag_comm2 type3">임대</span><br>공장</span>
						<span class="s_type">보 800 만원 / 65 만원</span>
						<div class="info">
							<span class="loc">남양주시 진접읍 19㎡ </span>
							<p class="desc">5톤트럭이 지나다닐 수 있습니다. 주변 시세보다 엄청 매우 저렴합니다.
확장으로 좀 더 큰 곳으로 가려고 내놓는 부분입니다.
앞 마당이 있어 사용 가능하며, 총 3동중 가장 앞쪽에 있어 단독 느낌으로 사용 가능합니다. 실 평수는 60평이며 복층 공사를 하여 복층까지 합치면 90평 사용 가능합니다. 
쇼룸 느낌으로 사용했던 부분으로 복층은 통 유리로 되어 있어 아래를 내려다 볼 수 있으며, 1층은 파벽돌을 붙이고 천장은 블랙으로 칠하는 등 예쁘게 꾸며놓았습니다.
화장실은 공장 내부에 있어 단독으로 이용 가능합니다.</p>
						</div>
					</a>
				</li>
				
				<li class="type1"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77781', '1')">
						<span class="tit"><span class="tag_comm2 type1">매매</span><br>토지</span>
				...
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77782', '1')">
						<span class="tit"><span class="tag_comm2 type1">매매</span><br>기타</span>
						<span class="s_type">11,000 만원</span>
						<div class="info">
							<span class="loc">정선군 여량면 52,089㎡ </span>
							<p class="desc">산 36번지이고 현재 주택이 있으며 그 집 뒷담부터 제 땅입니다. 남쪽방향 52089m2 (평당7000원) 빚이 있어서 사정상 급매합니다.</p>
						</div>
					</a>
				</li>
				
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77780', '1')">
						<span class="tit"><span class="tag_comm2 type1">매매</span><br>빌딩</span>
...
● 건물면적 : 56.88 ~ 74.16 m² 
● 용도 : 근린생활시설
● 건물 : 지하 1층~지상 4층, 별도 주차장(주차공간 4대)
● 매물특징 :
- ★초역세권으로 마포구청역 5번출구에서 200m정도(도보 3분)에 위치한 건물
- 합정역까지 지하철 2정거장
- ★망리단길 약 700m(도보 10분)
- ★망원시장 약 500m, 상암홈플러스 및 메세나폴리스 약 1km 생활편리 최상
- ★한강인접으로 망원한강공권까지 약 1km 
- 망원한강공원은 잔디밭과 산책로 등 휴식공간이 잘 조성되어 있으며 유동인구 多
- 하늘공원, 망원유수지 체육공원, 평화의공원 인접
- 최근 마포한강아이파크(약 1km) 385세대 입주로 상권 긍정적 및 투자가치 부상
- YG 신사옥 ‘19년 7월 예정
- 홍대, 연대, 서강대 서울 서부권 유명학교가 반경 약 3km</p>
						</div>
					</a>
				</li>
				
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('102258', '2')">
						<span class="tit"><span class="tag_comm2 type1">매매</span><br>토지</span>
				...
				<li class=""><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77770', '1')">
						<span class="tit"><span class="tag_comm2 type1">매매</span><br>빌라</span>
						<span class="s_type">53,000 만원</span>
						<div class="info">
							<span class="loc">종로구 부암동 100㎡ </span>
							<p class="desc">4층 빌라의 4층. 남향(면적 144.36/100.18)
밝고 전망 좋은 집. 
20평 정도의 야외 베란다가 4면으로 둘러 있음. 부암동 최고의 전망.
깨끗해서 수리 불필요.
옥상 독점 사용.  옥상에 온실이 있어 활용 가능함.
옥상으로 올라가는 계단과 공간은 수납 공간으로 활용 가능.</p>
						</div>
					</a>
				</li>
				
				<li class="type1"><!-- loop | 테두리 : type1, bg : type2, 테두리+bg : type3 -->
					<a href="javascript:" onclick="goDetailPage('77762', '1')">
						<span class="tit"><span class="tag_comm2 type2">월세</span><br>상가</span>
						<span class="s_type">보 5,000 만원 / 170 만원</span>
						<div class="info">
							<span class="loc">수원시 연무동 162㎡ </span>
							<p class="desc">인테리어 사무실로 이용했던 건물로 현재 공실이고, 1층(30평)은 자재창고, 2층(30평)은 사무실로 사용하면 좋습니다.  전용면적 60평 사용할수 있습니다. 비슷한 업종으로 활용하셔도 됩니다. 상가앞에 공영주차장이 있어 주차가 편하고,  상가에도 주차1대 할수 있습니다.
주차장위에는 공원으로 조성이 되어 있어서 공원뷰가 아주 멋집니다. 수원화성 성곽뷰도 아주 이쁩니다. 임대기간은 2년입니다.(2019년.4월~2021년.3월)</p>
						</div>
					</a>
				</li>
			...
			<!-- //베이직매물 -->
			<!-- paging -->
			<div class="paging" id="pagingBasic"><strong><span class="skip">현재페이지</span>1</strong><a href="javascript:goPage(2, 1);">2</a><a href="javascript:goPage(3, 1);">3</a></div>
			<!-- //paging -->

			<!-- 2017.10.20 추가 : 미래에셋 온라인보험 배너 추가 -->
			<div class="btn_wrap mgt4">
				<a href="https://online.miraeasset.com/html/event/ad_201508/index.html?tab=3&amp;_OC_=375" target="_blank">
					<img src="https://image.r114.co.kr/W1/images/sub/img_ad_miraeasset.png" alt="미래에셋 온라인보험 자네 보험료는 가계수입의 몇 % 인가 (미래에셋생명) 생명보험협의회심의필 제 2015-1690호(2015.07.21)">
				</a>
			</div>
			<!-- //2017.10.20 추가 -->
		</div>
		...
		<div id="list_searchLoad" style="display: none;">
			<h4 class="h4_type4"><span id="searchAddressView"></span> 직거래 물건 <span class="fc_red" id="searchCount">0 건</span></h4>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		*/
		...
		$('#estateTypeFilter').on('selectmenuchange', function() {
			...
			if ($("#estateTypeFilter").val() == "토지" || $("#estateTypeFilter").val() == "기타")
			{
				$(".clsOptionView").hide();
			}
			else
	...
	**************************************************************************/
	...
	function search() {
		...
		// 시도/구시군/읍면동
		var arrAddr =jQuery.trim($("#addrSearchWord").TextVal()).split(" ");
		...
		$.QueryString['propertyType'] = $('#estateTypeFilter option:selected').val() || '전체';	//모바일 호환
		$.QueryString['dealingWay'] = $('#dealingWayFilter option:selected').val();

		var dealingWay = $('#dealingWayFilter option:selected').val();

		switch (dealingWay) {
			case '매매':
				$.QueryString['price'] = $('#priceFilterItem1 option:selected').val();
			...
			case '월세':
			case '임대':
				$.QueryString['price'] = $('#priceFilterItem2 option:selected').val();
				$.QueryString['depositRent'] = $('#priceFilterBW option:selected').val();
		...
		$.each($.QueryString, function (key, value) {
			if(value == null || value.match(/^ *$/) || value.indexOf('전체') != -1) {
	...
	function setView() {
		//지역
		$("#addrSearchWord").val($.QueryStringGet('addr1', '') + ' ' + $.QueryStringGet('addr2', '') + ' ' + $.QueryStringGet('addr3', ''));

		//매물종류
		$("#estateTypeFilter option[value='" + $.QueryStringGet('propertyType', '') + "']").attr("selected", true);
		$("#estateTypeFilter option[value='" + $.QueryStringGet('propertyType', '') + "']").prop("selected", true);
		$("#estateTypeFilter").selectmenu('refresh');

		//거래유형
		$("#dealingWayFilter option[value='" + $.QueryStringGet('dealingWay', '') + "']").attr("selected", true);
		$("#dealingWayFilter option[value='" + $.QueryStringGet('dealingWay', '') + "']").prop("selected", true);
		...
		switch ($.QueryString['dealingWay']) {
			case '전세':
				$("#priceFilterItem1 option[value='" + $.QueryStringGet('price', '') + "']").attr("selected", true);
				$("#priceFilterItem1 option[value='" + $.QueryStringGet('price', '') + "']").prop("selected", true);
			...
			case '월세':
			case '임대':
				$("#priceFilterBW option[value='" + $.QueryStringGet('depositRent', '') + "']").attr("selected", true);
				$("#priceFilterBW option[value='" + $.QueryStringGet('depositRent', '') + "']").prop("selected", true);
				$("#priceFilterBW").selectmenu('refresh');
				$('#priceFilterBW').trigger('selectmenuchange');

				$("#priceFilterItem2 option[value='" + $.QueryStringGet('price', '') + "']").attr("selected", true);
				$("#priceFilterItem2 option[value='" + $.QueryStringGet('price', '') + "']").prop("selected", true);
		...
		//면적
		$("#searchSize option[value='" + $.QueryStringGet('size', '') + "']").attr("selected", true);
		$("#searchSize option[value='" + $.QueryStringGet('size', '') + "']").prop("selected", true);
		...
		//방수
		$("#bang option[value='" + $.QueryStringGet('room', '') + "']").attr("selected", true);
		$("#bang option[value='" + $.QueryStringGet('room', '') + "']").prop("selected", true);
		$("#bang").selectmenu('refresh');

		//욕실수
		$("#bath option[value='" + $.QueryStringGet('bath', '') + "']").attr("selected", true);
		$("#bath option[value='" + $.QueryStringGet('bath', '') + "']").prop("selected", true);
		...
		setTimeout(function () {
			$.when(
				//호선
				$("#subl option[value='" + $.QueryStringGet('subwayLine', '') + "']").attr("selected", true),
				$("#subl option[value='" + $.QueryStringGet('subwayLine', '') + "']").prop("selected", true),
				$("#subl").selectmenu('refresh'),
				setSubwayline("#subn", "1", $('#subl option:selected').val(), "0")
			).done(function () {
				//역명
				$("#subn option[value='" + $.QueryStringGet('stationName', '') + "']").attr("selected", true);
				$("#subn option[value='" + $.QueryStringGet('stationName', '') + "']").prop("selected", true);
				$("#subn").selectmenu('refresh');
			});

			//이동방법
			$.when(
				setTransportationMeans("#subm")
			).done(function () {
				$("#subm option[value='" + $.QueryStringGet('means', '') + "']").attr("selected", true);
				$("#subm option[value='" + $.QueryStringGet('means', '') + "']").prop("selected", true);
				$("#subm").selectmenu('refresh');
			});
		}, 10);

		//소요시간
		$("#subt option[value='" + $.QueryStringGet('timeDistance', '') + "']").attr("selected", true);
		$("#subt option[value='" + $.QueryStringGet('timeDistance', '') + "']").prop("selected", true);
		$("#subt").selectmenu('refresh');

		//상세옵션 on
		if($.QueryString['sizeMin'] || $.QueryString['room'] || $.QueryString['bath']
			|| $.QueryString['subwayLine'] || $.QueryString['stationName']
			|| $.QueryString['means'] || $.QueryString['timeDistance']) {
	...
	var getDirectDealSearch = function() {
		...
		// 검색 결과 타이틀
		var title = $("#addrSearchWord").TextVal() + " " + $('#estateTypeFilter option:selected').text() + " " + $('#dealingWayFilter option:selected').val();
		$("#searchAddressView").html(jQuery.trim(title));

		var formData = {
			page: util2.curPage,
			estateType: ($.QueryString['propertyType'] || '') + ($.QueryString['dealingWay'] || ''),
	...
	var getDirectDealListBasic = function() {
		...
		var productType, estateType, addr1, addr2, addr3, sizeLow, sizeHigh, dealType, mPriceLow, mPriceHigh, jPriceLow, jPriceHigh, bPriceLow, bPriceHigh, wPriceLow,  wPriceHigh,
			bang, bath, direction, door, heatt ,heatf, subL, subN, subM, subT, lifeequipment, etcequipment, sfKind, sfKeyword;
		productType = "베이직";
	...
	function goSellPage(goodsCode) {
		...
		*/
		...
		var url = "/?_c=service&_s=directdeal&_m=directdealsellpersonal&goodsCode="+goodsCode+"";
...
</script><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="priceFilterBW-button" id="priceFilterBW-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="priceFilterItem2-button" id="priceFilterItem2-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="subn-button" id="subn-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="estateTypeFilter-button" id="estateTypeFilter-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="dealingWayFilter-button" id="dealingWayFilter-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="priceFilterItem1-button" id="priceFilterItem1-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="searchSize-button" id="searchSize-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="bang-button" id="bang-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="bath-button" id="bath-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="subt-button" id="subt-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><iframe name="easyXDM_Kakao_default1156_provider" id="easyXDM_Kakao_default1156_provider" src="https://kapi.kakao.com/cors/?xdm_e=https%3A%2F%2Fwww.r114.com&amp;xdm_c=default1156&amp;xdm_p=1" frameborder="0" style="position: absolute; top: -2000px; left: 0px;"></iframe><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="subl-button" id="subl-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="subm-button" id="subm-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div id="fb-root" class=" fb_reset"><div style="position: absolute; top: -10000px; width: 0px; height: 0px;"><div><iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" src="https://staticxx.facebook.com/connect/xd_arbiter/r/d_vbiawPdxB.js?version=44#channel=f9df0ef83a2d7&amp;origin=https%3A%2F%2Fwww.r114.com" style="border: none;"></iframe></div><div></div></div></div></body>
</html>