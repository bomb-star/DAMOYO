...
<body style="">
	...
	<div id="body_layout">
		...
		//tab -->
					...
					<div class="inner">
						...
						<div id="priceFilterType1">
							<span class="inp_slt" style="width: 170px;"> <select
								...
								data-min-max="Y" data-price="Y" disabled=""><span
								...
								data-price="Y" disabled=""><span class="txt">만원</span>
						...
						<div id="priceFilterType2" style="display: none;">
							<span class="inp_slt" style="width: 135px;"> <select
								...
								id="priceFilter2Max" data-min-max="Y" data-price="Y" disabled=""><span
								class="txt">만원</span>
							<button type="button" class="btn_ico_type1">
				...
				<div id="list_firstLoad">
					<!-- 기업보유 매각물건 -->
					<h4 class="h4_type4">
						기업보유 매각물건<a href="javascript:" class="btn_type1 rb"
							onclick="goSellPage();">등록하기</a>
					</h4>
					<ul class="list_thumb_type5 type2" id="list_Pic">
						<li><a href="javascript:" onclick="goDetailPage('994')">
								<div class="thumb">
									<img
							...
							</span> <strong class="tit">경주시 천북면 928,445㎡</strong>
								<p class="desc">자산관리공사
									온비드&amp;#40;www.onbid.co.kr&amp;#41;에서 &amp;#34한국마사회
									경주부지&amp;#34를 검색하여 공고문을 확인하시기 바랍니다.</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('970')">
								<div class="thumb">
									<img
									...
									공장<br> 325,200 만원
							</span> <strong class="tit">진천군 덕산면 15,357㎡</strong>
								<p class="desc">일반 제조 공장 및 창고 완비. 위험물 제조를 허가받은 공장(약 50만리터
									탱크시설 완비) 지방도 2차선 직근접위치. 중부고속도로 6km 이내 임대 보증금액 월세는 6-22번지에 한함</p>
						</a></li>


						<li class="wrt"><a href="javascript:"> <span
								class="ico_comm_l r_wrt2"></span> <span class="fc_blue2">기업</span>매물
								등록하시고 <br>빠른 거래하세요~ <span class="ico_comm_l plus"></span>
						</a></li>
					...
					<ul class="list_thumb_type5 type2" id="list_VIP">
						<li><a href="javascript:" onclick="goDetailPage('996')">
								<div class="thumb">
									<img
									...
									빌딩<br> 200,000 만원
							</span> <strong class="tit">남양주시 진접읍 892㎡</strong>
								<p class="desc">현재 어린이집으로 이용중 다른 용도로 사용가능하며 세부사항은 별도협의
									부탁드립니다</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('982')">
								<div class="thumb">
									<img
							...
							</span> <strong class="tit">전주시 만성동 12,628㎡</strong>
								<p class="desc">[ 세부 토지 내역 ] 236-6번지 (해당토지 8차선 도로 인접)
									산37-1번지 293-3번지 294번지 236-2번지 (48%지분)</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('972')">
								<div class="thumb">
									<img
										src="https://image.r114.co.kr/support/directbank/2018/11/1전경가로.jpg"
										alt="">
								</div> <span class="s_type"> <span class="tag_comm2 type1">매매</span>
									공장<br> 230,000 만원
							</span> <strong class="tit">음성군 대소면 9,062㎡</strong>
								<p class="desc">공장 4개동, 근린생활시설 1개동</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('971')">
								<div class="thumb">
									<img
										src="https://image.r114.co.kr/support/directbank/2018/11/1[크기변환]전경가로.jpg"
										alt="">
								</div> <span class="s_type"> <span class="tag_comm2 type1">매매</span>
									공장<br> 500,000 만원
							</span> <strong class="tit">칠곡군 가산면 18,547㎡</strong>
								<p class="desc">소유주 제조공장 운영중</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('966')">
								<div class="thumb">
									<img
										src="https://image.r114.co.kr/support/directbank/2018/08/1크기변환_전경.jpg"
										alt="">
								</div> <span class="s_type"> <span class="tag_comm2 type1">매매</span>
									상가<br> 52,000 만원
							</span> <strong class="tit">연수구 청학동 1,786㎡</strong>
								<p class="desc">• 901호 : 탁구장, 2021년 5월만기, 임대료 150만원 • 902호 :
									사무실, 2018년 6월만기, 임대료 100만원</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('963')">
								<div class="thumb">
									<img
										src="https://image.r114.co.kr/support/directbank/2018/07/1전경.jpg"
										alt="">
								</div> <span class="s_type"> <span class="tag_comm2 type1">매매</span>
									토지<br> 160,000 만원
							</span> <strong class="tit">김천시 율곡동 487㎡</strong>
								<p class="desc">- 김천혁신도시 내 위치한 근린생활용지 - 매각조건 협의가능</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('962')">
								<div class="thumb">
									<img
										src="https://image.r114.co.kr/support/directbank/2018/06/1전경_3.JPG"
										alt="">
								</div> <span class="s_type"> <span class="tag_comm2 type1">매매</span>
									상가<br> 70,000 만원
							</span> <strong class="tit">고창군 아산면 1,719㎡</strong>
								<p class="desc">스포츠서울 소비자만족대상을 받은 선운사맛집 장어만셀프입니다. 5백석 좌석을
									보유하고 있으며, 대형 주차장 완비, 2층 60명 가량 수용 가능한 펜션도 있고, 식당 뒷쪽에 예쁜 조각공원과
									족구장도 마련되어 있습니다. 겨울 제외하고 대부분 성수기이고, 지역 특성상 사계절 내내 지역 축제가 열리고 있어
									늘 관광객으로 붐빕니다.</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('961')">
								<div class="thumb">
									<img
										src="https://image.r114.co.kr/support/directbank/2018/06/1크기변환_KakaoTalk_20180611_132933747.jpg"
										alt="">
								</div> <span class="s_type"> <span class="tag_comm2 type1">매매</span>
									전원농가주택<br> 41,000 ~ 43,000 만원
							</span> <strong class="tit">칠곡군 북삼읍 497㎡</strong>
								<p class="desc">1. 전원주택 준공완료 2. 즉시 입주 가능 3. 대지면적 150평</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('960')">
								<div class="thumb">
									<img
										src="https://image.r114.co.kr/support/directbank/2018/06/1전경_2.jpg"
										alt="">
								</div> <span class="s_type"> <span class="tag_comm2 type1">매매</span>
									토지<br> 100,000 만원
							</span> <strong class="tit">강서구 개화동 579㎡</strong>
								<p class="desc">1. 개화동 551-9, 31번지 2. 대출 없음 (첨부 등기부등본 참조)</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('955')">
								<div class="thumb">
									<img
										src="https://image.r114.co.kr/support/directbank/2018/05/1전경_2.jpg"
										alt="">
								</div> <span class="s_type"> <span class="tag_comm2 type1">매매</span>
									토지<br> 67,000 만원
							</span> <strong class="tit">사천시 서포면 2,010㎡</strong>
								<p class="desc">1. 도로 접 2. 바다 조망</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('954')">
								<div class="thumb">
									<img
										src="https://image.r114.co.kr/support/directbank/2018/05/1전경_1.jpg"
										alt="">
								</div> <span class="s_type"> <span class="tag_comm2 type1">매매</span>
									숙박콘도펜션<br> 1,400,000 만원
							</span> <strong class="tit">김해시 생림면 11,618㎡</strong>
								<p class="desc">1. 매도인이 오토캠핑장을 직접 운여하고 있습니다 2. 매출 및 수익 관련사항은
									별도 문의 부탁드립니다.</p>
						</a></li>

						<li><a href="javascript:" onclick="goDetailPage('952')">
								<div class="thumb">
									<img
										src="https://image.r114.co.kr/support/directbank/2018/04/1전경.jpg"
										alt="">
								</div> <span class="s_type"> <span class="tag_comm2 type1">매매</span>
									단독다가구<br> 370,000 만원
							</span> <strong class="tit">용산구 이태원동 135㎡</strong>
								<p class="desc">1. 층별구성 4F - 주택 3F - 주택 2F - 주택 1F - 세탁소 2.
									재건축용 물건이며 대출금 없음</p>
						</a></li>
					...
					<!-- paging -->
					<div class="paging" id="pagingVIP">
						<strong><span class="skip">현재페이지</span>1</strong><a
							href="javascript:goPage(2, 2);">2</a><a
							href="javascript:goPage(3, 2);">3</a><a
							href="javascript:goPage(4, 2);">4</a><a
							href="javascript:goPage(5, 2);">5</a><a
							href="javascript:goPage(6, 2);">6</a><a
							href="javascript:goPage(7, 2);">7</a><a
							href="javascript:goPage(8, 2);">8</a>
					</div>
					<!-- //paging -->
					<!-- //금융권VIP 매각물건 -->
					...
					<ul class="list_basic type2" id="list_list">
						<li><a href="javascript:" onclick="goDetailPage('994')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
						...
						<li><a href="javascript:" onclick="goDetailPage('984')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="" alt=""></span> <span class="s_type">토지<br>
						...
						<li><a href="javascript:" onclick="goDetailPage('983')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="" alt=""></span> <span class="s_type">토지<br>
								<em>평당 110만원</em></span>
						...
						<li><a href="javascript:" onclick="goDetailPage('966')">
								...
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2018/08/1크기변환_전경.jpg"
									alt=""></span> <span class="s_type">상가<br>
								<em>52,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('954')">
								...
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2018/05/1전경_1.jpg"
									alt=""></span> <span class="s_type">숙박콘도펜션<br>
								<em>1,400,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('949')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2018/03/1전경.jpg"
									alt=""></span> <span class="s_type">공장<br>
								<em>200,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('948')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2018/03/1크기변환_KakaoTalk_20180305_111859815.jpg"
									alt=""></span> <span class="s_type">빌딩<br>
								<em>475,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('947')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2018/03/1크기변환.jpg"
									alt=""></span> <span class="s_type">공장<br>
								<em>320,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('946')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2018/02/IMG_5154.jpg"
									alt=""></span> <span class="s_type">공장<br>
								<em>9억 원(협의 가능)</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('945')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2018/02/1전경_1.jpg"
									alt=""></span> <span class="s_type">빌딩<br>
								<em>800,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('944')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2018/02/1전경.jpg"
									alt=""></span> <span class="s_type">숙박콘도펜션<br>
								<em>90,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('943')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2018/01/01.jpg"
									alt=""></span> <span class="s_type">숙박콘도펜션<br>
								<em>90,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('942')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2018/01/순자.jpeg"
									alt=""></span> <span class="s_type">빌딩<br>
								<em>250,000 ~ 280,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('903')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2017/11/75A821C2-9211-418A-94C1-DB131CB5EBD3.jpeg"
									alt=""></span> <span class="s_type">단독다가구<br>
								<em>65,500 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('896')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2017/10/1공장외부-1.jpg"
									alt=""></span> <span class="s_type">공장<br>
								<em>470,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('893')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2017/10/IMG_1306.JPG"
									alt=""></span> <span class="s_type">토지<br>
								<em>평당 130만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('892')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2017/10/1전경_1.jpg"
									alt=""></span> <span class="s_type">아파트<br>
								<em>58,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('891')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2017/10/7단지사진1_1.jpg"
									alt=""></span> <span class="s_type">아파트<br>
								<em>22,000 만원</em></span>
								<div class="info">
						...
						<li><a href="javascript:" onclick="goDetailPage('890')">
								<span class="tit"><span class="tag_comm2 type1">매매</span><br>
								<span class="tag_comm2 type3">VIP</span></span> <span class="thumb"><img
									src="https://image.r114.co.kr/support/directbank/2017/10/1전경_2.jpg"
									alt=""></span> <span class="s_type">아파트<br>
								<em>36,000 만원</em></span>
								<div class="info">
					...
					<div class="paging" id="pagingList">
						<strong><span class="skip">현재페이지</span>1</strong><a
							href="javascript:goPage(2, 3);">2</a><a
							href="javascript:goPage(3, 3);">3</a><a
							href="javascript:goPage(4, 3);">4</a>
					</div>
					<!-- //paging -->
					<!-- //기업매물 정보 -->
					...
					<div class="aff_company">
						<a href="#none" class="logo_company aff1">미래에셋대우</a> <a
							href="#none" class="logo_company aff2">미래에셋생명</a> <a href="#none"
							class="logo_company aff3">우리레오PMC</a> <a href="#none"
							class="logo_company aff4">Mate Plus</a> <a href="#none"
							class="logo_company aff5">KT&amp;G</a> <a href="#none"
							class="logo_company aff6">SM 솔로몬저축은행</a>
					</div>
					<!-- //기업매물 제휴업체 -->
				</div>
				...
				<div id="list_searchLoad" style="display: none;">
					<h4 class="h4_type4">
						<span class="fc_red" id="searchAddressView"></span> <strong>
							<span id="searchEstateView"> </span>
						</strong> 기업보유 물건 (<span class="fc_red" id="searchCount">50건</span>)
					</h4>
						...
						<div class="slide_type6 type2">
							<div class="bx-wrapper" style="max-width: 100%;">
								<div class="bx-viewport" aria-live="polite"
									...
									<ul
										style="width: 2215%; position: relative; transition-duration: 0s; transform: translate3d(-456px, 0px, 0px);">
										<li
	...
	<script type="text/javascript">
		...
		$(document)
				.ready(
						function() {
							...
							// 매물유형 선택	(변경)
							$('#estateTypeFilter').on('selectmenuchange',
									function() {
		...
		var getDirectDealSearch = function() {
			...
			searchBaseInfo = $('#estateTypeFilter option:selected').val() + " "
			...
			estateType = $('#estateTypeFilter option:selected').val()
					+ $('#dealingWayFilter option:selected').val();
		...
		function goDetailPage(seq) {
			...
			var link = "/?_c=service&_s=directdeal&_m=directdealdetailEnterprise&seq="
					+ seq;
	...
	<iframe name="easyXDM_Kakao_default5757_provider"
		id="easyXDM_Kakao_default5757_provider"
		src="https://kapi.kakao.com/cors/?xdm_e=https%3A%2F%2Fwww.r114.com&amp;xdm_c=default5757&amp;xdm_p=1"
		...
		<div
			...
			<div>
				<iframe name="fb_xdm_frame_https" frameborder="0"
					...
					src="https://staticxx.facebook.com/connect/xd_arbiter/r/d_vbiawPdxB.js?version=44#channel=f392406818a886&amp;origin=https%3A%2F%2Fwww.r114.com"
