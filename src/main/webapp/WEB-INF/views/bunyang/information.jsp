            ...
            <li class="on">
				<span>
					...
					<div class="layer_menu lm_5">
						<ul>
							<li class="on"><a href="/?_c=lots&amp;_s=info&amp;_m=infolist">분양정보</a></li>
...
<script type="text/javascript">
	...
	var markerData = [{"기본정보코드":"A01010008260000", "지도좌표Y":"37.4813447292831", "지도좌표X":"127.106050298303"},{"기본정보코드":"A01010014050017", "지도좌표Y":"37.4856964979078", "지도좌표X":"127.069984538876"},{"기본정보코드":"A01010014050018", "지도좌표Y":"37.4808752222762", "지도좌표X":"127.057498528965"},{"기본정보코드":"A01010019360000", "지도좌표Y":"37.494177115388574", "지도좌표X":"127.06094607725364"},{"기본정보코드":"A01010019360001", "지도좌표Y":"37.50243427680084", "지도좌표X":"127.06028327617133"},{"기본정보코드":"A01010021640003", "지도좌표Y":"37.5001990525", "지도좌표X":"127.0457742754"},{"기본정보코드":"A01010026080003", "지도좌표Y":"37.4902237985", "지도좌표X":"127.0786729728"},{"기본정보코드":"A01010035650001", "지도좌표Y":"37.5164520943452", "지도좌표X":"127.049967930007"},{"기본정보코드":"A01110025220000", "지도좌표Y":"37.6000846281015", "지도좌표X":"127.060238232067"},{"기본정보코드":"A01110025790000", "지도좌표Y":"37.57878098875915", "지도좌표X":"127.04419232697671"},{"기본정보코드":"A01110026420000", "지도좌표Y":"37.5800134245286", "지도좌표X":"127.028488756503"},{"기본정보코드":"A01120015400002", "지도좌표Y":"37.48460749065684", "지도좌표X":"126.97706111584892"},{"기본정보코드":"A01120026910006", "지도좌표Y":"37.5005300692925", "지도좌표X":"126.947281193773"},{"기본정보코드":"A01121560800008", "지도좌표Y":"37.4998616", "지도좌표X":"126.9742991"},{"기본정보코드":"A01130033320000", "지도좌표Y":"37.555706491164734", "지도좌표X":"126.95047519858238"},{"기본정보코드":"A01141201000053", "지도좌표Y":"37.585918918365046", "지도좌표X":"126.92387126069535"},{"기본정보코드":"A01150004610026", "지도좌표Y":"37.5030936242", "지도좌표X":"127.0162629585"},{"기본정보코드":"A01150009190066", "지도좌표Y":"37.4799856556", "지도좌표X":"127.0034279626"},{"기본정보코드":"A01150009190067", "지도좌표Y":"37.476554661", "지도좌표X":"126.9997196254"},{"기본정보코드":"A01150021440021", "지도좌표Y":"37.48940879742104", "지도좌표X":"127.02608262698368"},{"기본정보코드":"A01170019640000", "지도좌표Y":"37.6158073297193", "지도좌표X":"127.058851655093"},{"기본정보코드":"A01191580700174", "지도좌표Y":"37.516464145034625", "지도좌표X":"126.85286530511752"},{"기본정보코드":"A01191580900187", "지도좌표Y":"37.52319225517656", "지도좌표X":"126.84399218132644"},{"기본정보코드":"A01221220700042", "지도좌표Y":"37.603754216825976", "지도좌표X":"126.90769961278018"},{"기본정보코드":"A01250027850001", "지도좌표Y":"37.6102488339867", "지도좌표X":"127.112817026829"}];
...
<div id="body_layout">
	<div class="body_wrap">
		...
		<div class="contents_wrap">
			...
			<div class="srch_deal_wrap srch_sale_wrap">
				<div class="inner">
					...
					<div class="sort_wrap2">
						...
						<a href="javascript:;" onclick="tabClick(1, 1);">오피스텔</a>
						<a href="javascript:;" onclick="tabClick(2, 1);">도시형생활주택</a>
						<a href="javascript:;" onclick="tabClick(3, 1);">상가</a>
						<a href="javascript:;" onclick="tabClick(4, 1);">아파트형공장</a>
					</div>
				</div>
				<div class="option_detail_wrap">
					...
					<div class="option_wrap">
						...
						<div class="option_item" id="optFilter1">
							...
							<span class="inp_wrap">
								<input type="radio" class="inp_rdo2" name="filterParam1" id="filterParam1_1" value="2">
								<label for="filterParam1_1" class="txt_sel">분양중</label>
							</span>
							 <span class="inp_wrap">
								<input type="radio" class="inp_rdo2" name="filterParam1" id="filterParam1_2" value="1">
								<label for="filterParam1_2" class="txt_sel">분양예정</label>
							</span>
							<!--
							<span class="inp_wrap">
						...
						<div class="option_item" id="optFilter2">
							<strong class="option_tit">청약통장</strong>
							<span class="inp_wrap">
								<input type="radio" class="inp_rdo2" name="filterParam2" id="filterParam2_1" value="청약예금">
								<label for="filterParam2_1" class="txt_sel">청약예금</label>
							</span>
							<span class="inp_wrap">
								<input type="radio" class="inp_rdo2" name="filterParam2" id="filterParam2_2" value="청약부금">
								<label for="filterParam2_2" class="txt_sel">청약부금</label>
							</span>
							<span class="inp_wrap">
								<input type="radio" class="inp_rdo2" name="filterParam2" id="filterParam2_3" value="청약저축">
								<label for="filterParam2_3" class="txt_sel">청약저축</label>
							</span>
							<span class="inp_wrap">
								<input type="radio" class="inp_rdo2" name="filterParam2" id="filterParam2_4" value="청약종합저축">
								<label for="filterParam2_4" class="txt_sel">주택청약 종합저축</label>
							</span>
							<!--
							<span class="inp_wrap">
						...
						<div class="option_item multi_row" id="optFilter3">
							<div>
								<strong class="option_tit">분양가</strong>
								<input type="text" class="inp_txt" title="분양가 최소값 입력" placeholder="최소" style="width:87px;" name="filterParam4" id="filterParam4"><span class="txt">~</span>
								<input type="text" class="inp_txt" title="분양가 최대값 입력" placeholder="최대" style="width:87px;margin-left:3px;" name="filterParam5" id="filterParam5"><span class="txt">만원</span>
							</div>
							<div>
								<strong class="option_tit">분양형태</strong>
								<span class="inp_slt" style="width:170px;">
									<select title="분양형태 선택" name="filterParam3" id="filterParam3" style="display: none;">
									...
									</select><span tabindex="0" id="filterParam3-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="filterParam3-menu" aria-haspopup="true" title="분양형태 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget" aria-activedescendant="ui-id-1" aria-labelledby="ui-id-1" aria-disabled="false"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">전체</span></span>
								</span>
							</div>
						</div>
						<div class="option_item multi_row" id="optFilter4" style="display: none">
							<div>
								<strong class="option_tit">가구수</strong>
								<span class="inp_slt" style="width:170px;">
									<select title="가구수 선택" name="filterParam7" id="filterParam7" style="display: none;">
									...
									</select><span tabindex="0" id="filterParam7-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="filterParam7-menu" aria-haspopup="true" title="가구수 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">전체</span></span>
								</span>
							</div>
							<div>
								<strong class="option_tit">역세권</strong>
								<span class="inp_slt" style="width:170px;">
									<select title="역세권 선택" name="filterParam6" id="filterParam6" style="display: none;">
										<option value="0">전체</option>
										<option value="3">도보3분 이하</option>
										<option value="5">도보5분 이하</option>
										<option value="10">도보10분 이하</option>
									</select><span tabindex="0" id="filterParam6-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="filterParam6-menu" aria-haspopup="true" title="역세권 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">전체</span></span>
								</span>
							</div>
						</div>
						<div class="btn_wrap">
			...
			<div class="sort_wrap mgt3 scrollTarget">
				...
				<a href="javascript:;" onclick="listSort(1);" class="">분양시기순</a>
				<a href="javascript:;" onclick="listSort(2);" class="">입주시기순</a>
				<a href="javascript:;" onclick="listSort(3);" class="">총가구수순</a>
		<!--		<a href="javascript:;" onclick="listSort(5);" class=" ">총점포수</a>	-->
			...
			<!-- //sort -->
			<!-- table -->
			<div id="lotsInfoList"><table class="tbl_type1 type11">
	...
	<tbody class="InfoList" id="lotsInfoList">
		...
		<tr id="Row_A01070017800009" data-info="아파트$항동공공주택지구2단지(국민임대)$서울특별시$구로구$항동$100-15$60$252$공공임대$2018.12 분양$2019.07 입주">
			<td><span class="tag_comm type4">분양중</span></td>
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:;" class="link_s" onclick="goView('A01070017800009');"><span class="fc_blue">항동공공주택지구2단지(국민임대)</span><br>구로구 항동<br>       </a></td>			
			<td>총 <em class="fc_black">252</em><i class="titleChange2">가구</i></td>
			<td>2018.12 분양<br>2019.07 입주</td>
		</tr>
		<tr class="even" style="display:;">
			<td colspan="5" class="lf">
				<span class="info_wrap2">
					<span>공고 : 2018.11.30</span>
					<span>접수 : 2018.12.10 - 2018.12.12</span>
					<span>발표 : 2019.05.03</span>
					<span>계약 : 2019.05.20 - 2019.05.22</span>
				</span>
			</td>	
			<td colspan="3" class="fc_gray6 rt factoryType" style="display: none;"></td> 
		</tr>
		
		<tr id="Row_A01070017800008" data-info="아파트$항동공공주택지구4단지(국민임대)$서울특별시$구로구$항동$77-1$50 ~ 60$107$공공임대$2018.12 분양$2019.06 입주">
			<td><span class="tag_comm type4">분양중</span></td>
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:;" class="link_s" onclick="goView('A01070017800008');"><span class="fc_blue">항동공공주택지구4단지(국민임대)</span><br>구로구 항동<br>       </a></td>			
			<td>총 <em class="fc_black">107</em><i class="titleChange2">가구</i></td>
			<td>2018.12 분양<br>2019.06 입주</td>
		</tr>
		<tr class="even" style="display:;">
			<td colspan="5" class="lf">
				<span class="info_wrap2">
		...
		<tr id="Row_A01040037510085" data-info="아파트$화곡한울에이치밸리움B동$서울특별시$강서구$화곡동$1065-2$21A ~ 23D$40$민간분양$2019.03 분양$2019.10 입주">
			<td><span class="tag_comm type4">분양중</span></td>
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:;" class="link_s" onclick="goView('A01040037510085');"><span class="fc_blue">화곡한울에이치밸리움B동</span><br>강서구 화곡동<br><span class="tag_comm type16">전매제한</span>       </a></td>			
		...
		<tr class="even" style="display:;">
			<td colspan="5" class="lf">
				<span class="info_wrap2">
					<span>공고 : 2019.03.12</span>
					<span>접수 : 2019.03.18 - 2019.03.20</span>
					<span>발표 : 2019.03.26</span>
					<span>계약 : 2019.04.08 - 2019.04.10</span>
				</span>
			</td>	
			<td colspan="3" class="fc_gray6 rt factoryType" style="display: none;"></td> 
		</tr>
		
		<tr id="Row_A01040037510087" data-info="아파트$화곡한울에이치밸리움A동$서울특별시$강서구$화곡동$1065-4$18A ~ 23C$44$민간분양$2019.03 분양$2019.10 입주">
			<td><span class="tag_comm type4">분양중</span></td>
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:;" class="link_s" onclick="goView('A01040037510087');"><span class="fc_blue">화곡한울에이치밸리움A동</span><br>강서구 화곡동<br><span class="tag_comm type16">전매제한</span>       </a></td>			
		...
		<tr class="even" style="display:;">
			<td colspan="5" class="lf">
				<span class="info_wrap2">
					<span>공고 : 2019.03.21</span>
					<span>접수 : 2019.03.26 - 2019.03.28</span>
					<span>발표 : 2019.04.03</span>
					<span>계약 : 2019.04.15 - 2019.04.17</span>
				</span>
			</td>	
			<td colspan="3" class="fc_gray6 rt factoryType" style="display: none;"></td> 
		</tr>
		
		<tr id="Row_A01110038680003" data-info="아파트$답십리엘림퍼스트$서울특별시$동대문구$답십리동$268-1$53A ~ 53C$79$민간분양$2019.04 분양$2021.03 입주">
			<td><span class="tag_comm type4">분양중</span></td>
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:;" class="link_s" onclick="goView('A01110038680003');"><span class="fc_blue">답십리엘림퍼스트</span><br>동대문구 답십리동<br><span class="tag_comm type16">전매제한</span>       </a></td>			
		...
		<tr class="even" style="display:;">
			<td colspan="5" class="lf">
				<span class="info_wrap2">
					<span>공고 : 2019.03.29</span>
					<span>접수 : 2019.04.03 - 2019.04.05</span>
					<span>발표 : 2019.04.11</span>
					<span>계약 : 2019.04.22 - 2019.04.24</span>
				</span>
			</td>	
			<td colspan="3" class="fc_gray6 rt factoryType" style="display: none;"></td> 
		</tr>
		
		<tr id="Row_A01250027850001" data-info="아파트$신내역금강펜테리움센트럴파크(C2)$서울특별시$중랑구$망우동$26$80 ~ 85$490$민간분양$2019.04 분양$2021.08 입주">
			<td><span class="tag_comm type4">분양중</span></td>
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:;" class="link_s" onclick="goView('A01250027850001');"><span class="fc_blue">신내역금강펜테리움센트럴파크(C2)</span><br>중랑구 망우동<br><span class="tag_comm type16">전매제한</span>   <span class="tag_comm type16">분양가상한제</span>    </a></td>			
		...
		<tr class="even" style="display:;">
			<td colspan="5" class="lf">
				<span class="info_wrap2">
					<span>공고 : 2019.03.28</span>
					<span>접수 : 2019.04.03 - 2019.04.05</span>
					<span>발표 : 2019.04.11</span>
					<span>계약 : 2019.04.23 - 2019.04.25</span>
				</span>
			</td>	
			<td colspan="3" class="fc_gray6 rt factoryType" style="display: none;"></td> 
		</tr>
		
		<tr id="Row_A01220014330010" data-info="아파트$은평서해그랑블$서울특별시$은평구$구산동$307-1$44 ~ 72$146$민간분양$2019.04 분양$2021.08 입주">
			<td><span class="tag_comm type4">분양중</span></td>
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:;" class="link_s" onclick="goView('A01220014330010');"><span class="fc_blue">은평서해그랑블</span><br>은평구 구산동<br><span class="tag_comm type16">전매제한</span>       </a></td>			
		...
		<tr id="Row_A01110026420010" data-info="아파트$청량리역해링턴플레이스$서울특별시$동대문구$용두동$11-1$60 ~ 151$220$민간분양$2019.04 분양$2023.01 입주">
			<td><span class="tag_comm type4">분양중</span></td>
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:;" class="link_s" onclick="goView('A01110026420010');"><span class="fc_blue">청량리역해링턴플레이스</span><br>동대문구 용두동<br><span class="tag_comm type16">전매제한</span>       </a></td>			
		...
		<tr id="Row_A01020039080000" data-info="아파트$강일2준주거1(행복주택)$서울특별시$강동구$강일동$730-2$28 ~ 38$119$민간분양$2019.04 분양$2019.12 입주">
			<td><span class="tag_comm type4">분양중</span></td>
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:;" class="link_s" onclick="goView('A01020039080000');"><span class="fc_blue">강일2준주거1(행복주택)</span><br>강동구 강일동<br>       </a></td>			
		...
		<tr class="even" style="display:;">
			<td colspan="5" class="lf">
				<span class="info_wrap2">
					<span>공고 : 2019.03.29</span>
					<span>접수 : 2019.04.08 - 2019.04.10</span>
					<span>발표 : 2019.08.02</span>
					<span>계약 : 2019.08.26 - 2019.08.30</span>
				</span>
			</td>	
			<td colspan="3" class="fc_gray6 rt factoryType" style="display: none;"></td> 
		</tr>
		
		<tr id="Row_A01250008770003" data-info="아파트$신내글로리움(행복주택)$서울특별시$중랑구$신내동$640$36A ~ 44CS$229$공공임대$2019.04 분양$2019.11 입주">
			<td><span class="tag_comm type4">분양중</span></td>
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:;" class="link_s" onclick="goView('A01250008770003');"><span class="fc_blue">신내글로리움(행복주택)</span><br>중랑구 신내동<br>       </a></td>			
		...
		<tr class="even" style="display:;">
			...
			<!-- //table -->
			<!-- paging -->
			<div class="paging"><strong><span class="skip">현재페이지</span>1</strong><a href="javascript:goPage(2, 1);">2</a><a href="javascript:goPage(3, 1);">3</a><a href="javascript:goPage(4, 1);">4</a><a href="javascript:goPage(5, 1);">5</a><a href="javascript:goPage(6, 1);">6</a><a href="javascript:goPage(7, 1);">7</a><a href="javascript:goPage(8, 1);">8</a></div>
			<!-- //paging -->
...
<script type="text/javascript">
	...
	**************************************************************************/
	var ajaxCall_List = function (hisData){
		...
		// 지역 검색
		$("#addrSearchWord").val(_SEL_METRO+" "+_SEL_COUNTY+" "+_SEL_TOWN);
			...
			success: function(data, textStatus, jqXHR){
				...
				if (data.length > 0) { // 자료가 있을때.
					...
					if (isFirstLoadLotsInfo) {
						Set_MapLots({"title":"","CortarNo":"","Level":_MAP_LEVEL,"Addr1": _SEL_METRO,"Addr2": _SEL_COUNTY,"Addr3": _SEL_TOWN,"ComplexNm":"","gisx":_GISX,"gisy":_GISY, "AddrCodeList":[{"mapLevel":"" + mapLevel + ""}],"bunList": ""});
	...
	**************************************************************************/
	...
	function searchWithDetailOption() {
		...
		$.Hash.filter2 = gFilter2.indexOf($(":input:radio[name=filterParam2]:checked").val());
		$.Hash.filter3 = gFilter3.indexOf($("select#filterParam3 option:selected").attr('value'));
		$.Hash.filter4 = $("#filterParam4").val();
		$.Hash.filter5 = $("#filterParam5").val();
		$.Hash.filter6 = $("select#filterParam6 option:selected").attr('value');
		$.Hash.filter7 = $("select#filterParam7 option:selected").attr('value');
	...
	function filterClear(form){
		...
		$("#filterParam3").selectmenu("destroy").selectmenu({style:'dropdown'});
		$("#filterParam6").selectmenu("destroy").selectmenu({style:'dropdown'});
		$("#filterParam7").selectmenu("destroy").selectmenu({style:'dropdown'});
	...
	*/
	...
	function tabUiSetting(g) {
		...
		if (g == 0) {
			...
			$(".option_detail_wrap .option_wrap div#optFilter1").css("display", "");
			$(".option_detail_wrap .option_wrap div#optFilter2").css("display", "");
			$(".option_detail_wrap .option_wrap div#optFilter3").css("display", "");
			$(".option_detail_wrap .option_wrap div#optFilter4").css("display", "none");

			$(".option_detail_wrap .option_wrap #filterParam1_3").parent().css("display", "");
			$(".option_detail_wrap .option_wrap div#optFilter3").find("div:nth-child(2)").css("display", "");
		}
		// 오피스텔
		else if (g == 1) {
			$(".option_detail_wrap").css("display", "");
			$(".option_detail_wrap .option_wrap div#optFilter1").css("display", "");
			$(".option_detail_wrap .option_wrap div#optFilter2").css("display", "none");
			$(".option_detail_wrap .option_wrap div#optFilter3").css("display", "");
			$(".option_detail_wrap .option_wrap div#optFilter4").css("display", "none");

			$(".option_detail_wrap .option_wrap #filterParam1_3").parent().css("display", "none");
			$(".option_detail_wrap .option_wrap div#optFilter3").find("div:nth-child(2)").css("display", "none");
		}
		// 도생주
		else if (g == 2) {
			$(".option_detail_wrap").css("display", "");
...
<div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="filterParam3-button" id="filterParam3-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content" aria-activedescendant="ui-id-1" aria-disabled="false"><li class="ui-menu-item"><div id="ui-id-1" tabindex="-1" role="option" class="ui-menu-item-wrapper ui-state-active">전체</div></li><li class="ui-menu-item"><div id="ui-id-2" tabindex="-1" role="option" class="ui-menu-item-wrapper">공공분양</div></li><li class="ui-menu-item"><div id="ui-id-3" tabindex="-1" role="option" class="ui-menu-item-wrapper">공공임대</div></li><li class="ui-menu-item"><div id="ui-id-4" tabindex="-1" role="option" class="ui-menu-item-wrapper">민간분양</div></li><li class="ui-menu-item"><div id="ui-id-5" tabindex="-1" role="option" class="ui-menu-item-wrapper">민간임대</div></li></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="filterParam7-button" id="filterParam7-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="filterParam6-button" id="filterParam6-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><iframe name="easyXDM_Kakao_default1630_provider" id="easyXDM_Kakao_default1630_provider" src="https://kapi.kakao.com/cors/?xdm_e=https%3A%2F%2Fwww.r114.com&amp;xdm_c=default1630&amp;xdm_p=1" frameborder="0" style="position: absolute; top: -2000px; left: 0px;"></iframe></body>
</html>