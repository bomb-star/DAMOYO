...
<body style="">
		...
		<div class="body_wrap">
			...
			<div class="contents_wrap">
				...
				<ul class="list_tab type4">
					...
					<li><a
						href="/?_c=Lots&amp;_s=offerStrategy&amp;_m=lotsOfferInfo">상식</a></li>
					<li><a
						href="/?_c=Lots&amp;_s=offerStrategy&amp;_m=lotsOfferFAQ">FAQ</a></li>
					<li><a
						href="/?_c=Lots&amp;_s=offerStrategy&amp;_m=lotsOfferInternet">인터넷
							청약서비스</a></li>
				</ul>
				...
				<ol class="list_tab2">
					...
					<li><a
						href="/?_c=Lots&amp;_s=offerStrategy&amp;_m=lotsOfferGuide&amp;_a=guide2">청약통장
							가입</a></li>
					<li><a
						href="/?_c=Lots&amp;_s=offerStrategy&amp;_m=lotsOfferGuide&amp;_a=guide3">청약자격(순위)
							확인</a></li>
					<li><a
						href="/?_c=Lots&amp;_s=offerStrategy&amp;_m=lotsOfferGuide&amp;_a=guide4">청약통장
							활용</a></li>
					<li><a
						href="/?_c=Lots&amp;_s=offerStrategy&amp;_m=lotsOfferGuide&amp;_a=guide5">분양정보
							확인</a></li>
					<li><a
						href="/?_c=Lots&amp;_s=offerStrategy&amp;_m=lotsOfferGuide&amp;_a=guide6">청약신청</a></li>
					<li><a
						href="/?_c=Lots&amp;_s=offerStrategy&amp;_m=lotsOfferGuide&amp;_a=guide7">당첨자
							확인</a></li>
					<li><a
						href="/?_c=Lots&amp;_s=offerStrategy&amp;_m=lotsOfferGuide&amp;_a=guide8">내
							집 마련</a></li>
				</ol>
				...
				<table class="tbl_type1 txt">
					...
					<tbody>
						<tr>
							...
							<td class="lf">국민주택기금의 지원없이 민간건설업자가 건설하는 주택 국가지방자치단체 및 <br>한국토지주택공사
								등이 공급
							</td>
							<td class="lf">청약부금<br>청약예금<br>주택청약종합저축
							</td>
						</tr>
						<tr>
							<th scope="row">국민주택</th>
							<td class="lf">국민주택기금을 지원받아 공급되는 주택 또는 국가지방자치단체·한국토지주택공사 <br>또는
								지방공사가 건설하는 주택 중 전용면적 85m² 이하의 주택
							</td>
							<td class="lf">청약저축<br>주택청약종합저축
							</td>
						</tr>
						<tr>
							<th scope="row">공공건설<br>임대주택
							</th>
							<td class="lf">국가 또는 지방자치단체의 재정으로 건설하거나 국민주택기금에 의한 자금을 지원 받아
								건설하여 임대하는 주택 <br>※ 임차인의 자격 및 선정방법은 주택공급 에 관한 규칙에서 특례규정을 두고
								있음
							</td>
							<td class="lf">청약저축<br>주택청약종합저축
							</td>
						...
						<tr>
							<th scope="row">민간건설<br>임대주택
							</th>
							<td class="lf">공공건설 임대주택 이외의 건설 임대주택<br>※ 임차인의 자격 및
								선정방법은 당해 임대사업자가 정하므로 구체적인 자격과 <br>선정방법은 입주자모집 공고문을 통하여 확인해야
								함
							</td>
							<td class="lf">청약예금<br>청약부금<br>청약저축<br>주택청약종합저축
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="tbl_type1 txt">
					...
					<tbody>
						<tr>
							...
							<td class="lf">서울특별시와 SH공사가 주변 시세의 80% 이하로 중대형 주택을 공급하여 실
								수요자들이 최장 20년 까지 살 수 있는 주택</td>
							<td class="lf">청약저축<br>주택청약종합저축
							</td>
						</tr>
						<tr>
							<th scope="row">행복주택</th>
							<td class="lf">대학생, 신혼부부, 사회초년생 등을 위해 직장과 학교가 가까운 곳이나 <br>대중교통
								이용이 편리한 곳에 짓는 임대료가 저렴한 공공임대주택 <br>※ 대학생과 취약 계층은 청약통장 미보유
								청약가능
							</td>
							<td class="lf">청약저축<br>주택청약종합저축
							</td>
	...
	<iframe name="easyXDM_Kakao_default8660_provider"
		id="easyXDM_Kakao_default8660_provider"
		src="https://kapi.kakao.com/cors/?xdm_e=https%3A%2F%2Fwww.r114.com&amp;xdm_c=default8660&amp;xdm_p=1"
		...
		<div
			...
			<div>
				<iframe name="fb_xdm_frame_https" frameborder="0"
					...
					src="https://staticxx.facebook.com/connect/xd_arbiter/r/d_vbiawPdxB.js?version=44#channel=f12c6f1b7e1144&amp;origin=https%3A%2F%2Fwww.r114.com"
