				...
				<span>
					...
					<div class="layer_menu lm_5">
						<ul>
							...
							<li class="on"><a href="/?_c=lots&amp;_s=lotsSchedule&amp;_m=lotsSchedule">분양일정</a></li>
		...
		<div class="contents_wrap">
			...
			<div class="srch_deal_wrap srch_sale_wrap2">
				<div class="option_item">
					...
					<input type="text" class="inp_txt" placeholder="시,구,동 등을 입력하세요." style="width:308px;margin-right:0;" id="addrSearchWord" readonly="" onclick="search_CreateAddrHtml('body', this.value);">
					<button type="button" class="btn_del round_s" id="cmdDeleteAddr">삭제버튼</button>
					</span>
				</div>
				<div class="option_item multi_row">
					<span>
						<strong class="option_tit">달력</strong>
						<span id="conditionCalendar">
							<a href="javascript:" class="txt_sel selected" id="calendarTypeM" onclick="changeCondition(this, 'M');">월단위</a><!-- 활성화 class="selected" -->
							<a href="javascript:" class="txt_sel" id="calendarTypeW" onclick="changeCondition(this, 'W');">주단위</a>
						</span>
					</span>
					<span>
						<strong class="option_tit">분양일정</strong>
						<span class="sort_wrap3" id="conditionStatus">
							<a href="javascript:" class="txt_sel selected" id="status0" onclick="changeCondition(this, '');">전체</a>
							<a href="javascript:" class="txt_sel" id="status1" onclick="changeCondition(this, '1');">오픈</a>
							<a href="javascript:" class="txt_sel" id="status2" onclick="changeCondition(this, '2');">공고</a>
							<a href="javascript:" class="txt_sel" id="status3" onclick="changeCondition(this, '3');">접수</a>
							<a href="javascript:" class="txt_sel" id="status4" onclick="changeCondition(this, '4');">발표</a>
							<a href="javascript:" class="txt_sel last" id="status5" onclick="changeCondition(this, '5');">계약</a>
						</span>
					</span>
				</div>

				<div class="option_item">
					<strong class="option_tit">분양종류</strong>
					<span class="sort_wrap3" id="conditionEstateType">
						<a href="javascript:" class="txt_sel selected" id="estateType0" onclick="changeCondition(this, '0');">전체</a>
						<a href="javascript:" class="txt_sel" id="estateTypeA" onclick="changeCondition(this, 'B');">아파트</a>
						<a href="javascript:" class="txt_sel" id="estateTypeB" onclick="changeCondition(this, 'C');">오피스텔</a>
						<a href="javascript:" class="txt_sel" id="estateTypeC" onclick="changeCondition(this, 'D');">도시형생활주택</a>
					</span>
				</div>
			</div>
			<!-- //검색 및 옵션 -->
			...
			<div class="calendar_wrap" id="monthlyWrap">
				...
				<div class="period_setting">
					<button type="button" class="btn_cal" id="calendarPrevMonth" onclick="changeMonthlyCalendar('prev');"><span class="ico_comm_s pv_cal">이전</span></button>

					<span class="inp_slt" style="width:80px;margin-right:6px;">
						<select title="연도 선택" id="calendarYear" style="display: none;">
							<option value="2017">2017</option><option value="2018">2018</option><option value="2019" selected="">2019</option><option value="2020">2020</option><option value="2021">2021</option>
						</select><span tabindex="0" id="calendarYear-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="calendarYear-menu" aria-haspopup="true" title="연도 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">2019</span></span>
					</span>
					년
					<span class="inp_slt" style="width:80px;margin:0 6px 0 9px;">
						<select title="월 선택" id="calendarMonth" style="display: none;">
							<option value="01">1</option><option value="02">2</option><option value="03">3</option><option value="04" selected="">4</option><option value="05">5</option><option value="06">6</option><option value="07">7</option><option value="08">8</option><option value="09">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option>
						</select><span tabindex="0" id="calendarMonth-button" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-owns="calendarMonth-menu" aria-haspopup="true" title="월 선택" class="ui-selectmenu-button ui-selectmenu-button-closed ui-corner-all ui-button ui-widget"><span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s"></span><span class="ui-selectmenu-text">4</span></span>
					</span>
					월

					<button type="button" class="btn_cal" id="calendarNextMonth" onclick="changeMonthlyCalendar('next');"><span class="ico_comm_s nx_cal">다음</span></button>
				</div>
				<!-- //기간 -->
				<div class="calendar" id="calendarMonthDay"><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190401'); drawScheduleCountByDay(this, 2); ">1</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190402'); drawScheduleCountByDay(this, 2); ">2</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190403'); drawScheduleCountByDay(this, 13); ">3</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190404'); drawScheduleCountByDay(this, 20); ">4</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190405'); drawScheduleCountByDay(this, 26); ">5</a></span><span>6</span><span>7</span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190408'); drawScheduleCountByDay(this, 13); ">8</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190409'); drawScheduleCountByDay(this, 13); ">9</a></span><span class="today"><a href="javascript:" onclick="javascript:getLotsScheduleInfo('N', '20190410'); drawScheduleCountByDay(this, 27); ">10</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190411'); drawScheduleCountByDay(this, 23); ">11</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190412'); drawScheduleCountByDay(this, 13); ">12</a></span><span>13</span><span>14</span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190415'); drawScheduleCountByDay(this, 10); ">15</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190416'); drawScheduleCountByDay(this, 4); ">16</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190417'); drawScheduleCountByDay(this, 9); ">17</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190418'); drawScheduleCountByDay(this, 2); ">18</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190419'); drawScheduleCountByDay(this, 4); ">19</a></span><span>20</span><span>21</span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190422'); drawScheduleCountByDay(this, 10); ">22</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190423'); drawScheduleCountByDay(this, 7); ">23</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190424'); drawScheduleCountByDay(this, 3); ">24</a></span><span>25</span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190426'); drawScheduleCountByDay(this, 3); ">26</a></span><span>27</span><span>28</span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190429'); drawScheduleCountByDay(this, 6); ">29</a></span><span><a href="javascript:" onclick="getLotsScheduleInfo('N', '20190430'); drawScheduleCountByDay(this, 1); ">30</a></span></div>
			</div>
			<!-- //월단위 -->
			<!-- 주단위 -->
			<div class="calendar_wrap" id="weeklyWrap" style="display: none;">
				<!-- 기간 -->
				<div class="period_setting">
					<button type="button" class="btn_cal" id="calendarPrevWeek" onclick="changeWeeklyCalendar('prev', true);"><span class="ico_comm_s pv_cal">이전</span></button>
...
-->
					...
					<button type="button" class="btn_cal" id="calendarNextMonth" onclick="changeWeeklyCalendar('next', true);"><span class="ico_comm_s nx_cal">다음</span></button>
				</div>
				<!-- //기간 -->
			...
			<div class="sort_wrap mgt3" id="cmdSort">
				<a href="#none" class="selected up">날짜순</a>
				<a href="#none">입주시기순</a>
				<!--
				<div class="total_cnt">
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G05060001580002')" class="link_s"><span class="fc_blue">인천가좌코오롱하늘채메트로</span><br>서구 가좌동</a></td>
			<td>
				<span class="lf">
					68Ad/30Ad ~ <br>133C1/63C1
				</span>
			</td>
			<td>
				<span class="lf">
			...
			<td>2019.04 분양<br>2021.07 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G04080040130001')" class="link_s"><span class="fc_blue">대구테크노폴리스줌시티</span><br>달성군 현풍읍</a></td>
			<td>
				<span class="lf">
					46A/20A ~ <br>67F/29F
				</span>
			...
			<td>2019.04 분양<br>2021.11 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G16020018920013')" class="link_s"><span class="fc_blue">신제주연동트리플시티</span><br>제주시 연동</a></td>
			<td>
				<span class="lf">
					62A/27A ~ <br>190A2/84A2
				</span>
			</td>
			<td>
				<span class="lf">
			...
			<td>2019.03 분양<br>2021.11 입주</td>
		</tr>
		...
		<tr>
			...
			계약 : <span class="fc_green">계약</span>
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A15100008340001')" class="link_s"><span class="fc_blue">광혜원지안스로가</span><br>진천군 광혜원면</a></td>
			<td>
				<span class="lf">
					84A/59A ~ <br>111/84
				</span>
			...
			<td>2019.03 분양<br>2020.09 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01110026420010')" class="link_s"><span class="fc_blue">청량리역해링턴플레이스</span> (1순위)<br>동대문구 용두동</a></td>
			<td>
				<span class="lf">
					83/59 ~ <br>207/150
				</span>
			...
			<td>2019.04 분양<br>2023.01 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A05060007900000')" class="link_s"><span class="fc_blue">인천검단대방노블랜드1차(AB4)</span> (1순위)<br>서구 당하동</a></td>
			<td>
				<span class="lf">
					99A/75A ~ <br>133A/108A
				</span>
			</td>
			<td>
				<span class="lf">
			...
			<td>2019.04 분양<br>2022.03 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01220014330010')" class="link_s"><span class="fc_blue">은평서해그랑블</span> (1순위)<br>은평구 구산동</a></td>
			<td>
				<span class="lf">
					61/44 ~ <br>98/72
				</span>
			...
			<td>2019.04 분양<br>2021.08 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01250027850001')" class="link_s"><span class="fc_blue">신내역금강펜테리움센트럴파크(C2)</span> (1순위)<br>중랑구 망우동</a></td>
			<td>
				<span class="lf">
					103/79 ~ <br>109/84
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02090400100002')" class="link_s"><span class="fc_blue">분당지웰푸르지오</span> (1순위)<br>성남시 수내동</a></td>
			<td>
				<span class="lf">
					111/84 ~ <br>156/119
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A08010001420005')" class="link_s"><span class="fc_blue">문수로두산위브더제니스</span> (1순위)<br>남구 신정동</a></td>
			<td>
				<span class="lf">
					116A/84A ~ <br>117B/84B
				</span>
			</td>
			<td>
				<span class="lf">
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01110038680003')" class="link_s"><span class="fc_blue">답십리엘림퍼스트</span> (1순위)<br>동대문구 답십리동</a></td>
			<td>
				<span class="lf">
					70A/52A ~ <br>71C/52C
				</span>
			...
			<td>2019.04 분양<br>2021.03 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01040037510087')" class="link_s"><span class="fc_blue">화곡한울에이치밸리움A동</span><br>강서구 화곡동</a></td>
			<td>
				<span class="lf">
					23A/18A ~ <br>29A/22A
				</span>
			...
			<td>2019.03 분양<br>2019.10 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A12150012650000')" class="link_s"><span class="fc_blue">함평월야푸르밸리</span><br>함평군 월야면</a></td>
			<td>
				<span class="lf">
					80/59 ~ <br>101/75
				</span>
			...
			<td>2019.03 분양<br>2020.05 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A09020024130001')" class="link_s"><span class="fc_blue">이안동해센트럴</span><br>동해시 천곡동</a></td>
			<td>
				<span class="lf">
					78A/59A ~ <br>111/84
				</span>
			...
			<td>2019.03 분양<br>2021.05 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A04087118930000')" class="link_s"><span class="fc_blue">대구국가산단대방노블랜드(A2-1)</span><br>달성군 구지면</a></td>
			<td>
				<span class="lf">
					99B/76B ~ <br>110B/84B
				</span>
			...
			<td>2019.03 분양<br>2021.07 입주</td>
		</tr>
		...
		<tr>
			...
			계약 : <span class="fc_green">계약</span>
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A13060001420000')" class="link_s"><span class="fc_blue">정읍첨단A1-3(행복주택)</span><br>정읍시 신정동</a></td>
			<td>
				<span class="lf">
					25A/16A ~ <br>55A/36A
				</span>
			...
			<td>2019.01 분양<br>2019.11 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02180012380001')" class="link_s"><span class="fc_blue">힐스테이트북위례(A3-4a)</span> (1순위)<br>하남시 학암동</a></td>
			<td>
				<span class="lf">
					116/92 ~ <br>130/102
				</span>
			...
			<td>2019.04 분양<br>2021.05 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A05070004130009')" class="link_s"><span class="fc_blue">호반써밋송도(M2)</span> (1순위)<br>연수구 송도동</a></td>
			<td>
				<span class="lf">
					116A/84A ~ <br>142B/101B
				</span>
			</td>
			<td>
				<span class="lf">
			...
			<td>2019.04 분양<br>2023.02 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G05070004130018')" class="link_s"><span class="fc_blue">호반써밋송도(M2)</span><br>연수구 송도동</a></td>
			<td>
				<span class="lf">
					151A/74A ~ <br>174B/84B
				</span>
			</td>
			<td>
				<span class="lf">
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A05060007900000')" class="link_s"><span class="fc_blue">인천검단대방노블랜드1차(AB4)</span> (2순위)<br>서구 당하동</a></td>
			<td>
				<span class="lf">
					99A/75A ~ <br>133A/108A
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A03070026970006')" class="link_s"><span class="fc_blue">신만덕베스티움에코포레</span> (1순위)<br>북구 만덕동</a></td>
			<td>
				<span class="lf">
					85/59 ~ <br>114/84
				</span>
			...
			<td>2019.04 분양<br>2022.04 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A08010001420005')" class="link_s"><span class="fc_blue">문수로두산위브더제니스</span> (2순위)<br>남구 신정동</a></td>
			<td>
				<span class="lf">
					116A/84A ~ <br>117B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A15023509950001')" class="link_s"><span class="fc_blue">청주산남2-1증축(행복주택)</span><br>청주시 수곡동</a></td>
			<td>
				<span class="lf">
					27/19
				</span>
			...
			<td>2019.01 분양<br>2020.02 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A11017122800006')" class="link_s"><span class="fc_blue">중산코오롱하늘채메트로폴리스</span><br>경산시 중산동</a></td>
			<td>
				<span class="lf">
					103B/84B ~ <br>137/113
				</span>
			...
			<td>2019.03 분양<br>2021.04 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A04020027910005')" class="link_s"><span class="fc_blue">성당태왕아너스메트로</span><br>달서구 성당동</a></td>
			<td>
				<span class="lf">
					108B/84B
				</span>
			...
			<td>2019.03 분양<br>2022.06 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G04020027910001')" class="link_s"><span class="fc_blue">성당태왕아너스메트로</span><br>달서구 성당동</a></td>
			<td>
				<span class="lf">
					121OB/50OB
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A07040018190002')" class="link_s"><span class="fc_blue">대전아이파크시티2단지(A2)</span><br>유성구 복용동</a></td>
			<td>
				<span class="lf">
					111A/84A ~ <br>295P/234P
				</span>
			</td>
			<td>
				<span class="lf">
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A07040018190000')" class="link_s"><span class="fc_blue">대전아이파크시티1단지(A1)</span><br>유성구 복용동</a></td>
			<td>
				<span class="lf">
					111A/84A ~ <br>133A/104A
				</span>
			</td>
			<td>
				<span class="lf">
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A04050020240002')" class="link_s"><span class="fc_blue">대구비산(행복주택)</span><br>서구 비산동</a></td>
			<td>
				<span class="lf">
					27A/16A ~ <br>58A/36A
				</span>
			...
			<td>2019.01 분양<br>2019.12 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02011426550000')" class="link_s"><span class="fc_blue">e편한세상일산어반스카이</span><br>고양시 일산동</a></td>
			<td>
				<span class="lf">
					96B/70B ~ <br>114/84
				</span>
			...
			<td>2019.04 분양<br>2022.12 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G02011426550001')" class="link_s"><span class="fc_blue">e편한세상일산어반스카이</span><br>고양시 일산동</a></td>
			<td>
				<span class="lf">
					- / -
				</span>
			...
			<td>2019.04 분양<br>2022.09 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02040028480001')" class="link_s"><span class="fc_blue">한양수자인구리역</span><br>구리시 수택동</a></td>
			<td>
				<span class="lf">
					83A/59A ~ <br>113B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01110026420002')" class="link_s"><span class="fc_blue">청량리역한양수자인192</span><br>동대문구 용두동</a></td>
			<td>
				<span class="lf">
					120F/84F ~ <br>231/162
				</span>
			...
			<td>2019.04 분양<br>2023.05 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G02040028480003')" class="link_s"><span class="fc_blue">유탑트윈팰리스</span><br>구리시 수택동</a></td>
			<td>
				<span class="lf">
					46/20 ~ <br>94/43
				</span>
			...
			<td>2019.04 분양<br>2022.01 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G04060032630003')" class="link_s"><span class="fc_blue">수성레이크푸르지오</span><br>수성구 두산동</a></td>
			<td>
				<span class="lf">
					194B/84B ~ <br>194A/84A
				</span>
			</td>
			<td>
				<span class="lf">
			...
			<td>2019.04 분양<br>2022.08 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A04060032630000')" class="link_s"><span class="fc_blue">수성레이크푸르지오</span><br>수성구 두산동</a></td>
			<td>
				<span class="lf">
					108B/84B ~ <br>196PH/152PH
				</span>
			</td>
			<td>
				<span class="lf">
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A13051222520000')" class="link_s"><span class="fc_blue">서완산골드클래스</span><br>전주시 서완산동2가</a></td>
			<td>
				<span class="lf">
					97/74 ~ <br>110/84
				</span>
			...
			<td>2019.04 분양<br>2021.06 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G01060037330009')" class="link_s"><span class="fc_blue">빌리브인테라스</span><br>광진구 화양동</a></td>
			<td>
				<span class="lf">
					38A/16A ~ <br>63D/27D
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02070036850002')" class="link_s"><span class="fc_blue">남양주더샵퍼스트시티(A1)</span><br>남양주시 진접읍</a></td>
			<td>
				<span class="lf">
					79A/59A ~ <br>111B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02180012380001')" class="link_s"><span class="fc_blue">힐스테이트북위례(A3-4a)</span> (2순위)<br>하남시 학암동</a></td>
			<td>
				<span class="lf">
					116/92 ~ <br>130/102
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A05070004130009')" class="link_s"><span class="fc_blue">호반써밋송도(M2)</span> (2순위)<br>연수구 송도동</a></td>
			<td>
				<span class="lf">
					116A/84A ~ <br>142B/101B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01110026420010')" class="link_s"><span class="fc_blue">청량리역해링턴플레이스</span> (2순위)<br>동대문구 용두동</a></td>
			<td>
				<span class="lf">
					83/59 ~ <br>207/150
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01220014330010')" class="link_s"><span class="fc_blue">은평서해그랑블</span> (2순위)<br>은평구 구산동</a></td>
			<td>
				<span class="lf">
					61/44 ~ <br>98/72
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A03070026970006')" class="link_s"><span class="fc_blue">신만덕베스티움에코포레</span> (2순위)<br>북구 만덕동</a></td>
			<td>
				<span class="lf">
					85/59 ~ <br>114/84
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01250027850001')" class="link_s"><span class="fc_blue">신내역금강펜테리움센트럴파크(C2)</span> (2순위)<br>중랑구 망우동</a></td>
			<td>
				<span class="lf">
					103/79 ~ <br>109/84
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02090400100002')" class="link_s"><span class="fc_blue">분당지웰푸르지오</span> (2순위)<br>성남시 수내동</a></td>
			<td>
				<span class="lf">
					111/84 ~ <br>156/119
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01110038680003')" class="link_s"><span class="fc_blue">답십리엘림퍼스트</span> (2순위)<br>동대문구 답십리동</a></td>
			<td>
				<span class="lf">
					70A/52A ~ <br>71C/52C
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A10020016170000')" class="link_s"><span class="fc_blue">김해삼계두곡한라비발디센텀시티</span> (1순위)<br>김해시 삼계동</a></td>
			<td>
				<span class="lf">
					84/64 ~ <br>110/84
				</span>
			...
			<td>2019.04 분양<br>2021.12 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02150035890003')" class="link_s"><span class="fc_blue">의왕역경기행복주택(따복하우스)</span><br>의왕시 삼동</a></td>
			<td>
				<span class="lf">
					43/29
				</span>
			...
			<td>2018.12 분양<br>2020.02 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02620036650000')" class="link_s"><span class="fc_blue">오산가장경기행복주택(따복하우스)</span><br>오산시 가장동</a></td>
			<td>
				<span class="lf">
					34A/21A ~ <br>34B/21B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02740002680000')" class="link_s"><span class="fc_blue">양주고읍A13(행복주택)</span><br>양주시 광사동</a></td>
			<td>
				<span class="lf">
					25A/16A ~ <br>55A/36A
				</span>
			...
			<td>2019.01 분양<br>2020.06 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02070005280003')" class="link_s"><span class="fc_blue">다산역(A2)경기행복주택(따복하우스)2회</span><br>남양주시 진건읍</a></td>
			<td>
				<span class="lf">
					40/24 ~ <br>71/44
				</span>
			...
			<td>2018.12 분양<br>2019.09 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01120015400011')" class="link_s"><span class="fc_blue">학수복합(행복주택)</span><br>동작구 사당동</a></td>
			<td>
				<span class="lf">
					33A/20A ~ <br>34/21
				</span>
			...
			<td>2019.04 분양<br>2019.11 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G02170039330004')" class="link_s"><span class="fc_blue">파주운정지구디에이블</span><br>파주시 와동동</a></td>
			<td>
				<span class="lf">
					60B/23B ~ <br>69A/26A
				</span>
			...
			<td>2019.04 분양<br>2020.11 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A14150040000000')" class="link_s"><span class="fc_blue">충남도청이전도시RM6(영구임대)</span><br>예산군 삽교읍</a></td>
			<td>
				<span class="lf">
					38B/25B
				</span>
			...
			<td>2019.04 분양<br>2020.03 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01250008770003')" class="link_s"><span class="fc_blue">신내글로리움(행복주택)</span><br>중랑구 신내동</a></td>
			<td>
				<span class="lf">
					58B/36B ~ <br>71B/44B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A10020016170000')" class="link_s"><span class="fc_blue">김해삼계두곡한라비발디센텀시티</span> (2순위)<br>김해시 삼계동</a></td>
			<td>
				<span class="lf">
					84/64 ~ <br>110/84
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01020039080000')" class="link_s"><span class="fc_blue">강일2준주거1(행복주택)</span><br>강동구 강일동</a></td>
			<td>
				<span class="lf">
					44S/28S ~ <br>59/38
				</span>
			...
			<td>2019.04 분양<br>2019.12 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01040037510085')" class="link_s"><span class="fc_blue">화곡한울에이치밸리움B동</span><br>강서구 화곡동</a></td>
			<td>
				<span class="lf">
					26B/20B ~ <br>29A/22A
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A05060008720000')" class="link_s"><span class="fc_blue">인천불로대광로제비앙</span><br>서구 불로동</a></td>
			<td>
				<span class="lf">
					85A/61A ~ <br>112B/84B
				</span>
			...
			<td>2019.03 분양<br>2022.02 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A06010000400003')" class="link_s"><span class="fc_blue">광주첨단H3(행복주택)</span><br>광산구 월계동</a></td>
			<td>
				<span class="lf">
					23/16 ~ <br>52/36
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A06010000400002')" class="link_s"><span class="fc_blue">광주첨단H2(행복주택)</span><br>광산구 쌍암동</a></td>
			<td>
				<span class="lf">
					27/16 ~ <br>60/36
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A06010000400001')" class="link_s"><span class="fc_blue">광주첨단H1(창업지원주택)</span><br>광산구 쌍암동</a></td>
			<td>
				<span class="lf">
					36B/21B ~ <br>66/39
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A14150040000001')" class="link_s"><span class="fc_blue">충남도청이전도시RM6(국민임대)</span><br>예산군 삽교읍</a></td>
			<td>
				<span class="lf">
					40C/26C ~ <br>69A/46A
				</span>
		...
		<tr>
			...
			계약 : <span class="fc_green">계약</span>
			-->
			<td><span class="lf">아파트<br>민간임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A07040018190004')" class="link_s"><span class="fc_blue">대전아이파크시티2단지(민간임대)</span><br>유성구 복용동</a></td>
			<td>
				<span class="lf">
					111A/84A ~ <br>112B/84B
				</span>
			</td>
			<td>
				<span class="lf">
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A07040018190003')" class="link_s"><span class="fc_blue">대전아이파크시티1단지(민간임대)</span><br>유성구 복용동</a></td>
			<td>
				<span class="lf">
					111A/84A ~ <br>111B/84B
				</span>
			</td>
			<td>
				<span class="lf">
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A13070025880003')" class="link_s"><span class="fc_blue">고창석정파크빌3차</span> (1순위)<br>고창군 고창읍</a></td>
			<td>
				<span class="lf">
					114B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A12050021740001')" class="link_s"><span class="fc_blue">여수관문(행복주택)</span><br>여수시 관문동</a></td>
			<td>
				<span class="lf">
					24/16 ~ <br>53/36
				</span>
			...
			<td>2019.01 분양<br>2020.07 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A12230020420001')" class="link_s"><span class="fc_blue">진도동외(영구임대)</span><br>진도군 진도읍</a></td>
			<td>
				<span class="lf">
					36A/24A ~ <br>36B/24B
				</span>
			...
			<td>2019.01 분양<br>2020.01 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A09050000420003')" class="link_s"><span class="fc_blue">원주더샵센트럴파크(4단지)</span><br>원주시 무실동</a></td>
			<td>
				<span class="lf">
					106A/84A ~ <br>127A/101A
				</span>
			</td>
			<td>
				<span class="lf">
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A09050000420002')" class="link_s"><span class="fc_blue">원주더샵센트럴파크(3단지)</span><br>원주시 명륜동</a></td>
			<td>
				<span class="lf">
					81A/59A ~ <br>113B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A09050000420001')" class="link_s"><span class="fc_blue">원주더샵센트럴파크(2단지)</span><br>원주시 명륜동</a></td>
			<td>
				<span class="lf">
					108A/84A ~ <br>130A/101A
				</span>
			</td>
			<td>
				<span class="lf">
			...
			<td>2019.03 분양<br>2022.01 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A09050000420000')" class="link_s"><span class="fc_blue">원주더샵센트럴파크(1단지)</span><br>원주시 무실동</a></td>
			<td>
				<span class="lf">
					80A/59A ~ <br>112B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02011426550000')" class="link_s"><span class="fc_blue">e편한세상일산어반스카이</span> (1순위)<br>고양시 일산동</a></td>
			<td>
				<span class="lf">
					96B/70B ~ <br>114/84
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02790039910010')" class="link_s"><span class="fc_blue">화성남양뉴타운A5(행복주택)</span><br>화성시 남양읍</a></td>
			<td>
				<span class="lf">
					25A/16A ~ <br>55A/36A
				</span>
			...
			<td>2019.04 분양<br>2020.05 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02180005760005')" class="link_s"><span class="fc_blue">하남감일A6(행복주택)</span><br>하남시 감일동</a></td>
			<td>
				<span class="lf">
					34B/21B ~ <br>57B/36B
				</span>
			...
			<td>2019.04 분양<br>2020.06 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02640039980000')" class="link_s"><span class="fc_blue">평택청북B12(행복주택)</span><br>평택시 청북읍</a></td>
			<td>
				<span class="lf">
					32/21 ~ <br>55/36
				</span>
			...
			<td>2019.04 분양<br>2020.02 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02640016300009')" class="link_s"><span class="fc_blue">평택고덕Ca2(행복주택)</span><br>평택시 고덕면</a></td>
			<td>
				<span class="lf">
					27A/16A ~ <br>60A/36A
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02640016300010')" class="link_s"><span class="fc_blue">평택고덕Ca1(행복주택)</span><br>평택시 고덕면</a></td>
			<td>
				<span class="lf">
					27A/16A ~ <br>60A/36A
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02170029800001')" class="link_s"><span class="fc_blue">파주법원(행복주택)</span><br>파주시 법원읍</a></td>
			<td>
				<span class="lf">
					24A/16A ~ <br>54A/36A
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A15020317200001')" class="link_s"><span class="fc_blue">청주동남A5(행복주택)</span><br>청주시 운동동</a></td>
			<td>
				<span class="lf">
					27A/16A ~ <br>59A/36A
				</span>
			...
			<td>2019.04 분양<br>2020.04 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G01110026420007')" class="link_s"><span class="fc_blue">청량리역해링턴플레이스</span><br>동대문구 용두동</a></td>
			<td>
				<span class="lf">
					71A2/29A2 ~ <br>127G/52G
				</span>
			</td>
			<td>
				<span class="lf">
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A14062819150003')" class="link_s"><span class="fc_blue">천안두정A1(행복주택)</span><br>천안시 두정동</a></td>
			<td>
				<span class="lf">
					26B/16B ~ <br>43A/26A
				</span>
			...
			<td>2019.04 분양<br>2019.10 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A05030017280003')" class="link_s"><span class="fc_blue">인천서창2지구14BL(행복주택)</span><br>남동구 서창동</a></td>
			<td>
				<span class="lf">
					24A/16A ~ <br>55B1/36B1
				</span>
			</td>
			<td>
				<span class="lf">
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A12190013890005')" class="link_s"><span class="fc_blue">영암용앙(행복주택)</span><br>영암군 삼호읍</a></td>
			<td>
				<span class="lf">
					32B/21B ~ <br>55/36
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A14050002290007')" class="link_s"><span class="fc_blue">아산배방2A12(행복주택)</span><br>아산시 배방읍</a></td>
			<td>
				<span class="lf">
					26A/16A ~ <br>57A/36A
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A04060032630000')" class="link_s"><span class="fc_blue">수성레이크푸르지오</span> (1순위)<br>수성구 두산동</a></td>
			<td>
				<span class="lf">
					108B/84B ~ <br>196PH/152PH
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A13051222520000')" class="link_s"><span class="fc_blue">서완산골드클래스</span> (1순위)<br>전주시 서완산동2가</a></td>
			<td>
				<span class="lf">
					97/74 ~ <br>110/84
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A14020021490000')" class="link_s"><span class="fc_blue">논산골든타워</span> (1순위)<br>논산시 취암동</a></td>
			<td>
				<span class="lf">
					102/76 ~ <br>209/157
				</span>
			...
			<td>2019.04 분양<br>2021.09 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02070036850002')" class="link_s"><span class="fc_blue">남양주더샵퍼스트시티(A1)</span> (1순위)<br>남양주시 진접읍</a></td>
			<td>
				<span class="lf">
					79A/59A ~ <br>111B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A13070025880003')" class="link_s"><span class="fc_blue">고창석정파크빌3차</span> (2순위)<br>고창군 고창읍</a></td>
			<td>
				<span class="lf">
					114B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02790027680006')" class="link_s"><span class="fc_blue">화성향남2A20(행복주택)</span><br>화성시 향남읍</a></td>
			<td>
				<span class="lf">
					25A/16A ~ <br>57A/36A
				</span>
			...
			<td>2019.01 분양<br>2019.09 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02790027680007')" class="link_s"><span class="fc_blue">화성발안A1(행복주택)</span><br>화성시 향남읍</a></td>
			<td>
				<span class="lf">
					30B/16B ~ <br>79A/44A
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A05060007900000')" class="link_s"><span class="fc_blue">인천검단대방노블랜드1차(AB4)</span><br>서구 당하동</a></td>
			<td>
				<span class="lf">
					99A/75A ~ <br>133A/108A
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A08010001420005')" class="link_s"><span class="fc_blue">문수로두산위브더제니스</span><br>남구 신정동</a></td>
			<td>
				<span class="lf">
					116A/84A ~ <br>117B/84B
				</span>
		...
		<tr>
			...
			계약 : <span class="fc_green">계약</span>
			-->
			<td><span class="lf">아파트<br>공공분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02640016300008')" class="link_s"><span class="fc_blue">평택고덕신혼희망타운(공공분양)</span><br>평택시 서정동</a></td>
			<td>
				<span class="lf">
					67A/46A ~ <br>80A4/55A4
				</span>
			</td>
			<td>
				<span class="lf">
			...
			<td>2019.01 분양<br>2021.08 입주</td>
		</tr>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02011426550000')" class="link_s"><span class="fc_blue">e편한세상일산어반스카이</span> (2순위)<br>고양시 일산동</a></td>
			<td>
				<span class="lf">
					96B/70B ~ <br>114/84
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02040028480001')" class="link_s"><span class="fc_blue">한양수자인구리역</span> (1순위)<br>구리시 수택동</a></td>
			<td>
				<span class="lf">
					83A/59A ~ <br>113B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A13051222520000')" class="link_s"><span class="fc_blue">서완산골드클래스</span> (2순위)<br>전주시 서완산동2가</a></td>
			<td>
				<span class="lf">
					97/74 ~ <br>110/84
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A14020021490000')" class="link_s"><span class="fc_blue">논산골든타워</span> (2순위)<br>논산시 취암동</a></td>
			<td>
				<span class="lf">
					102/76 ~ <br>209/157
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02070036850002')" class="link_s"><span class="fc_blue">남양주더샵퍼스트시티(A1)</span> (2순위)<br>남양주시 진접읍</a></td>
			<td>
				<span class="lf">
					79A/59A ~ <br>111B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A05070004130009')" class="link_s"><span class="fc_blue">호반써밋송도(M2)</span><br>연수구 송도동</a></td>
			<td>
				<span class="lf">
					116A/84A ~ <br>142B/101B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01110026420010')" class="link_s"><span class="fc_blue">청량리역해링턴플레이스</span><br>동대문구 용두동</a></td>
			<td>
				<span class="lf">
					83/59 ~ <br>207/150
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A10140006430001')" class="link_s"><span class="fc_blue">의령동동5(행복주택)</span><br>의령군 의령읍</a></td>
			<td>
				<span class="lf">
					27AB/16AB ~ <br>59A/36A
				</span>
			</td>
			<td>
				<span class="lf">
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01220014330010')" class="link_s"><span class="fc_blue">은평서해그랑블</span><br>은평구 구산동</a></td>
			<td>
				<span class="lf">
					61/44 ~ <br>98/72
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01250027850001')" class="link_s"><span class="fc_blue">신내역금강펜테리움센트럴파크(C2)</span><br>중랑구 망우동</a></td>
			<td>
				<span class="lf">
					103/79 ~ <br>109/84
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02090400100002')" class="link_s"><span class="fc_blue">분당지웰푸르지오</span><br>성남시 수내동</a></td>
			<td>
				<span class="lf">
					111/84 ~ <br>156/119
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A07040018190001')" class="link_s"><span class="fc_blue">대전도안2A21(행복주택)</span><br>유성구 원신흥동</a></td>
			<td>
				<span class="lf">
					24A/16A ~ <br>54A/36A
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01110038680003')" class="link_s"><span class="fc_blue">답십리엘림퍼스트</span><br>동대문구 답십리동</a></td>
			<td>
				<span class="lf">
					70A/52A ~ <br>71C/52C
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A11020038240000')" class="link_s"><span class="fc_blue">경주용강1단지증축(영구임대)</span><br>경주시 용강동</a></td>
			<td>
				<span class="lf">
					28B/19B ~ <br>37A/26A
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02790022740001')" class="link_s"><span class="fc_blue">화성우방아이유쉘메가시티(2단지)</span><br>화성시 기안동</a></td>
			<td>
				<span class="lf">
					- / -
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02790022740000')" class="link_s"><span class="fc_blue">화성우방아이유쉘메가시티(1단지)</span><br>화성시 기안동</a></td>
			<td>
				<span class="lf">
					- / -
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A04030006490002')" class="link_s"><span class="fc_blue">방촌역세영리첼</span><br>동구 방촌동</a></td>
			<td>
				<span class="lf">
					- / -
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A04040022630001')" class="link_s"><span class="fc_blue">강북태왕아너스더퍼스트</span><br>북구 읍내동</a></td>
			<td>
				<span class="lf">
					- / -
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A04060032630000')" class="link_s"><span class="fc_blue">수성레이크푸르지오</span> (2순위)<br>수성구 두산동</a></td>
			<td>
				<span class="lf">
					108B/84B ~ <br>196PH/152PH
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02180012380001')" class="link_s"><span class="fc_blue">힐스테이트북위례(A3-4a)</span><br>하남시 학암동</a></td>
			<td>
				<span class="lf">
					116/92 ~ <br>130/102
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02160031200005')" class="link_s"><span class="fc_blue">의정부고산S2-1(행복주택)</span><br>의정부시 고산동</a></td>
			<td>
				<span class="lf">
					24A/16A ~ <br>53A/36A
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A03070026970006')" class="link_s"><span class="fc_blue">신만덕베스티움에코포레</span><br>북구 만덕동</a></td>
			<td>
				<span class="lf">
					85/59 ~ <br>114/84
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A10020016170000')" class="link_s"><span class="fc_blue">김해삼계두곡한라비발디센텀시티</span><br>김해시 삼계동</a></td>
			<td>
				<span class="lf">
					84/64 ~ <br>110/84
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02040028480001')" class="link_s"><span class="fc_blue">한양수자인구리역</span> (2순위)<br>구리시 수택동</a></td>
			<td>
				<span class="lf">
					83A/59A ~ <br>113B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01110026420002')" class="link_s"><span class="fc_blue">청량리역한양수자인192</span> (1순위)<br>동대문구 용두동</a></td>
			<td>
				<span class="lf">
					120F/84F ~ <br>231/162
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A13070025880003')" class="link_s"><span class="fc_blue">고창석정파크빌3차</span><br>고창군 고창읍</a></td>
			<td>
				<span class="lf">
					114B/84B
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01110026420002')" class="link_s"><span class="fc_blue">청량리역한양수자인192</span> (2순위)<br>동대문구 용두동</a></td>
			<td>
				<span class="lf">
					120F/84F ~ <br>231/162
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">오피스텔<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('C', 'G08010001420011')" class="link_s"><span class="fc_blue">문수로두산위브더제니스</span><br>남구 신정동</a></td>
			<td>
				<span class="lf">
					- / -
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A14020021490000')" class="link_s"><span class="fc_blue">논산골든타워</span><br>논산시 취암동</a></td>
			<td>
				<span class="lf">
					102/76 ~ <br>209/157
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A01180021200001')" class="link_s"><span class="fc_blue">위례신도시리슈빌(A1-6)</span><br>송파구 장지동</a></td>
			<td>
				<span class="lf">
					- / -
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02070030300000')" class="link_s"><span class="fc_blue">성도르피스더스테이(민간임대)</span><br>남양주시 오남읍</a></td>
			<td>
				<span class="lf">
					- / -
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A13051015760000')" class="link_s"><span class="fc_blue">e편한세상우아주공1</span><br>전주시 우아동3가</a></td>
			<td>
				<span class="lf">
					- / -
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>민간분양</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A13051001160004')" class="link_s"><span class="fc_blue">전주에코시티14BL</span><br>전주시 송천동2가</a></td>
			<td>
				<span class="lf">
					- / -
				</span>
		...
		<tr>
			...
			-->
			<td><span class="lf">아파트<br>공공임대</span></td>
			<td class="lf"><a href="javascript:goLotsInfoDetailPage('B', 'A02092534260004')" class="link_s"><span class="fc_blue">성남고등A1(국민임대)</span><br>성남시 고등동</a></td>
			<td>
				<span class="lf">
					39B/26B ~ <br>65A/44A
				</span>
			...
			<td>2019.01 분양<br>2019.08 입주</td>
		</tr>
	...
	*/
	...
	function changeMonthlyCalendar(way) {
		...
		if (way != "") {
			...
			var month = $("select#calendarMonth option:selected").val();
			var day = "01";
			calendarMonthDate = getYearMonth(year + month + day, way) + "01";
		}
	...
	function changeWeeklyCalendar(way, isLoad) {
		...
		var firstdate = calendarWeekDate.substr(0,4) + "." +  calendarWeekDate.substr(4,2)+ "." +  calendarWeekDate.substr(6,2);
		var lastdate = "";
	...
	function makeCalendarMonth(dt) {
		...
		for (var i=1; i<= parseInt(lastDate); i++) {
			...
			$.each (lotsScheduleData.rows, function(index, entry) {
				if ( theDay == entry["날짜"] ) {
					isTheDay = true;
					if (searchStatus == 0 && parseInt(entry["건수"]) > 0) {
						if (today == theDay) {
							calendar = calendar + '<span class="today"><a href="javascript:" onClick="javascript:getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["건수"])  +  '); \">' + i.toString() + '</a></span>';
						}
						else {
							calendar = calendar + '<span><a href="javascript:" onClick="getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["건수"])  +  '); \">' + i.toString() + '</a></span>';
						}
					}
					else if (searchStatus == 1 && parseInt(entry["오픈수"]) > 0) {
						if (today == theDay) {
							calendar = calendar + '<span class="today"><a href="javascript:" onClick="javascript:getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["오픈수"])  +  '); \">' + i.toString() + '</a></span>';
						}
						else {
							calendar = calendar + '<span><a href="javascript:" onClick="javascript:getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["오픈수"])  +  '); \">' + i.toString() + '</a></span>';
						}
					}
					else if (searchStatus == 2 && parseInt(entry["공고수"]) > 0) {
						if (today == theDay) {
							calendar = calendar + '<span class="today"><a href="javascript:" onClick="javascript:getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["공고수"])  +  '); \">' + i.toString() + '</a></span>';
						}
						else {
							calendar = calendar + '<span><a href="javascript:" onClick="javascript:getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["공고수"])  +  '); \">' + i.toString() + '</a></span>';
						}
					}
					else if (searchStatus == 3 && parseInt(entry["청약수"]) > 0) {
						if (today == theDay) {
							calendar = calendar + '<span class="today"><a href="javascript:" onClick="javascript:getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["청약수"])  +  '); \">' + i.toString() + '</a></span>';
						}
						else {
							calendar = calendar + '<span><a href="javascript:" onClick="javascript:getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["청약수"])  +  '); \">' + i.toString() + '</a></span>';
						}
					}
					else if (searchStatus == 4 && parseInt(entry["발표수"]) > 0) {
						if (today == theDay) {
							calendar = calendar + '<span class="today"><a href="javascript:" onClick="javascript:getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["발표수"])  +  '); \">' + i.toString() + '</a></span>';
						}
						else {
							calendar = calendar + '<span><a href="javascript:" onClick="javascript:getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["발표수"])  +  '); \">' + i.toString() + '</a></span>';
						}
					}
					else if (searchStatus == 5 && parseInt(entry["계약수"]) > 0) {
						if (today == theDay) {
							calendar = calendar + '<span class="today"><a href="javascript:" onClick="javascript:getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["계약수"])  +  '); \">' + i.toString() + '</a></span>';
						}
						else {
							calendar = calendar + '<span><a href="javascript:" onClick="javascript:getLotsScheduleInfo(\'N' + '\', \'' + theDay + '\'); drawScheduleCountByDay(this, ' + parseInt(entry["계약수"])  +  '); \">' + i.toString() + '</a></span>';
						}
					}
					else {
						if (today == theDay) {
							calendar = calendar + "<span class='today'>" + i.toString() + "</span>";
						}
						else {
							calendar = calendar + "<span>" + i.toString() + "</span>";
						}
	...
	function makeCalendarWeek(dt) {
		...
		if (searchStatus == 1) {
			calendar = calendar + "<li class='status1'>오픈 : " + status1Count +  "건</li>";
		}
		else if (searchStatus == 2) {
			calendar = calendar + "<li class='status2'>공고 : " + status2Count +  "건</li>";
		}
		else if (searchStatus == 3) {
			calendar = calendar + "<li class='status3'>청약 : " + status3Count +  "건</li>";
		}
		else if (searchStatus == 4) {
			calendar = calendar + "<li class='status4'>발표 : " + status4Count +  "건</li>";
		}
		else if (searchStatus == 5) {
			calendar = calendar + "<li class='status5'>계약 : " + status5Count +  "건</li>";
		}
		else {
			calendar = calendar + "<li class='status1'>오픈 : " + status1Count +  "건</li>";
			calendar = calendar + "<li class='status2'>공고 : " + status2Count +  "건</li>";
	...
	function getYearMonth(dt, way) {
		...
		if (dt != "") {
			...
			var year = parseInt($("select#calendarYear option:selected").val());
			var month = parseInt($("select#calendarMonth option:selected").val());
			var day = parseInt("01");
		}
	...
	var getLotsList = function() {
		$("#lotsInfoList").html('<tr><td colspan="8"><div class="loding_wrap on" style="line-height:350px"><img src="https://image.r114.co.kr/W1/images/sub/loding.gif" alt="로딩중"></div></td></tr>');

		if (calendarMode == "M") {
			$.when(
				getLotsScheduleCount(calendarMonthDate),
				getLotsScheduleInfo("M", calendarMonthDate)
			).done(function() {
			...
			$.when(
				getLotsScheduleCount(calendarWeekDate),
				getLotsScheduleInfo("W", calendarWeekDate)
			).done(function() {
	...
	function getLotsScheduleCount(date) {
		...
		var formData = { estateType: estateType, searchDateType: searchDateType,  searchDate: searchDate, searchStatus: searchStatus, metro: addr1, county: addr2, town: addr3 };
	...
	function getLotsScheduleInfo(searchDateType, searchDate) {
		...
		$('#lotsInfoList').html("<tr><td colspan='8'><div class='loding_wrap on'><img src='https://image.r114.co.kr/W1/images/sub/loding.gif' alt='로딩중'></div></td></tr>");
		...
		return $.ajax({
			...
			success: function(data, textStatus, jqXHR){
				if (jQuery.trim(data).length > 0) {
					...
					$("#lotsInfoList").html("<tr><td colspan='8' class='result_nodata'>분양일정이 없습니다.</td></tr>");
				}
			},
			error: function (jqXHR, textStatus, errorThrown){
		 		//$("#lotsScheduleList").html("<li class='result_nodata'>분양일정이 없습니다.</li>");
	...
	$('#cmdSort').children('a').click(function () {
		...
		var order = sortList(thisObj, idx, {'key':sortType, 'dir':sortOrderby});
		...
		jQueryObj.each(function (idx) {
			if(idx == selectedIndex) {
				if(newKey in oneWay) {
					...
					if(newKey == oldKey) {
						newDir = orderDirs[(orderDirs.indexOf(oldDir) + 1) % 2];
						$(this).removeClass(dirClasses[orderDirs.indexOf(oldDir)])
								.addClass(dirClasses[orderDirs.indexOf(newDir)]);
					}
					else {
						newDir = defaultDirs[idx];
						$(this).addClass(selected);
						$(this).addClass(dirClasses[orderDirs.indexOf(newDir)]);
					}
				}
			}
			else {
				$(this).removeClass(selected).removeClass(up).removeClass(down);
			}
		});
		objSort.key = newKey;
		objSort.dir = newDir;
...
</script><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="calendarYear-button" id="calendarYear-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><div class="ui-selectmenu-menu ui-front"><ul aria-hidden="true" aria-labelledby="calendarMonth-button" id="calendarMonth-menu" role="listbox" tabindex="0" class="ui-menu ui-corner-bottom ui-widget ui-widget-content"></ul></div><iframe name="easyXDM_Kakao_default6302_provider" id="easyXDM_Kakao_default6302_provider" src="https://kapi.kakao.com/cors/?xdm_e=https%3A%2F%2Fwww.r114.com&amp;xdm_c=default6302&amp;xdm_p=1" frameborder="0" style="position: absolute; top: -2000px; left: 0px;"></iframe><div id="fb-root" class=" fb_reset"><div style="position: absolute; top: -10000px; width: 0px; height: 0px;"><div><iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" src="https://staticxx.facebook.com/connect/xd_arbiter/r/d_vbiawPdxB.js?version=44#channel=f418e13aa244b8&amp;origin=https%3A%2F%2Fwww.r114.com" style="border: none;"></iframe></div><div></div></div></div></body>
</html>